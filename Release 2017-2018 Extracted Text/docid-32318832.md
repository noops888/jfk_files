...
9A. LISTENING EQUIPMENT

During the course of certain investigations, it sometimes becomes

desirable to listen to conversations carried on by suspects or others

without disclosing to them the fact that they are overheard.

When such

conversations are carried on within a room or enclosure, it is poseible
...
some distance away from the room under investigation. Two types of

amplifiers are supplied by the bureau for this, one known as the Detect-

aphone and the other as the Lafayette amplifier. Two models of Detect-

aphones are available, namely the older model PA-173 and the new PA-1e0

Briefcase Detectaphore.

9B., DETECTAPHONE

On each occasion requiring the use of the Detectaphone, a thorough check

should be made of the set before

its final installation is
...
volts and between 30 and 35 amperes.

The large "B" batteries should

read between 36 and 45 volts, although satisfactory operation may

occasionally be obtained with voltages as low as 30.

The small "C"

battery when new should test 3 volts and should be replaced when the

reading is less than 2.5 volts.

The "A" batteries will need the most
...
control is turned on, the microphone should be connected to the amplifier
...
In placing a microphone in a room to be occupied by a suspect,
...
Because the microphone can be affected only by the sound which
...
than a desk drawer or bookcase.

In placing the wire leading from a microphone to an amplifier, care

should be taken that at all points

where connections are made, the

insulation has been thoroughly scraped from the wire and the bright metal

is exposed. It is absolutely essential that all connections be bright

and cléan, for otherwise, noisy operation or even failure to operate may
...
In connection with the size of the wire which may be used, it should be

guared unar nen using the carbon or dynamic type microphones the larger une

wire, the longer it may be made and still give satisfactory operation..

For

distances of 25 to 50 feet, very fine wire may be used without serious 108s

of response.

In general, however, the shortest line and the largest wire
...
room, to allow the hook-up to be tested

and any necessary changes made or
...
§lobules! placed between two carbon lor metal! surfaces.
...
sound waves impressed against it.

This vibration, and resultant change

in current opposition, causes the electric current to vary in direct ac-

cordance with the sound waves.

This weak electric current is amplified

of strengthened by the vacuum tubes in the amplifier proper.
...
transmitted. If the small cover of

a carbon microphone is loosened or
...
case the material used to make the contact between the two sides of the

electric circuit is lost and the microphone is rendered more or less

inoperative, depending upon the amount of carbon particles spilled:

The Detectaphone unit includes one amplifier:

one small crystal

microphone with a grilled face

to plant in a room for sound pick-up; one

extremely sensitive crystal well microphone: to enable pick-up of con-

versations in adjacent, rooms; two

boosters for use with extension lines;

and one set of crystal headphones.
...
ground lead in all cases.

In connecting the headphones it' makes no

difference which wire connects to the ground terminal post. The knurled

bakelite knob on the amplifier box is the switch and volume control.

Turning the

knob to the right, in a clockwise direction, increases volume.

Be sure the

switch is off when amplifier is not in use
...
The best results with Western

Electric Dynamic microphones or sound

Power microphones will be obtained with shielded twisted pair wire,

but generally ordinary twisted pair wire will be satisfactory and more

easily disguised.

9C. BRIEFCASE DETECTAPHONE

The Briefcase Detectaphone

is a new improvement over the original
...
Three jacks are provided for using three

crystal microphones simultaneously and a single jack is provided for all

other types of Bureau microphones. However, an external battery is still
...
Ray-O-Vac P3A30, Eveready 733, Burgess W3OP1, or General V30AAA
...
Detectaphones recently received by the

Bureau bearing the name "Clarion" use one Eveready 742 battery for the lz-volt
...
SOUND AND TECHNICAL EQUIEMENT

9D. RADIO DECOY PACKAGE KITS

Eight complete decoy package kits are presently availaole for use

on extortion and similar cases.

The kit consists of a decoy package:

an auxiliary beat oscillator, antenna, spare tubes, batteries. and
...
as part of the accompanying kit.
...
picks up the signal which

is heard as a constant "beat" note or squeal

in the receiver.

The approach of a person or animal within 6 to 12 inches

of the decoy will result in a marked

change of pitch of the beat note and

contact with the decoy will cause the note to disappear completely.
...
of approximately .4 to 6 mile nas been secured in practical operating

conditions using standard Bureau automobile receivers. Large buildings
...
The small briefcase transmitters; six of which
...
For greater coverage, a higher powered portable unit capable of

operation from 110-voit a.c. or 5-volt dic. sources is available. Two
...
the above-mentioned equipment is so designed as to be able to transmit

2/15/43

DocId: 32318832 Page 5
