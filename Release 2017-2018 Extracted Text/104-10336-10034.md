...
[fidentity redacted but, in fact, IUDECANTER).
...
interviews, and/or assumptions based on
...
escape damage fully or to some degree.
...
(S) While the foregoing showing of intelligence damage
...
• issue of extreme importance to the Directorate of
...
factual description of the source (e.g., "a
...
supported by reporting from another source ladentity

i redacted but,

"In fact, IJDECANTER).

• It concludes by stating that this source (TUDECANTER$ has

had his "... bona fides ... fully established Iby CIA)."
...
IIDECANTER known to the public in true name and crypt,
...
le. g., a defector), they act on the information to the
...
the United States is considering avenues of
...
9: \irg_frontoffice|general\lss\arrbijtp.doc
