...
JEK Assassination Records- Proposal
...
exposed, link operations or assets to one another or which
...
there is no obiection to its release.
...
that the release of pseudonyms

is not done in such a manner so
...
is to mean that only a small number of
...
to the release of this information as it
...
the book "Deadly Secrets" notes that there was
