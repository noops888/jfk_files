...
THE DIRECTOR OR SEALE REUGENCE
...
adeguacy of CIA's search, review, and release of documents under

the JFK Act. Mr. Cohen

signed the Agency's Declaration of

Compliance because he was

the most senior Agency official with
...
overall dally management of the Central Intelligence Agency,
...
Information Review Officer have certifjed to me that their
...
documents, primarily from the FBI.

Other major additions to
...
subiects which are considered central to the Oswald/JFK
...
of Operations components deemed most likely to

possess records relevant to the JFK assassination of the

kind of concern

to the Board (See Tab 3).
...
fOr JEK Assassination Board Requests
...
which will make the responses

available to the Board. FATUOY

Prease provide the name of your local point otticer to

John Pereira, Chief, HRG (x30373-secure) by 13 April: (ATUO
...
omplied fully with the requirements of the JFK Act. Amon
...
3. del In discussiong with the Board staft we have

attempted to focus any new tasking co chose are in which
...
may contain information relating in any way to the JEK
...
searches hould focus on documents that might be retrievable
...
its task of overseeing the search and declassification of all Federal govemment records relating to
...
ADMINISTRATIVE INPERNAL USE ONLI
...
ADMINISTRATIVE INTERNAL USE ONSY
...
addresses the Board's request that the
...
failed to produce any record ot volume v.
...
tapes were retained and returned
...
of Meeting - 26 Nov; Participants - DCI &
...
selected additional documents for inclusion in the JEK
...
based upon reference to Item Number 40-76 of the
...
-he DCI before access can be granted. This letter will be
...
chose pages of the defector file deemed relevant by the ARRE
...
and monitoring of mail with the
...
It is believed that OS holdings on tee
...
as assassination.records as a result
...
people whose work requires them to review Agency documente
...
eventhen derantil arked with eavala
...
collection and break down as follows: thirty-tour (34) boxes

of DO materials: nine (9) boxes of Office of Security files;

fifteen (15) boxes of OLC materials; two (2) boxes each of

oSC and IG materials; and one (1) box of DDS&l documents.
...
includes: 201 files on Cubans, Americans, and Soviets
...
assassination, Lee Harvey Oswald, of the various conspiracy
...
ensuing investigations, which causes a number of
...
-- Mx. & Mrs. George de Mohrenschildt (all documents)
...
work for OIM, OCA, OGC and PAS, and put the Agency in a bad light. / suggested that I should ask the

EXDIR to sign the declaration. The GC interposed no objection. I then spoke with the EXDIR who agreed

to sign a declaration if this would satisfy the situation. I informed the GC thaf the EXDIR was willing to
...
FDA, R. Bruce Burke@DCl, Lee S. Strickland@DAl

PA, J. Barry Harrelson@DCI
...
rape mates of lo or old alone a bourg re or pirate com at

predocessor

with the Board.

has reported that, to ensure that the ARRB staff understood the DI records

system and search capabiles, the DURO and the DI Information Management Officer, Ms.

briefed the staff on 13 May 1987. Other DI participants at the meeting were
...
Amlted number of records searches he bl conducted in direct responso to ARRB equegis on

11 Jing 1997 Ol personnel met with membors of the ARRB. Mr: Mynnhad arendedhs
...
IRO for the Directorale of Intelllgence
...
. FBls study, never disseminated, entitlec

he Past Soviet Propaganda Assessment of President Johnson

Studi is Confidential and dated 25 November 1963
...
E possible coverup in killing of Oswald - to seal his lir
...
the General. Counsel(OGC), Office of Congressionäl
...
Until that time the Historical Review GrOUp (HRG)
...
Varren and Rockefeller Commissions, Pike and Church
...
They have provided a list to HRG.
...
for release to the ARRB and approved access with certain restrictions. There is no record in the DAARO's
...
identified files on Shackley, Cross and Gupton which were reviewed by the ARRB staff. HRM identifier

files on Morales and Shackley which were provided to HIRP. Neither office surfaced records on Bar
...
Capchart's Office of Security file is in the sequestered collection. The DA JFK Focal Point
...
responses to this request. The Official Personnel File of Charles Ford was given to HRP, OS provided
...
Administrative faternat too Only
...
Administrative Intentattoo Only
...
Administrativelternal Ust-Ommy
...
g:lirolbriefingVrkbref.ppt

Administrative-Internal-Ust Only
...
Auministrative Internal too Daly
...
Administrativa latomat tot Only
...
Administrative Internal boo-Ombe
...
the Damestld Contacts Diviaion (DED).

6. Where are recörds that would describe liaison (etc.) cooperation or operations

between

Os arid erlocated? How are these records organized?
...
lush tund which was tightly controlled by Angleton and no
...
Are there any records of CI operational, expenses foi
...
impossible that any fund was not audited/certifled in some

fashion li.e. reviewed and certified decentrally and only
...
search these microfilm

records, find the correct office and

produce hardcopy reports listing the employees on the rolls
...
associated with the occupation li.e.

B&F officers assigned to CI

from 1959-63. The employee name could then be used to located

current or archived HRM

files. CAUTION: 1) If an individual came
...
they would not appear on the

staffing complement of the outside
...
pIobability has been destroyed, would have this type of
...
accounting containing indigenous personnel are kept for 56 vears,

Station accounting not contaizing indigenous personnel are kept
...
tiles created.during.this.time frame.but itis.impossible.to...

state ris is all anclusive:
...
need names to aton tested ecose datensterscupation,

polygraph number, reference source

information codes,

remarks. SSN, sex, employer, and file retirement data.
...
Aside form the subject name indices,
...
.The-SecurityResearch.Staff..(sps/.was..the.componept....

responsible.for.collecting...developing.and evaluat.ing

informatior of a counterintelligence nature to detect andlor

prevent peretration of the Agency's organization, employees, and

activities by foreign or domestic
...
Question 5 - Does OS process

security clearances for non-
...
their foreign travels, specific scientific
...
(eto) cooperation or operations between Os and CI located?
...
turnarcond time imposed on responding to this
...
If the title does not include these weds, retrieveal would be
...
assassinaison Records Review BOGId (ARRE) to be hela on Monday.
...
seat from a field site would be passed to a
...
CS= 97-052 cared i1 January 1997

tichededine 104-10335-10015)
...
I=ianing to the existence of pre-assassination tries on lee
...
pe=raining to the Difice of Personnel Security (OPS). These
...
File (#0341008) contained a zefezence to bee jamey oswald,
...
Harvey Oewald (#0351164). This information was reflecied in
...
o microfiche records which were supergeded by the auromares

syscem.

This hand search produced the same resules as the

automated seasch of MD?/PS.

(U) In your request specific mention is made of an

EELINGUA file. MOP/PS =eflects OS maintained Eour osticial

==es under IniS DIOJeC=-70Q77826 (a7 administrarive =1le),

$0090079, #0093466 la general filel, and $0119144. All CE

the HoLINGUrI, files we=e des=royed on & Agail 1994 along

with numerous soft files. Since this material has been

destroyed, OPS cannot definitively state whether inese files

soniained any information on bee Harvey Oswala.

A seaIca ca

oswald's name did not produce an index reference to any cê

these files.

10) Anzacned is a11 c5 Ine avalzaaze information

regarding the destruction of the aza-NGurE
...
===s=mation Managemen: Branch/Records Cours: Section and

==om a review of general office administrative files.

Questiezzi (J) Other chas =0= the 201-259246 file

on Oswali, Please explain whez each Oswalà sile was

opened, the purpose for the opening of the file, and

ine documenas that weze in the sile at the time o= the

assassinatio?.

Response:

(5) As noted above, all ETLINGUAi files have

been destroyed.

Since OS Files are usually see up in

chronclogical sequence, a search of tiles with numbers in

close proximiay to those recorded £o= HaLINGJA: was
...
Opened apprecimately February 1953
...
HTLINGUA:, waS a Directorate of Operations project
...
1960 with actached list of American "defectors"
...
The inder reference to the Defeciors File
...
have beer unsuccessiul.

(J) Information regarding the purpose of the Defecions

File was Gleaned frot a Guick review of selected holdings.

7of cris citice ac one time was assigned to the

Securisy Analysis Group and recails the Defecto= Machine

Iis=12g.

==Om de= Ies0i-ec-:o-, I=iS macaine 1=5=179 Was

approxitezely one and one-half inches chick and was i= two
...
assigned aubers in numerical-order and contained

Limited Informentor or ezca name.

¡ci re Specia Investigations Branch ca Investigations

Division is the currena operating component encompassing mos:

== the Security Analysis Group functioas saill conducted :

DeS.

cê this disice was queried regarding sifice

holdings relating io the Defecior Machine Listing.
...
could 70r recall ine listing, opined it may have been

destroyed, and suggested contacting

Counterintelligence Cente= (CIC).

(C) CiC assumed many of the fuaciions previously
...
Lisüing may have been transferred to CIC during the
...
has made inquiries with Directorate ce Operations
...
1959 entiüled "U.S. Jefector to Reds Turned to
...
Department of State Sispatch from Moscow dated
...
E=om Mexico City dated

%..

Jungoing cabie #74030 to Mexico City datea
...
Responsei (0) In is believed thai OS holdings on. Lee

Harvey Oswald began in 1959 with his travel to Russia @uring -
...
component responsible for collecting, deveioping, anc

evaluating information of a counterinterigence nature =o

detect and/or prevent penetzation of the agency's.

orgarization,

employees, and acrivities by loreiga s=

domestic organizations or individuals. SPS conducted

research in connection with employee loyalty cases and

maintained recoris identifying personalities, environments,

and se=sonal

traits of individuals wno had been os

counterintelligence interest over the years. SPS maintained

liaison with vazious government agencies in connection with

countezintelligence activities and coordinated the

counterintelligence esters i==ougaoui os.

Using

organizational chares of tris time period, SRS reported

cireculy to the citice of the Director da Security.

(5)

== she OPS/Managemena Stalá was queried
...
melating to the above requesa,

and the GPS/===o=marion
...
the informasion on the mission aná

Incuion of SRS was retrieved from the arcaired Office of

Security administrative and ristorical Biles as well as a
...
For your information, a page-by-page review of

=ne documenis concained in the Defeciors File (12 volumes)

and bee Harvey Oswalá's file 17 volumes) has a0= beez

conduceed for the purposes of this request. Due estores

were concentrated on the pre-assassination time i=ame.

4.

(u) This review was conducted iy

OPS/CO/IMB, secure $0552.
...
WENOF-DUM FOR: Gloria Boyd, FREICS=
...
15B Picntionar Information Beguest 522-1
...
dinision de resooneratitutes marie era for the veers

953-56 and

Some c3 are documenas are dates

====

=zane

spectated but were determined == ze

effective Guzang the beams
...
operations and the History Seats

scoumeras.

ine aroached noc:==

= you nave any Enestions, Please cai: Marlene
...
MACLASSIFIED WHEN SEPAR4080 FROM SOCCEN
...
ARRB Request for Access to Indices to CIA
...
Regarding equities that concern the Office or the DA, I Leviewe
...
Henry and Wiliam Morris Kent. In an effort to bring the status of this particular tasking (CLA-IR-12) up-to-date, I provide the following:
...
Doug Gupton. We were advised by Barry, ard as outined in a 22 May 1996 letter from ARRB to John Pereira, that Cross. Henry and

Gupton are pseudonyms used by CIA personnel who testified to the HSCA.

Notwithstanding, we tasked OPS and HRM tó conduct searches on these individuals in an effort to locate files. On 22 December 1996,
...
Henry and Gupton but failed to locate any files on these individuals in light of the fact that only the pseudas had been provided. We
...
in OPS for review. They were unable to locate a record on Bart Henry. It is my understanding that you have not reviewed these files 1o
...
Please let me know it l have misinterpreted the status of this request. Thank you. Frieda
...
Request No. CIA-16 from JFK BoaId
...
in MI. Marwell's letter to the Historical Review GrOUD, the
...
Oswald's name did not produce an index reference to any os
...
As noted above, all TLINGUAL files have
...
and from she Soviet Union,

and south

America. In OS this project was known as
...
a. Washincion Star press clipping of 26 November 1959
...
permanently charged to the Security Analysis GIous of OS.

Sitorts to locate this listing or determine the disposition

have beer unsuccesséil.

(J) Information regarding the purpose of the Desecio=s

File was gleaned from a quick review of selecied holdings.

J of this office at one time was assigned to the
...
approximately one and one-half inches thick and was i= iwo

one par= consisted of an algraberical index s=

defector names with assigned zumbers.

The second pas-

Listed the

assigned numbers in numerical-order and contained

Limized information on each zame.

iC)

The Special Havestigations Branch ca lavestigations

Division is the current operating component encompassiag mos=

of the Security Analysis Group Eunctions saill conducted in

c5 this difice was queried regarding ostice

holdings relating to the Jefecsor Machine Listiag.

Ms

has no knowledge of the listing and suggested

as a resounce.

CIC iiaison Difices,

could a00 recall the listing, opined

#= may have been

destroyed, and suggested contaczing
...
queried -egarding the

possibility the Defecto= Machine

Listing may have been transierred to CIC during the

-ealicament of duties.

advised the Deiec.or

Machine Listing couls 20t

be

located in CIC holdings; and be
...
separate repository for the numerous press
...
Incoming cable #35017 from Mexico City dated
...
references to the Clandestine Services Handbook (CS-B)
...
officer esponsible. for the collection, analysis, and filing
...
and pesonal tradis of individuals who had been os
...
counterintelligence activities and cocidinated the
...
cirecily to the citice of the director ca securioy.

15)

of the OPS/Management Seaft was queried
...
=55a551=a0:0= Time period.

made inauiries

I=lasiag to ine above recuest,

and the 22S/E=ásamasion
...
the infomation on the mission and
...
For your information, a bage-by-bage review o=
...
•. Mr. Capehart was however, an employee of a
...
memorandum (attached) and our telechone conversation or

5 February wherein you recested chat the Directorate os
...
George herbert Walker Bush to determine wrether he had asy

affiliazior with CIA during the 1963 period.

The Office of Persorne: Security and the Office ci

Zuman Rescuice Maragement have reviewed its files and have

been unable to find any documentation to snow that Geczge
...
AIMINISTENTIVE-INTERNAL ÜSE INCY
...
Associate Incimation Review Cifices, IDA

SUBJECT:

CIA-1R-11 - ARRE RecueSt IC= Saarch Ci

Varren Commission Critics 107/IR0 NO. 2=

1.

This is with reference to your ? February 1999

memorandum (Tao A) and our subsequent telephone conversatiar
...
Commission critics Edward J. Epsteia,

issian Thompsor, VaIk
...
the Citice of Persorner Security

(OpS), the Office of Human Resource Management (PaN)

and Eze

office of ine Publication Review Ecard conducted inc=ouga
...
its search in esporse 50 CI2-73-27

(DA/IRO No. 14) .

At your requesi, or 6 February 1998

3) we requested

that OPS make arcarcemenus to have cris sile

revzewed oy the ARRy to determine whica cocumeres are

Assassination Records. Accordingly, CeS did not address tae

Weisberg file in this CIA-IR-li resporse.
...
aCraId J. Epstein - AIN 0 482 753 lEgurd in GPS;
...
Syria Meagher - opS adrised tat trere Nas an

impersora.

soider regarding Subject and a isa Ranpares

Magazine article which were destroyed in accordance vice tae

2ecords Corazol Schedule on : Jaraury 4334

ASMENISTRATTIE • IMORMAL USE CAL!
...
Please let me know when vou want me to request the

on Edward Epstein from OPS and 2RS. Meanwhile, this

goncludes Da action on Cra-12-12a
...
ADMINISTRAGIVE - INTERNAL USE ONLY
...
EFFICIENCY & IS NOT MEANT AS A BREACH OF CYBERSPAGE ETIQUETTE.
...
THE ASSAILANT WAS ARRESTED, NO HARM TOL
...
22 MAY GJ'Q* CLEARANCE REQUIREMENT INFORMATION & 1962 FAVORABLE BACKGROUND INVESTIGATION

26 FEB 64 & 25 MAR 63-POLYGRAPH SCHEDULING MEMOS

BECKY, IF WE CAN BE OF FURTHER ASSISTANCE, PLEASE LET US KNOW. THANKS.
...
Neu KrelPersonalized

Ci BY: 162125

CL. REASON: Sacion 1 5
...
previously. This reflects the search after our visit to OFL to define search terms. I am also forwarding .

for your information the paperwork that appreved the destruction of financial accountings aiter 6 years 3
...
attached) wherein you requested, on behalf
...
access to records of possible pertinence to the Jer
...
located medical charts on Leake, Garbler and George BIOWn
...
Priority Reaust Front JFK Board dated 17 Bocerber 1986, DA-13
...
Priority Requests from JEK Board
...
O=fice of Personnel Security conducted appropriate searches of
...
This file refleces that in August 1957

Foreign Documents Divisior/00 requested a ciearance on Spas I.

Raikin for unclassified contract employment wich Projece u.s.
...
January 1967 the Office o= Security again granted approval for

Mr. Raikin to be used as

an unwitting independent contractor with
...
record to an media article dated 1971 from Comouters and
...
'ermindex. My records show that all DA action is now complete regarding CIA IR-19 DA/IRO 32a, 32

ind 32c). As you were advised in my memoranda dated 6 and 7 August 1998, the Garrison (Volume l
...
(AIN O 800211). Evidently, he was a former employee. I regret that we did not have this information prior.

1o lasking you the first time.
...
Barry: HRM's response follows to your request for the address of

This sounds like the individual you

described-spelling different. As stated,

resigned in 1970 and the Agency has no current address or record of whether or nor
...
GS-03) - his title was photographer. He reEOD'd ol

J0 and resigned on E

nis title was photographer and he was assigned to NPIC. HRM would have no address listing for this individual.
...
Search Results-Bill Green and Claude Barnes Capelarl
...
The search undertaken was reasonably calculated o uncover all responsive records. Please advise if i may be of further assistance.

CC:

Becky L. Rant, J. Barry Harrelson @ Ol.
...
05 Personnel Security's Managemen: Data Program/Personnel

Security (MDP/2S) database

was searched as requested.

2.

The searches undertaken were reasonably calculated

to retrieve ali responsive accumenes.
...
Please annect any Further

inquiries regarding this master
...
Barry, the Center for CIA Security had a file for a PUNTER, Jordan J.. DPOB (?)

_This file was destroyed circa 1980-1981 following the Records Control Schedule. Thanks.L
...
_@DA, Becky L. Rant@DA, Frieda P. Omasta@DA, Gary M.
...
Jesponse referred to below, this concludes DA action on this request. MRM and OFSS were negative. As you know, OFSS
...
Oswald Lewinter came to the attention of the Office ca

Security in December 1991. CIa/Public Affairs advised

Lewinter apparently approached the Sritish Broadcastiag
...
operations overseas. His offer was in conjune=son its

six part teievision series being produced by the 50 cases

upon the book "The Agency" by ohn Banelagh.

Lewinter is a known fabricator and has uses the serrating

aliases; Oscar Lewinter, Ibrahimir

• Razin, Razin Ferneer.

Lewinter is indexed to the os crani file.
...
ABR5 Request Regarding Canard dewinter
...
Lewinter. Lewinter was the sungec cs
...
intelligence swindler, peddler, and fabricates.
...
Lewintar dair same to the attort it he tattra

Security In December 1091. The did's ducaid dilairs

given: that

LeWintez apparently appicached the British Ersadcasting

corporation isBci claiming to be a loomer cia Officer. Lewinter

volunteered io provide information aocur agency operations

overseas. His ofier was in conjuncoion mith a six-part teletsion

serles being paceuced ly the 35C based on the bock "the agency'"
...
The atrachment is an extract of che
...
#Re Para 3 - The Calle stant was

pour ay the Office of The Desector

inter 197a then it wa placed to

see

The Offece of Communice tion.
...
ATTACHMENT IO 1l MARCH 1228 MEMCRINDUM RE: CIA-IR-36

1.

Per the review board staif's request the following.

is a brief explanation of how the pirectorate of Operations

(DO! processed cables in the 1963/1964 time-frame. "As

we

are

unable to. locate any definitive

records on the subject.

....anid'in all probability none ever existea,
...
meet each division's unique requi-ements, there were common

functions performed by all the registries to include:

collectine, sorting, and celivering of incoming cables;

maintenance of incoming and outgoing cable "chronos";

collecting and delivering of incoming and outgoing pouch

material: and the issuance anâ maintenance of "pseudo and
...
processing point, then called the Cable Secretariate, withir

the disicasi communicattors.
...
acco-cing to pre-defined

These guidelines were unique to each division

and were i=equently altered to meet changing operational
...
the original Headguarters building) to Cable Secretaziate
...
This mouse la MOr to be ties in agent!

-3=ua!s.

=:=ase

destroy after reading. 1
...
1 Hebruary 1992. the Casie

transferred

of the Diac:or io the Citica
...
jcuriga, Fano in hory( ta iori)

Vebster, Robert Edward

Ierbell, Mitchell Livingston III
...
Onginal Text of Frieda P. Omasta
...
_@DA, Becky L. Rant@DA, J. Barry Harrelson@DCl, Gary M.
...
Automated Name Check Activity (SANCA) were
...
and appropriate disposition. 'Please direct any furthe=
...
Informacion Management Branch or enroute and are available

for your office's review here at CCS/IMB. The Center Eor

CIA Security defers

to the Assassinations Records Review
...
Alliluyeva, Svetlana. The Security File (hardcopy) refleces

ATTACHMENT $ CONTINUED

Stalina, Svetlana

I.. The McMillan Security File (hardcoby)

reflects. Macmillan. not McMillan.

MARTIN, Jack. ces records reflect the three following
...
Directorate of Science and Tech and have held various professional

this position in february 1996, ano
...
lechnology and the Associate Deputy Director tor science anc

lechnology; the Office of Technical Service (OTS); the Office o
...
package of documents forwarded by Barry Harrelson.
...
oresent location of Staff D records.
...
OTC, and OTS were searched for the
...
of ongoing CIA activity at the
...
for the years 1958-1968 (CIA-1). Requeste
...
activity since 1992 and the JFK EPO since 1995.
...
with the conduct of operations and

protection of

sources and methods. We also provided
...
occur if certain information was released.
...
June 1995 and some undated) to answer, including
...
Mexico city Station and Headquarters, and (B)
...
Jand advised that an unclassified response
...
"annual reports" for the years 1957 through
...
it was doing against operational requirements. The
...
operational requirements the Agency was expected
...
NC1-263-77-10). The 1977 authorization
...
thich may have seen decided to HINdUAl materter al

We know,

for instance, that there are HILINGUAL items
...
was opened in 1969 and closed in
...
The Do retired recoras system, CARD, has a reference to
...
in the DO and in all instances were
...
201 file #07662 (two volumes), has an A-file #048050,
...
I. Ed Butler -- Trace resulted in an A file (#121440)
...
identifying the reels and

folders of the files that
...
JEK. Declaration of Exedrick C. Wickham,
...
in the collection with some redactions.
...
Combs then wrote a memorandum dated April 1997
...
• KGB approaches made to various members of
...
fxom officers involved in the Cuban program,

•there was never a Cuban Government in Exile.

Durino the plannina for the Bay of Pigs
...
that a projected government in
...
-- Files of CIA officials/offices
...
its incoming cable traffic from
...
each division and were frequently
...
usually for 90 days, and

the receiving office placed a
...
sent "routine" but with ten addressees on a
...
JFK EPO, Directorate of Operations
