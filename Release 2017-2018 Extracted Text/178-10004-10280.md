...
deadline, which has limited the ability to research all the questiona
...
the public to issue the report as now written.
...
Dy this he meant high-level assurances of suppost
...
AMLASH/1 then went to Paris, Erance, where he was met

again. Meetings with AMLASH/1 in October 1965 consisted of

exploration as io what he might do, and requests by him for
...
to render the assistance it is prepared io
...
(probably under AS auspices) recognition
...
In 1967 the Inspector General of CIA conducted an iuvesti-
...
be used to kill Castro fiom a distance. FitzGerald rebuffed
...
still tas not given the technical assistance.for the operational
...
•Government gave much equipment and money to exile groups fos:
...
rifles and scopes. During the period following 19 Navember,
...
22 November 1963 and met with AMLASH/1 on that date. AMLASS/1.

vas show the ballpoint pen device but did not accept it, He alco
...
a coup, however he night attempt it. This is emphasized by
...
formalized by a memorandum written the same dale.
...
1966 trial contain no reference to his activities prior to, 196g, i.e.,

before President Kennedy's assassination. The transcripts suggest:

that, to the Cubans' knowledge, AMLASH/I was not in touch with CLA

before November 1964. Nor did the bool which Castro provided to
...
This was after AMLASH/I was informed in 1964 that the U.S.
...
NW 50955 DooId: 3210573B Page 6
...
the matter but there is no evidence that Oswald Inew
...
program. How and in what forum was the staled
...
that CLA intended at this time to use AMLASH in ar
...
Footnote: The case officer did not say, as staied
...
This seems to indicate that the TBI
...
ment of a prospective agent in another Europeas
...
The 8 December 1963 cable from IMWAVE was in
...
It is requested that CIA supnort for
...
1965 on the security of the operation, does noi
...
to it then, so how it could have lonown is subject
...
While the point is noted only in passing, thai AMLASH/1
...
dispatching an assassin.

And then jail his. own provocateur

for what is now some ten years. No evidence
...
The citation of 1964 events that do not specifically rclate
...
polygraph should be deleted, because of its lise in chocking
