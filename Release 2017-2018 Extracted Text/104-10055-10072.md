...
On 16 December 1963 Peter I. SWINEHART, POB, arrived at Mexico
...
apartment. (See HMMA-22608, ll Dec 63, para 5.d.) Lines leadirg from the
...
Mlock would not open for the agent on the afternoon of 6 December.: PARMUTH
...
and PARMUTH met at the LIFRODE basebouse to install the 35mm SEQUENCE

camera and the VLS2 trigger device. SWINEHART instructed both L-22 and
...
with SWINEHART's satistaction. Although the Consulate door was closed to the
...
visitors as of 1010 that day. PARMUTH and SWINEHART joined I 22 shortly
...
0800 to 1800 hours daily, six days a week. In order for I-22 to process the film
...
satisfy PBRUMEN reguirements at the Station. Forwarded as enclosure 2 is

the installation m statistical and training report concerning this operation.
...
meeting with LIFEUD22. The purpose of this meeting was to pick up photographs
...
(Enc. #3 is an S-2 forsn.)

b. On 20 December 1963, PARMUTH was trained in the use of SW

raysterh 99 by a visiting KURIOT technician.
...
(1) Secret writing: issued1 - 37 carbon to SWLUCK/1.
