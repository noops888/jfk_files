...
Select Cormittee on Assassinations into the death of Presi-

dent John i Kennedy,'I am writing to request that py narch
...
Possible and actual intelligence agents, assets,
...
are has adi stand it cancer. anne manad
...
records systèm and are to be maintained by that unit. Some desks levy require-
...
dossier on perinanent charge should be returned to Central Files under a
...
How-Rentsieted Doesler

For Split Charge Dosalara:

1l documente polor to Testa

SorRided to IP/PILaS. All
...
This 13 tO 3011ly you that secountabllity Zor the documens(s) am/or tile(s) cited
...
decording te, you have any questions regarding this transfer.

I''s records nou reflect you as the custodian. Please contuc: IP,Files,
...
¡equest (Form 813) to change the action desk designation to insure that th

01 personality will be included in the Headquarters and field machine listing
...
Peronine dost maybe retired by choking Do is ope the 301.
...
mita a deter an to ration a ald a Contal Files by sub
...
To restrict a illa, couplace Beetion A (signature at 1.0. not
...
Desk" blocks on the 20l: Personality File Action Request (Form 831). The
...
(CANTARGANIZATSGA SAYERMAL USE GNE?

ZO1 SIAMANG ALPHA LIST
...
some trade or manual occupation, i.e, carpenters; bricklayers, painters, mechanic

and electricians. If a list is requested for electricians, all others in this category

will be included in the printout. These ron-standard listings may be sorted
...
d. All rembers of the Security Service of the
...
C/NE/ISR should be indicated as the originating
...
J. Identified intelligence officers.
...
e-go, 201-123456, is assigned to each person, and a dossier controled
...
future reporting on the individal both as a tie number and in place of
...
walle. For oxample: A considerable number of stations are concerned
...
sonalities, such lists should contain the names and identitying dat
...
identifiable personalities concerning whom enough inior mation is not
...
ried with us numbers in appropriate genera. or special usungs,
