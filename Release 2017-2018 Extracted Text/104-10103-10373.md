...
transmitted outside,o) CIA Access to Top Secret matter is limited to Top Secret Control personnel and those individuals whose oncial
...
of custody in the left-hand columns provided. Each individual no sees the Top Secret document will sion and l
...
mpleted in the appropriata spaces bel

SPATCHED A COUTSIDE CIA)
...
from minor editorial notations and comments; to factual corfections
...
prior to lio doparture for Havana. fle was dever a lully recruised
...
with developments). FitzGerald recalled that AML.ASH/1 spoke of
...
that CIA intended at this time to use AMIASH in an
...
asked a hypothetical question about use of ALash,
