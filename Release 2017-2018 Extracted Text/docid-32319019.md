...
AGENCY FILE NUMBER: 62C-HQ-1029205-490
...
LuAnn Wilkins or Carol Keeley, ext. 0674

Approved By: Keeley Carol L

Drafted By: Wilkins LuAnn M

Case Tb #: 62-40-1029205-490
...
Reference: 62-HQ-1029205 Serial dtd 5/29/98
...
In referenced communication, each field office was

requested to search for additional records related to the JFK
...
This communication resulted in questions
...
should be forwarded to the Historical
...
forwarded to the JFK Task Force

immediately.

TO

assist in the search for the core and related

subjects', biographical data is being furnished which should

assist you. Please expand the search

to include "Presidential

Assassination Threats of JFK prior to 11/63".

DocId: 32319019 Page 2
...
placed on record since the previous search not

to include the

prior responses to this legislation.
...
all search slips should

be forwarded to the HERU/JFK Task Force

to the attention of Catherine Lamey, Room 11144, by July 20,
