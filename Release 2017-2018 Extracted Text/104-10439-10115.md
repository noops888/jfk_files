...
a choice of a number of meana of making the first contact.
...
han average if he is a walk-in who has not delayed ir

telling his story to a non-Communist official or servic

and who passes KUBARK testing, and are poor it a detected
...
Has the potential DA told us everything? Or
...
service, the nature and level of his assignments, level of
...
m. Time and support available. The base of
...
periodic debriefing of the DA, with little of no attempt to
...
In such cases, including those involving U.S.
...
do The agent's documents should be subjected to
...
Unwilling Das, serving either service
...
3. Unwilling DA's show the reverse pattern.
...
which the adversary exploited in recrulting the agent.
...
I Both willing and unwilling double agents are
...
The case officer should avoid competing
...
They are frequently cynical. They
...
carry it out. On a long-range basis, however, unwilling
...
vith the attainment of such long-held, personal objective,

s security and status. The length of required service ma
...
flicts directly with bis desire not to place himself in the

power of another through divulging too much. Persistent

case officer digging into bis past, especially if performed
...
training needed and should supply it, being careful to tailos
...
reprimands or threats but mrsing a consequent grudge in
...
Because willing and unwilling doubles show
...
caution but not for apprehension.
...
rom overcentralization. The headquarters of a typica
...
c. On the other hand, the adversary services,
...
range of hostile goals listed in Part II, above.
...
iter of information and to identify all sub-sources, witting
...
several agents without regard for access. If the
...
to satisfy specific counterintelligence requirements.

The

ODYORE military services, for example, will consent to
...
entire service. He also needs to know some-
...
He needs to draw from the agent all the
...
4. As was noted in Part II, cover must be established
...
But the KUBARK case officer must
...
ions, some KUBARK case officers have merely repri-

nanded the arent and continued the operation as before

leaving the confidant half-in and half-out of the case. I
...
6. A security check-list is included in Part VIII of
...
eels rebuffed. Sympathy and perhaps non-discernibl

naterial assistance are in order, alone with an explan-
...
seem to indicate. Even if the advergary is identified
...
should be included in the reporting to headquarters.
...
'he operational value of such payments depends chiefly o
