...
AGENCY FILE NUMBER: 62C-HQ-1029205-3328*
...
Margaret B. Munroe, PLS

susan S. Vaden, PLS

called 92796-mall send
...
Synopsis: Boston is requested to conduct necessary research

pursuant to the Assassination Records Review Board (ARRB) letter

requiring the FBI's response by 10/21/96. Boston is also requested

to send pertinent files to Headquarters/JFK Task Force as
...
Boston should furnish background information

concerning these electronic surveillances to HQ by C.O.B. 10/11/96.

Boston should ship requested files to HQ/JFK Task Force,
