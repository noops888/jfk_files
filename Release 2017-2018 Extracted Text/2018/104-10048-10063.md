...
IO HAVE TESTIFIED SEFCRE THE EASTLAND SENATE COMMITTEE DURING

ITS HEARINGS IN S9 OR 6B ON CASTRO ACTIVITIES. SINTION CHOKING

LUITILIAGTARNS SASH. REQUEST ANY HOS TRACES AND

CONMENT S.

- 3.

CaRDIMY PUR SUING MUCH SA'E LINES AS STATION ON THEIR HAS

REQUESTS. WE CHECKING TOGETHEP. PREVENT DUPLICATION BUT STATION

VILL HANDLE TRACES INCIRALLWITH SHOT IHO JAGUAR WILDERESS

REMIES IN DURICAFE BOTH TOSTAT FON AND OENAY. HAVEASKED SMOIN

FOLLOW UR ANKLEARSON ISUQUECTS AERIAD EGNAZQUEAS

APPOR IATEAN THEY HAVE TER LEBANEY

-SCORTET

EnS COMMENT: "ALSSEMINATION APPELGABLE FORYBAT GPFLOOR*CABLES.
