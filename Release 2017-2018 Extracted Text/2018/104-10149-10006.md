...
well as corrections of fact. Ce) ae
...
Liaison would recognize in the draft (page 4, as well). iG )
...
subsequent observations in the draft. (ce 2) :
...
the Committee is for it to express, however overstated and however weakly based(¥
...
matter, but that is based on the interpretations of the Committee and not a
the facts.Cv )
...
source evaluation, without specifying the sured. (s)
...
demonstrating just that. (Ea


What the draft indicates is “plausible” to the author, about the
Bureau's not reporting it, ks speculation and not fact. Had these been
...
11/ Classified CIA Dispatch No. 22579, 12/5/63 He
...
the HSCA investigators to explain what they wanted. CJ 2)
...
a post that has not been acknowledged by the U.S. or jovernments.
...
siderations which led to the actual opening of the file. ww)
...
to open a file. The judgment of the officer in question controlled. cu)
...
Issue A - #2, Opening of Lee Harvey Oswald's file.) (we)
...
this subject is that the investigators sought eer from people years
...
filing system awd it will tell where the full file is. There can be no
...
fact, involved in some sort of CI project." Depends on who is Jooking at
files they don't understand. Having asked the question, one must assume
there is a compulsion to write about it. ()

Page 44. Please describe Mrs. Egerter by position in lieu of
using her name, “The CI Staff officer who opened the Oswald 201 file." (ca)

Page 48. Request omit specific reference to "Tegal travelers program."
...
reference to her being denied a security clearance. Ce)

Page 66. Delete “at Harvard University," and change next line to read

“of fris access to others who might be going to the...." This merely tells —

the story while generalizing the specific operational activity. Ce)
...
to financial loans and Bu be deleted. Ce )

Page 82. 7) ea route to USSR. At page 86
reference to the CIA file on pall Consul should be deleted, as should the
reference to CIA Dispatches! Histon the existence of CIA
...
“a dispatch from the Embassy, dated 9.Qctober 1959...."“ The reference to a
CIA dispatch on page 88 should be deleted. Ce) i
