...
Your ?'s re: Overall Digraph and ZR
...
it the the te te the t to the if it i de to it the is if i if the it if i te the of to i it if i it if i I t if f i t . I I I I I . I . . - t I t i fI f t f t t . - t . . . t.
...
or activitles for which responsibility is shared with other components.
...
time in the whole document the following into is mentioned is: "Juan Jose Gonzalez Jimenez

resigned as Mexico City Chairman on 17 Jan 96." He has 201-0000001. The DMB analyst pulls

this info using 'Z' or 'FR', and instead of having a 60 page document in his 201, he has a one.
