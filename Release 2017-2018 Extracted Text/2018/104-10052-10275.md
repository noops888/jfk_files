...
70
Chief, KURIOT Attn: Photographic Branch 2x _| 10 tonne sequen

: omar quanto oxse
Chief, WH Division ts

Chief of Station,’ Mexico City MiCROFIM
‘supvecr
...
Activity for the month of December consisted of the followin;
Installation of the SEQUENCE camera at. the LIERODE basehouse;’ Assistance
was given to C/{¥CHARITY on an audio operation against an LCHARVEST
...
On 17 December 1963 an SWB representative arrived at Mexico City. 4
...
3. SWB Report ‘ fs “popy
_Digtribution: g

V4 - KURIOT, ‘w/encls
1 - WH, w/o encls

CROSS REFERERS TO 5 THBPATGH SIBOL AND MNGER ome
‘yo Ate he file
oe HMMA-22726 16 January 1964
...
i feo
CASIFCATION DISPATCSTMEOT AND NO
...
audio inetallation to the LP were strung and secured below the flooring which had .
...
“leading into the crawl space at the front entrance hall of the buildizig although

the curious would be discouraged to enter this area because of stagnant water
six to ten inches deep on the floors at all times, cob webs, bugs, etc., etce..
...
training period given by RESCIGNO at the M@RCHARITY base, PARMUTH was
able to service this request satisfactorily.’ This extension was one which |
xeplaced one removed (for study) by KUSODA officials who inspected Mexico,
...
Foe USE PREVIOUS EDITION, ‘CLASSIFICATION PAGE NO.
Peo :

‘oa 530 Sa Ghane tos SECRET GSE] connnueo A
WHICH ARE OBSOLETE. =)
...
take to be presented to the COS and G/PBRUMEN for their approval, Both were
...
from both of these cameras dnd make prints daily, it will be necessary to install
...
the installation, amg statistical and training report concerning this operation,
...
sand logs for 30 and 31 December in connection with a priority PBRUMEN operation,

6. Station Support {sw Activity).

as: On 6 December 1963, a-visiting TDYer from Tegucigalpa requested
PARMUTH to train @WILUCK/1 in secret writing, Training was carried out on
...
FORM . USE PREVIOUS EDITION: “CLASSIFICATION PAGENO.
hear BSCS ns al sian SECRET Ladleoumuro 3
Lal * WHICH ARE OBSOLETE. °
...
CEARSICATION [DISPATCH SYMBOL AND NO.
...
(l) Secret writing: issued 1 - 37 carbon to SWLUCK/l.
(2) Flaps and seals: 0,
