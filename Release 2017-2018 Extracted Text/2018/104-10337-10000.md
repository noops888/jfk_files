...
WHouse, craig livingstone 202-456-5216

× 40620, Cleanence Divisor
...
I on the status of the Board's request for
...
reached through the Division's front office 1x4)437) secure,
...
duplicates are flagged and wil be prepared for NARA Later:
...
Agency documents la DO reviewer would join the HRG

reviewers when documents were ready for DO reviewl
...
to review the documents in the
...
should comply with the JFK Board's request to transfer the re-locatien

records, but that the transfer should clearly be documented
...
• alarm systeur including - #4,533.00

ucks a installatie

(ARRB will haulle contract / reimbusement require l
...
Total estimeted additional cost 19, 533.00
...
from CIA/CSI/HRG offices at

Virginia, to the CIA controlled SCIE within the offices of
...
Russell B. HOLMES (AIN 0059388) has been granted an AD HÖC Secret access for the
...
do your recads on Des. Holmes and

accreditation on the 6o0 & Stroet

facility

I Sara ducas requises Copies of

DO NOT use this form

a8 a RECORD of approvals, concurrences, disposals,
...
SUBJECT: [gRe: Parking for JRK ICs downtown

1980

Sarr Park 202-383-6250, cost: $165 @ month for unreserved space at 601 E. St Facility -- Frank talked with Barbara Hicks, extensio

08. If they need a car, we will use Kovar's, but other cars may park in the space on a regular basis. The manager, Mr. Retta,
...
I can't reach Kovar so use my car (1985 CHEV Citation, DC Tag 981442). We will be rotating the individuals working at the SCIF plus I
...
of the JFK SCIE to include equipment and installation of the
...
To Further informatior-i required contane contact
...
4017) (AFMS ID 79002001L00) Cc: 2420
...
Puss dly the attached

take care of the legenay'

There if

I the Corte of ta SCIE
...
your folks to pay the tab by personal check and be reimbursed by CSl. The latter is their preferred
...
y and between Center far Stud

of Intell

_ (Customer) and CarrPark, for parking privileges

• requiring an Initial Foo 08 $ 165°
...
Philip R. Carr. Presider

Money tot cyt

NAME:::

ogamso kit Mr, SIGNATURE
...
customer will be required to pay the Monthly Fee. CarrPark reserves the right to cancel this Agreement without notice
...
riolation of the Agreement. The Customer is responsible for notifying CarrPark if the Monthly Permit for the following

nonth has not been received by the 28th of the current month. Failure to make such notification will result in full daily

sharges assessed for each day a Monthly Permit is not displayed. In the event a Monthly Permit is lost or stolen, a
...
Vonthly Permits to employees/agents as specified in the registration list provided to CarrPark, described below.
...
Sustomer to each such employee/agent. This registration list shall be updated on a monthly basis by the Corporate
...
to considejation of prospective customers on a waiting list for that Facility.
...
I also hold the position Chief of the Publications
...
nas members who serve in senior positions in other agencies of
...
the academic community in the United States and abroad, and from
...
Subsequently, articles are edited and published in one of
