...
page review and-sanitization of classified documents. _ For
...
bf We need reviewers with broad Agency experience, which
...
i Develop a strategy/policy with the IROs concerning the
...
bl Maintain written,up-to-date, project-specific
...
kd there were two major releases of Agency records (August
...
bed approximately 80% of the 227, 000 pages release in
1993-94 contained deletions

Ls resources were taken from other projects and added
...
i We need reviewers with broad Agency experience, which
can be either managerial or substantive.


13-00000

ad We need to establish early on what information is
already in the public domain and address the issue of
“official release” in the context of each project.
...
i On-site Directorate reviewers are the most effective
way to handle the internal coordination requirements of a
large project. Without the DO's JFK team on site it would
have been impossible to complete the JFK project.
...
bel Maintain written, up-to-date, project-specific
declassification guidelines. This-is no small task. A
“declassification guide” must be flexible; no guide can
anticipate all the issues which will arise in a review.
After six years, we were still revising the JFK guidelines
...
DRAFT: Section .2tf, ARRB Requests for Additional
...
to act in a manner prescribed under this cota in-
...
with alfiost unlimited access to Agency records and
...
all began as a request by the Board or an ARRB staff méiber
...
___. histories of CIA offices and projects; a review of the
...
information was involvéd, negotiations took place and, on ©
occasion, a written statement about the materials was
provided for release vice the actual document(s) .

Hy. The Agency’s written responses to each request -
...
SA. Lessons learned: A number of things syrfaced as
...
authority) are met; and, a senior focal point officey who
...
This file contain 442 excerpts from the minutes of the DCI's Moming Meetings
...
* Treat documents in ways different from all other release programs. tok de Jf pal jaatbolt
+ Postpone plans for systematic declassification on other programs forsthinkwe-baino legal
mandate.
...
° We are trying to apply these lessons leaned to our planning for the Nazi War Crimes Disclosure
Act.
...
AIUO When Separated CL BY:
from Attachments CL REASON:
> DECL ON:
...
JEK activity in sight,” resources could be applied to the
...
AIUO When Separated CL BY: {0611637/
from Attachments CL REASON: ~1.5(
...
10. (AIUO) Another long time debate concerned z
...
postponed word, phrase, or paragraph had to the approved __
...
of exact duplicate documents: that they all be handled_
...
e Don’t cut costs on indexing. Use experienced indexers.
...
e Develop better information on the cover status of retired
employees.
...
gai (C) In 1976, then DDI Ed Proctor wrote to the DCI,
...
the records would result in one of the nin
...
4. Segregability and substitute language.

When the Review Board determined that the
tisk of harm did outweigh the public interest
...
Jaw enforcement office that assisted in a fed-
...
FBI files on LeeHarvey Oswald’s wife
...
NAssassinations”(HSCA) Subject Files.
...
Review Board, the FBI coll and began to
...
limitations of this Act if lagencies provide}
...
PORT GF THE’ ASSASSINATION RECOR
...
request for blanket postponements of CLA
...
eonesCist
sw ot, oft, oor, sonrfer) ci/ers, cific 2, £4, 5, WT,

DAMEDUATE

&
veo CTX HISTORICAL REVIEW Pi f i
2 DOCEDIATE Mex! fF Su "ROGRA! 8.4886
REF: MEXI 6453 (IN 36017) 1995

1 monster ro asa asfnboy ape an
cavecnapves a wean 36 0c4T6 AL ATED
rosea ren tre rosa.

2. DISPATCH SOONEST BY SPECIAL COURIER, STAFFER UF
scnsan fete eanicpre ano ont area
AVAILABLE]ALL PERTINENT MATERIAL,

1 fironassareswaeanes] oe

END OF MESSAGE
CS Comment: *Reported that okt | October 63, an‘American mate who satd
‘ste name was Loe Oswald was at the Soviet Embassy in Mexico City,

coon wie O54}. Fal-as7atd
D:ae0-5-4 ( foronteienst are ~RBORS= FT
‘ 23 Ts »

X Seeuso
erent ence <cee |
REPRODUCTION BY OTHER THE ISSUING O ieee 1S PROHIBITED. Sahin
...
Agency employees if it determined that a par- gi
...
protection. NSA argued that the release of arv id
...
_..clear and convincing evidence-that the
threat to the military defense, intelligence
operations, or conduct of foreign relations of
the United States posed by the public disclo-
...
it. Commentary. The Review Board
...
Harter 5: THE STANDARDS FOR Review: Review BOARD “COMMON Law”

ii. Commentary. The Review Board
ased CIA sluglines .because the Agency
r offered the Review Board any evidence
tu explain why the Board should not release
...
i to release the crypt “RYBAT” in two
; elsewhere in the document at issue,
the CIA agreed to release the crypt
<PFLOOR when it appeared in the text. CIA
tald the Review Board that it could not, how-
ever, release the slugline “RYBAT
SVELOOR.” CIA offered no substantive
arguments to support its request for post-
penement of the slugline. Given the statute’s
demand that CIA provide clear and convinc-
iy, evidence in support of its requests for
...
stage “surveillance method,” “operational
...
Fen eaots 3 ston co REX oF owe ALTRI HAY
adopter rs
So eee
apenas
...
Pe SEH
FINAL REPORT OF THE ASSAS:

Record revtewed unilaterally by CIA fa 1992.
eas ues

iD

SPIE: eerste venti he fh cay eet
...
tule, and except for the specific time win-
...
ugatt seatleg Me fame eatde cine
...
i, Review Board guidelines. CLA cable, dis-
...
teleased information that revealed that CIA
...
to pe the individual's identity unless the
...
Cuarrer 5: THE STANDARDS FOR Review: REVIEW BOARD “COMMON Law”
...
se his or her identity. As a general rule, the

»w Board usually protected the identities
...
the Review Board considered whether
...
ag with other United States citizens was gener-
...
i it. Commentary and overview of foreign
...
| o
s
con nennto econ ssonesseeesesenesseesseesneronesseen
...
SUBSECT: DCI Sources and Methods Authority With Respect
...
1992 (ARCA), Pub. L. 102-526, 106 Stat. 3443-3458, reprircedat
44 U.S.C. § 2107 note. For ycur convenience, I have highlighted
the pertinent provisions that will aid in resronding to aa
...
thac may be protected and set a strict procedsral scheme by which
...
to intelligence sources and methods informati subject to the
ARCA.
...
AGENCY- INTERNAL USE ONLY
PRIVILEGED ATTORNEY WORK PROCVCT
...
currently utilized, or reasonably expected to be
utilized, by the ae States Government and which has

not_been offici the disclosure of which
would interfere ae the conduct of intelligence
...
7(4) (1). Specifically, the "Review S5oard shi consider and
...
of information that the originating agency f met the criteria
...
AGENCY-INTERNAL USE ONLY
IVILEGED ATTORNEY WORK PRODUCT
...
early years of the project (1992-1994), with the concurrence of the DO/IRO, but OIM has no ane
...
a
Ve Avstralian———_ ssaseess passers sasastseststocaigatet
...
eabaEs=9¢ cc caasienaait “5 c3, 2-1 5-75 |

cat LIA 2-82

L.sd

Seen essaneaessosnassdtnnonSEsSnGSS
