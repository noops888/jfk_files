...
surrounding teltap operations run by the Agency
(Mexican Sérviceg, official acknowledgment of which could have an

impact ison and foreign. rela . We therefore, wish to
...
Embassies fas long as they appear unilateral and we can cont inied
{Pe protect the existence of any participation of the Mexican ¢

vices. We are willing to release documents which indicate the
...
B. Cryptonyms, such as those in the LI s
unless they appear in the context of ison’
(opera ional equ s{(such as LITENSOR and
LITEMPO) ~~

Cc. We need to continue the protection of the cryptonym
LIENVOY.
This cryptonym is used extensively throughout the
collect to describe \the joint activity from
different perspectives. Individual occurrences may
not seem to reveal anything significant but, when
looking at the crypton: in_context over the entire
collection it Phair acca ee Lace A At we
...
C/IMS/ESG/F. Wickham/44448/13 July 95
