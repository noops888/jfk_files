...
Operational Plan for Continuing
...
an operational plan for the action which we
...
action on a phased basis to

provoke a revolt inside Cuba, since

unless there are major changes in operational and internal con-

ditions in Cuba,

such a revolt if provoked would be totally
...
particularly in Latin America, will be both necessary
...
(Validity of this assumption is questional)
...
Maintain through clandestine means, short of commando
...
Take maximum action to induce a split in the Cuban
...
coverage which has been developed

I by the Clandestine Service.
...
susceptibility to approach

exists. These additional
...
Communications Intelligence: We will continue
...
has been made world-wide of all Comnunist Party
...
suca action would result in unacceptableprejudice to
...
be Latin America where there are
...
we have conducted indicates that

have some direct

pertinent access to Cuban targets. All of these
...
remaining cases in the total of

are bein individually
...
in the areas where the teams are operating

_' In addition, on the most carefully
...
and AUTORRID teams and particularly to recruit and, as
...
status of this program and the proposed further explatation
...
which on the basis of the assumptions in Paragraph I
...
American Airways and KIll to resume their flights between Miami

and Havana at the appropriate time.

D.

It is recommended that if any "Track Two" concept
