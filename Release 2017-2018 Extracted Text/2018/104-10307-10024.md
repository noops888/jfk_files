...
Cc. CIA operations involving a high noise level and a
...
Vakalty of Lhig O4furviyptearn 0 gucctiondlé)
...
tions with the(1s1)resruitea agents now resident in Cuba.
...
BH
the present time we are running Cuban diplomats

stationed outside Cuba as controlled agents and have viable

operations aimed at an additional loan diplomats.
...
increase tneix{ __ intercept coverage of Cuban
communications, 24
...
be Latin America where there are pinetrations of

2
various communist parties. Of this the survey

we have conducted indicates thai" —"have some direct
pertinent access to Cuban targets. All of thes fwhaa
be directed against these targets unless in any case
there are overriding reasons to the contrary, The
remaining cases in the total ofan bein individually
...
successful black infiltrated teams (COBRA aztd AMTORRID)
...
in the areas where the teams are operating Cc)
a In addition, on the most carefully
...
ll. Exfiltration: As feasible, agents and potential
...
Bei it would be advisable to press for the creation within the
...
Cc. The abolition of the operational Mongoose mechanism.
...
ne American Airways and KLM to resume their flights between Miami
