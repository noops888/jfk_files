...
the DS&T questions. Questions have beon added to the DO list to reflect our conversation
...
any record of what happened to the manuals?
...
that, TSC keeps a hardcopy file records of operations that

are either still active, or that are no longer active but

still have technical equipment in place. For example, if

TSG concealed a device in a wall but was unable to retrieve
...
personnel on the use of the equipent, and remove the

equipment when the operation is terminated. Once an

operation is in-place, up and running, the station is
...
production of the Mexico City Station during the period of
...
This cable traffic only covers
...
and the officers producing the
...
TSC would probably not have had access to the raw
...
answer to question 1 nder Surveillance
...
be created using terms, such as, "Castro," search query would
