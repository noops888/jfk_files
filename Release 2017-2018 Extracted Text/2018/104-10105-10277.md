...
concern the fabrication of the for a Mexican operation,

the entry into the ]Embas sy in Mexico City, and the’

loperation. The wording of the
...
journalists as agents; delete the word [_——=é': to. make thee
...
of the names of and Frank Holcomb, both now
retired under cover; a direct reference to joint operations with the
against China; and the wording of his reference
to ias documentation used by the Watergate burglars. The
language of this last item will be changed so that it no longer leaves
the impression that the documentation was prepared by the ee
for this operation.
...
admiration and respéct for the Agency and seems convinced that
