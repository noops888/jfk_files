...
of a group of documents from the Ford Presidential Tibrary.
...
The Board instead questioned the deletions and

asked for more evidence before agreeing to protect.
...
IKey points to make: this is not just Agency decision, NSC

and/or WH will have to be consulted; the protection /

classification has been has up-held by......
...
We could also make available to

oF covert actions pr appropriate ared defending protection

of covert actions

2.

If the Board remains inclined to release, prepare full

evidence package, etc.
...
the ARB staff no later than the week of May 4.
...
(Multiple documents -- I briefed you earlier on this issuel.
...
The Agency may be required to provide additional
...
Aliases [when true name is releasedl
...
documents applying the proposed compromise guidelines.

If

we conclude that the Agency's eguities can be protected

under this compromise, the ARRB staff will present the

guidelines to the Board at the April meeting with the

recommendation that the be adopted.

The staff will describe
