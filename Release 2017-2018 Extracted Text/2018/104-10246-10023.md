...
Peter T. SWINEHART 2X _|NO INDEXING RequiRED
...
- CRERCRTON BIPATEH SHILDON
CONTINUATION OF
DISPATCH SECRET HMMA-28202
...
and FRANCOTTE utilizing the Turret Gamera Concealment device, However,
...
FRANCOTTE that their eupport, and the LIFIRE truck, would be required in
...
quarters at thé conclusion of this operatim. Please refer to HMMA-23189
dated 26 March 1964 for specific details,

5, Station Support

a, On 4 March FRANCOTTE inspected the(passport}camera installation
at the The inspection was conducted by Identity A, whom
FRAN ad previously been introduced to by Gregory D, PARMUTH, Since
...
LIMOPE basehouse,. The entire evening was spent with LIMOPE/l and LIMOPE/2,
...
at the basehouse, but had not beeri used, it was decided to remove this lens from
...
CONTINUATION OF CREATION SPATE STROT ANON
...
Number of people trained in photographic techniques/equipment: 0.
...
Black and White: 49 jobs. -

(1) Total prints: 1,174.
...
FORM VOUS EDITION, ‘CLASSIFICATION PAGE NO.
pee yh AND 51.29 SECRET Jconmmuen 4,
