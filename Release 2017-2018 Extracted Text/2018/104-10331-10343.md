...
The following item numbers are keyed td |
...
decision on disposition of CIA's classified (retention) oFK
collection.
...
Each keyword needs to be a see penianet entity on the extract
disk.
