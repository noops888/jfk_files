...
Reference: EMMW-13207, 14 December 1964

FRE DOI 20-17

Attached by split transmission is an outline for Project LIONION

covering the semices of the two agents heretofore known as LIFEUD-22

(201-288248) and LIFEUD-23 (201-305604) -

This project was anticipated in

paragraph 4, page 9 of the LIRANCH project outline transnitted by Reference.
...
LEONINE DIANA 2510 RESIdESE ANANA
...
recordinz of eventual technical penetration operations of the target.

The target Installation is the PERUMEN Enbassy compound (Including
...
fications by the PBRUMEN section at the Station. then shown canantal. ta

LITAMIL-9) and LETAMIL-7

They are subsequently furwaruea op one ul section or iH/SA where they are shown
...
In eddition to photography, LIONION-1 and LIONION-2 are often called upon
...
e valued piece of real estate which will be used as a listening post when the

Station succeeds in installing additional technical surveillance devices in the

tarzet in the form of concealed radio transmitters.
...
LIONION-1 1s a young PBRUMEN lawyer in exile. He left PHRUMEN in 1960,
...
While in Mexico LIONION-1 was recruited, as LILILY-I, to
...
mother, was recruited in 1961, as LILIUY-2, as a basehouse occupant and
...
and determination to bring about the downfall of, the AMIHUG regime. An

additional notivating factor is that both agents actually enjoy what for many woula
...
to dabble without notable publishing success bacause of family landholdings in

T'ampa, Florida (irherited from his deceased father), which enable him to live as

"rentista,

" one who lives on income from sources other than gainful employment.
...
Commmication 1s prinarily with LIONION-1; with LIONION-? only in his
...
LIONION-] safe apartment. This apartment, which would appear to be a LIONION-1
...
to indicate that they are working for an exile organization based in the MAVE
...
With the KUFIC automatic pulse camera on the premises. This camera is of such
...
investigation or house search for a period of time sufficient to remove compronis-
...
correspondenca to prepare new passports for both LIONION agents so that they may

travel outside Mexico.

Security measures employed in this operation are

designed to make it virtually

impossible

for any opposition service to link LIONION personnel with the Station.

Coordination. Coordination with other PBPRIME elements

or the Mexican government

is not necessary at

this time and none is envisaged.
...
G. Costs. The total annual cost o1 Project LIONION is $10,478, distributed
...
Salaries for LIONION-1 and -2 include the custonary year end

bonus of one month's salary.

LIONION-l's saary was raised Irou $200 to
...
IIONION-2's salary has remained at $150 per month since her
