...
It is requested that you review these drafts and let me have
...
he actually said. The fact is that the Office of Security does
...
1960. The testimony given by the person opening

the file is correct on this
...
September 1960 was of concern because of their previous access
...
copies of records into a single working file. (c)
...
have opened the file, and what is the word "purported" intended to convey? (u)
...
waiti Page I and 2.. The "pre-assassination file" did not contain the letters

cited because the Department of State--which had these--did not provide

them until after the assassination. (U.)

Page 8, The correct date of the-letter is 6-Juty (see-page: 6 of draft) fi)
...
A-6 above, and the conments immediately above apply equally to this. (u)
...
stories. Simply stated, CIA responded to a Warren Commission request. (U:)
...
while avoiding specific reference to the Station, as such.
...
to communications from Mexico City could simple refer to cables
...
been asked " (S, in present context; U relen aloes
...
IN 68376 does refer to an unknown person sitting at Azue's desk, but that
...
New Orleans on 19 September 1963....
...
fly to Mexico and back between

17 and 18 September in order

claims, on 1& September " Getting his pay off, as Alvarado
...
Same page, MEXI 7768 should show as IN 70860. (C)
...
Twentyfourth page, 2007183. MEXI 7256 should show as IN 74273. (c)

Same page.

Objection to discussion of operational details of use
...
ne must have made honest mistake in relatine original story in

is identification of Oswald. " (u
...
publishing his name. That the FBI did conduct an
...
Page 10. The comment at the bottom of this page, describing
...
matter, but that is based on the interpretations of the Committee
...
source evaluation, without specifying tao suedo (5)
...
6/ Classified CIA Document DIR-86767, 4 Dec 63
...
advertised, even if it contributed to the credibility of

the Committee's report.(c

Page 8. Footnote. One officer "claims to believe," as distinguished

from "acknowledges" the possibility of a "vest pocket"

operation known to no
...
Page 18. Top of page. While the cable could provide a proper
...
not, and should not be. The implicit criticism reflects a failure to
...
on the institution of the "AG" sympols. Agency records show that it was
...
Was There a Dual Filing System
...
operation without a record file. The key consideration, if
...
covers the lack of supporting evidence.

This has been the subject of a previous
...
Page 30. It is not at all clear why reference
...
Request omit specific reference to "legal travelers program."
...
82. Oswald in Helsinki en route to USSR. At page 86
