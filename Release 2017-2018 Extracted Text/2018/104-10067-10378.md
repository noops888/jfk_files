...
area on 28 November 1978. “It shouldbe available there; it still is at
CIA headquarters. (e) : .
...
sand why, which was probably broadly correct, although with some errors in

oa The point is that what.she says is the best description on the opening.
I< oo
...
of a 201 file," indicates a misunderstanding of the procedure and standards H
for opening 201 files. (o) . i
...
the officer in question whether. to do so or not, if it met the criteria: ()
There was no requirement to open a file on a person such
as Oswald.» There being no requirement there could be no "failure,"
if it wasn't done. Nor would there have been a “delay.” Oswald's i
...
Further, it was still a judgment cal] when the file was actually opened; 4
...
copies “af records into a single working file. (c)
...
We have given the paper an overall classification of Confidential. ©)

Page.1. The citation of 12 H 212 and 213 should be 11H 212 and 213. Cv )
...
Book III, Séction VIII, D. 8 (Oswald Soviet Correspondence)
It is understood that this is not intended for unclassified

publication and that our review is all that is requested. We have given

- \S the paper an overall classification of Confidential.” Q@)

Bence Page 1 and 2.. The "pre-assassination file" did not contain the letters
> -
...
Page-8-—The-correet-date-of- the-letter—is-6-Jury=(see-page-6-of draft Go)
...
Dear Mr. Blakey:
I am submitting herewith informal comments en the drafts submitted
...
i is my understanding that you intend for only one or two
...
publication,. Jn its present form we have given it an overall classification

i
|

of Confidential. It is understood we are to comment for accuracy only.
We have no points to make on this. ow)
...
of Secret. It is understood we are to conment for accuracy only.CY ) ‘
...
of the investigators to make a formal ‘inquiry about it. fo
...
It is our understanding that this is not intended for unclassified
publication. ain its present form we have given it an overall classification
...
a premise that is highly dubious. 0)
...
it is doubtful that many really knew his private thoughts (vu )
...
matter, but beyond that there was no relation. (ee)
...
and the machinery was also occupied with more likely sources. Cc
...
Sone of the comments will be detailed. (uv)
...
also presents problems with which you ive familiar. It is suggested
...
There we& of course, considerable other Cuban inquiries. Ce)
...
ig a State Department 1182.C¢) a
...
been asked." CS, wn “oveseut couterty O welen stow \.



14-00000

Eighth page, 2001167, line-4, cited.as MEXI 7072n should be IN 68406.(c )

Same page, line 8, cited as MEXI‘7084 should be IN 68496.(C )

Same page, line 11, MEXT 7092 should be IN 68542.(C }
...
Same page, MEXI 7098 should show as IN 69127. (¢e )
...
Eusebio AZCUE; Luisa CALDERON and Alfredo MIRABAL....They may a11
...
that it was_not so much a case of restraining Mann's desire to look into
...
City on the 18th of September. @w)
Same page. MEXI 7107 should show:as IN e9310.(¢ ) :
Same page. Delete "Jerez" and "Nicaraguan." Ce)
Fourteenth page, 2001173. MEXI 7113 should show as IN 69620. (ea)
Seventeenth page, 2001176. MEXI 7120 should show as IN 69670. Cc )
Same page, NEXI 7156 should show as 1N 70530. Cc
Same page, MEXI 7127 should show as IN 70145. Ce)
Same page, MEXI 7168 should show as IN 70860. CC )
Same page, delete "Jerez." ¢ )
Eighteenth page, 2001177. Win Scott should be deleted. Cc )
...
from R. Helms:.to J. Lee Rankin, 6/1/64, Attachment F, p.4. Cv)

Twentyfirst page, 2001189. Delete "Jerez." Cc)
...
in polygraphing ofa foreign national in Mexico City. We would prefer that
...
was polygraphed in a CIA safehougs. That communication was
...
his identification of Oswald." (y)
...
changed to "reported conversations." cs)
...
and Yiaison sources and activities. Reference to photography of the
...
‘Monterrey Base onthe next’ page:should:be. deleted, with reference “to a
...
‘Subsequent observations in the draft. (ec 2) 7
...
they should be destroyed or whether they could be retained because of 7
counter-intelligence interests. This file was categorized for retention
because he Wasa subject of possible interest in the assassination
...
publishing his name. That. the FBI did conduct an extensive ry
...
would permit eventual identification of Lopez. Ce)
...
on a continuing basis, and the dowmplaying of this one was--and remains-- r
; |

{i

@ proper professional judgment. In this case, the report routinely was
forwarded to the FBI, with its primary responsibility for conducting the i
...
Page 11. The draft report errs in relating the treatment inthe CIA’

Task Force Report in 1977. That study pointed out the errors in the Monterrey if
...
of Book V of the Senate report, :withoutundertaking consideration of all the
information available. The selected quotation in the Task Force Report should

be read in its entire context..C-U)



14-00000

Page 13. Reference to a Mexican police source should be deleted. (ec)

Page 13. The HSCA may feel there are sinister implications on this :
matter, but that is:basedson:the ‘interpretations of the Committee ahd not on
the facts.CU )
...
Bureau's not reporting “it, 2s ‘speculationand not fact. Had these been |
a real problem, it would have been worked out. That the Bureau did not
complete its investigation until too late in the scheme of things to report to i
...
2 mot read at CIA, in the CI Staff Oswald file. OF the seven volumes held by
...
vas stated it is incorrect. Cv) . 5
...
the HSCA investigators to explain what they vanted. CU )
...
not noted jn the draft). But the allegation of operational disbursements
...
siderations which led. to the actual opening of the file. (Cj )
...
of Plans, not the "DDO." cw)

Page 2k. The opening form showed only a place for citing a "source
...
Page25. Has the draft erred in using the name "Lee Henry Oswald" at
cthe end of the first paragraph?. Did the author not mean that.had records
on Oswald been sought in his correct riame, Lee Harvey Oswald, it stil] would

have been found although indexed under Lee Henry Oswald? Ce)
...
quite @ good memory on some things). Unfortunately, his memory plays him tricks
...
»avareness (sic) was heightened into concern” by the rough notes when the



14-00000

memorandum from me dated 27 September 1978. (US
...
filing system, ewd it will tell where the full file is. There can be no
...
Page ra It is not at all clear why reference to someone ina
...
there is a compulsion to write about it, 0)

Page the Please describe Mrs. Egerter by position in lieu of
using her name, "The CI Staff officer who opened the Oswald 201 file." C)
...
jeopardize those who may participate in the future. (ee) .
...
reference to her being denied a security clearance. CC)

Page 6. Delete."at Harvard University," and change next line to read
...
cthe USSR, end the sentence with a period after "...from the Soviet Union."
...
written, with deletion for purpose.of the word “Accordingly.” (?
...
@ispatch should be deleted; it should suffice if it was simply stated that

"a dispatch from the Embassy, dated 9 October 1959...." The reference to a

[CIN dispatch] on page 88 should be deleted. Cc)
