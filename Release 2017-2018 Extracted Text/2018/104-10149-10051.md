...
a sat Won
—_ DO: NOT REPRODUCE
UNCLASSIFIED WHEN SEPARATED RETURN To CLA

FROM ATTACHMENTS

RETURN TO CIA APPROVED FOR RELEASE 1993
 Beppound Use Oniy GIA HISTONECA, REVIEW PROGRIM-

ACME fi
rig - Adse ‘
T= OLC/Subj 21167
7 1 = OLC/Chrono
1 - RSG penivativectay AAtzc?
1 - SDB sconseoneeP SCL EITEVW ON lm. 17 52

OLC/SDB/ksn (25 Jan 79) i ; in a
...
Af eDI2T0 JOR RELEAGE 193 .


activity was removed in time from the actual event. In fact, he was
bb ath man to run the Cuban Task Force subsequent to the Bay of
gs.
...
pinto departure serves more to distort the record than to i11uminate
it. (U
...
i_raises_a_sources-and-methods question. References to

General references to the name of the Soviet ConsuT
shou @ considered to determine if the story can be told without
using that name. (C)
...
to allegations which already reflected such speculation. {U) é
...
soca at pages 17, 22, and 23. Does it raise a methods question? (C)
...
Legal Attache's office on the Alvarado nll while the jurisdictional
