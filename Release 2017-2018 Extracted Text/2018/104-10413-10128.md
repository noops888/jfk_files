...
exploit leads from the Soviet Erbassy. This umbrella type project (LIFEAT)
...
were placed by an employee of the telephone company
...
(the American School) (Ranon) collected the film gait
...
Va for ITALIA FilM to se process taid, Mas Ma traM to to (428E)
...
Little and Riquelme Lin), the agent had identified Sancho. (who was
...
new crypts. /svancona) and PetEy Magsara, replaced Anderson in handling
...
official status and arranged to obtain selected letters from
...
foreigners and colitical investigations. Their azents vere vicious, vonal,
...
the airport as well as file searches of names fron DFS Hqtrs where the files
...
replaced by Phil Roettinget (resigned and remained in Mexico), Mahoney, Thomas

(Hazlitt, and Robert Pelamann One After The Ether)
...
grew into a proposal Miguel Aleman (jI. son of former Mexi President), acting
...
manipulated control over the principal agert of LIBIGHT mail intercept. The
...
post where thirty telephone lines would connect as well as a
...
personal problems associated with being outside the station go that the Mexicans
...
approve a request by LIFLEGANT that Brady had turned down by the son, LIENVOrE?.
...
dealingswith the "exteans except when Scott was ill or out of town. Generally,
...
10/65 - 1967 Stanley Watson CY (retired)
...
About nid 1962 (check date) LINNVOY outside Vexi rept asked)
...
2 Polish, and I Jugoslav line. The basehouse listening post had a live
...
operators cleared the camera each day whether there was annettax a full
...
new Soviet. and family, all foreigners and foreign lisenee plates. Hunan
...
frequently developed nechanical difficulties. Bob Zambarnardil and Spathar
...
the caller was trying to speak Russian. Any delay was caused by waiting

to

compare the photographs with the typed transcript. There were

no copies of

transcripts every made in languages other than Spanish or English because Win

Scott. could read only those two languages ard he personally screened
