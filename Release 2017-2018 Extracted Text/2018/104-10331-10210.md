...
serious concerns, as outlined below, and CIA
...
documents originated by these

entities can be released by the
...
Similarly, there is no mechanism that would allow
...
Otherwise, an anomalous situation could
...
same Executive branch information would be
...
rather than review of existing files for
...
is a difficult one, and we do not mean tob suggest that

reasonable requests for materials should denied simply because
...
The resolutions contain no provision reguiring security

clearances or secure document handling by the Assassination

Materials Review

Board or its Executive Director/staff
...
This may not provide sufficient

time for meaningful review

what could prove to be large volumes of
...
automatic 30 day extension to consider whether an
...
Because of this restriction, these individuals

are unlikely to have any familiarity with the documents at

issue and

may well have no expertise in intelligence or law
...
Reguiring that the staff informally
...
that relevant expertise is brought to bear as part
...
adequate to protect Agency interests in certain
...
currently drafted, they would be wholly unavailable.
...
they could well arise with respect to other
...
for congressional oversight of the Review Board
...
be of concern, especially if the Review Board seeks
...
Pof my staff at (703) 482-6126 with any
