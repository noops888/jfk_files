...
*PUNGES matically, downgrad
“fied weangtiled in form’ is det y ae
USS

SSIFIED when blank—TOP, SI

ched ‘from controlled document: i

DOC. DATE
copy NO

NUMBER OF. PAG! iy total E
NUMBER OF. ARIAS ¥

transmitted outside -of CIA.
duttes relate to the’ matter. Top Secret Control Opicers who receive and/or'release :the attached Top Secret ‘material’ will sign ‘this’ form i
and indicate period of custody in the le/t-hand columns provided. Each. individuat who sees, she Top Secret document: will: sign and
indicate the date of handling in the right-hand. columns,

REFERRED TO! RECEIVED Zz RELEASED “| i: SEEN BY
OFFICE - SIGNATURE pate | Time |oate |orime |") SIGNATURE « | orrice/oiv.
...
| NOTICE OF DETACHMENT: When this orm is detached from Top Secret material it shall be completed tn the appropriate spaces below:
and transmitted.to Central Top Secret, Control for record. :

DOWNGRADED : z DESTROYED : DISPATCHED (OUTSIDE CIA) ‘i
BY (Signature) To 7 qe
BY (Signature) WITNESSED BY (Signature) BY. (Signature)
OFFICE E oe DATE 8: gts OFFICE, DATE OFFICE DATE

FORM QG "use. recvious corrrome: ="
...
it clear that there were no grounds for him te believe, and he did
...
_writing in the file’ as follows:
...
AMLASH/I1 of full U.S. support "if there is a change of the
present leadership. "'
...
that, to the Cubans' knowledge, AMLASH/I was not in touch with CIA
...
suggest that Castro was not aware that AMLASH/I1 had any contact
...
of Castro's knowledge, the reports of AMLASH/l's public trial
...
activity during this period, referritig instead to a later time.

The most recent information available indicates that
AMLASH/I is still in jail, where he is serving a thirty year
_sentence.
...
"and complete paragraph, 2d line. The phrase
...
. says "see within weeks of this meeting CIA escalated
...
successful in a coup of his own, There iano
...
contacted the Wice Consul at.the Soviet Embassy in
...
known, as shown by the evidence his views were 7
...
to the possibility of using AMLASH/I1 in the recruit-
...
did make TD" available for interrogation, at which the
FBI was present. : :
...
_ qualify him'to address where things stood in

1963. Infact, he is quoted at page 139 as saying
that he could not recall the time frame.

Page 133. The draft report states that i in October 1963 the
: FBI knew of the "assassination aspect of the
AMLASH" operation, As is noted earlier, 7
