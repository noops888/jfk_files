...
YUNG SSIFIED when blank-TOP SE

T when attached to Top Secret Document

fied wen, filled in form is detached from controlled document.

CONTROL AND COVER SHEET FOR TOP SECRET DOCUMENT

SUB CA

matically downgraded or declassi-

DOCUMENT DESCRIPTIONP

*#puty Inepector General
...
This form will be placed on top of and attached to each Top Secret document Fecetoed Dynthe Central Intelligence Agenc

or classifed TOD Secret within the ClA and will remain attached to the document until such time as it ''downgraded, destroyed,

transmitted outside of CIA..

Access to Top secret matter is limited to Top Secret Control personnel and those individuals whose oficia

duties relate to the matter.

Top secret Control Olicers who receive and/or release the attached, Top secret material will sion this form

and indicate period. of custody in the left-hand columns provided.

Each individual who sees the Top secret document willision and
...
and transmitted. to Central Top Secret Control for
...
AMLASH/l any support prior to a successful coup in Cuba.
...
that, to the Cubans' knowledge, AMLASH/1 was not in touch with CLA
...
activity during this period, referring instead to a later time.
...
"backed by CIA, " in describing the Bay of Pige
...
available for this review, disclose no requeats
...
there was'ho evidence" of intent to use him as an
...
Membership of the Committee con-
...
Tearned( of CIA's operations on 10 October 1963
...
to discuss ting alicy decided to recommend a chang
...
according to the manifest, the only passenger.
...
That the SAS Executive Offcer views the AMIASH
...
at pages 41, 40, 49, and 57. In addition; although IMWAVE
