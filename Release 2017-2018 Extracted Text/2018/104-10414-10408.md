...
hos SSRETER Staten SRR RET
DISPATCH SECRET / 255 BIMMA ~15979
L . AeePet-1842 _
TO; Ghief, WH Division RERGGUATTER FE NO,
bd 50-6-74/1
FROM. ~|oaTE
:_ Chief of Station, Mexico City 18 November 1960
oer BEG" — (CHECK ONE]
- LIEMPTY Project Renewal ~ MARKED FOR INDEXING
NO INDEXING REQUIRED
eeeeiaecoe INDEXING CAN BE JUDGED
~ Renewal of Project 7 _BY QUALIFIED HO, 085K ONLY
...
RECORDS OFFrCER sraup

é
The following action tg
auth ct fn
3
ta Coordinat
4f appropriate,”
os tart 58
= va pvons coon SRST
oss Sant en ano 31.27 i ,
a 3? oats SECRET /tgpeetic |] covnuee
...
and to other Station activities in genera’. SCANTLING's.
production, measured against monetary expenditures,

case officer time and other intangible factors, unques—
tionably justifies his continuation as am integral part
of Project LIEMPTY.

Reymond H. GERENDE Segment (discussed in relation to project
...
visiting or working ak the LIMERICK target.
...
Station efforts is the case ofljoseph Ralph T) In this
case, a LIENVOY lead indicated that an A n might visit
...
quarters, left no question as to(MAURI') identity,
...
observation and arialysis, LICALLA also maintains a daily
