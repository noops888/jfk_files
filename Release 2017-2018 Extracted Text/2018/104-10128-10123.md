...
and application for Federal employment in triplicate. The commini-

cation is from Chief of Station,; Santiago, to Chief, WHD.
...
3. Investigation to be completed as: & Routine
...
and piblishing business in Santiago, Chile. He has been operationally

cleared for use in connection with FULMINATER project (see memo of 3 f

for ADSO). It is now desired to

use his business facilities for|

for cut-out and other agent functions in connection with specirIc OPC
...
7. Subject HAS/AXI been briefed that investigation is pending.

8. Subject HAS/RASHRY been briefed on "cover" story to be used in Investigation.

Has not

9. Subject HKS/KASXIRT Indicated to probable Investigative contacts investiga-
...
I1. CIA indices checks required for provisional operational clearance by

(date)

12. REMARKS: It is hoped this clearance can be granted with a minimun delay
