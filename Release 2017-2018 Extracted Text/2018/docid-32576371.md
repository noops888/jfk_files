...
1 - Mr. Sullivan(J. D. Donohue, 815 RB)

SAC,

Pilladelphia (52-102t sub)
...
telephone terminal box in the rear of 906 South 3th Street to an
...
the chokes and must not have stubs nor multiple appearancés. It may

require opening several cable splices to provide this service.

There is no assurance that the RFVT unit will properly excite
...
It it ie possible to run a drop wire directly from the terminal
...
DocId: 32576371 Page 2

---

## Page 3

box and running the drop wire from this point to the institutions.
...
Referenced communications were in regara to
...
South sth Street, telephone number MA 7-6443, serviced by
...
post number 8 (see sketch S9-0). The second appearance 1s
...
fa parochial institution, further that this unit would be

used to relay technical coverage at target area to Phila-

delphia's central plant, the following information 1s
...
2) - Bureau (92-6054)- (Encs d

1 - Philadelphia (92-1027)b
...
requirement for an RIVT installation,are the previously
