...
of classifications may be impressed with it, but js not substantively
...
ground information on Lopez in Mexico and ae aaa was
...
ar Page 5. Second paragraph. The indicated deletions (Monterrey Station,

and reference to the dealing with

CIA) are appropriate. Thereafter, wher ame appears, it should
...
Page 12. Delete reference to DCOS and|
...
support the thesis.
and nothing anywhere records such a view.
...
That may be difficult for someone outside the intelligence
...
conversation in which she made it. First, itis based on a
...
This js based on an error of.a Warren Commission investigation.
...
Further, no one has told them that such was the case,
...
3. New phrasing on page 5.
4. Deletion of ane on page 5.
