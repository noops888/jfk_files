...
c.nvincing to oake corclusiong • Yest of the questi as during the recent
...
3. In the doctorig opini,n, liSBliKO sentioned to us quito e lou farily
...
ather, and machine stalling about the! activitias ar privato ilvas.

significantly, jost'or the inforcallin ISO has given us lo abaut

paople who are sothr either dond or so longer in authority. For exasalo,

HALYSHET, (fortor dioputy chalran of the Counell of Hinistors, ajod) 3
...
BULGAIN, (DO LONGOr VIP)I SUZNETOT, DEV., (shot); SECiERBANCY,

galorest ng about thiam • For exarlo, ho contioned SHVERUlE uhe LiToSeE

and the

Suritscavaaga Streat, a last Sona to everyone, ex/Sarily Silenashlo

with ELSYGIN • L

Latoly ho sentioned lalahal Zuckoves da fator ubo he knel vo/bava
...
Sotlet officialss, er thin nan is not SCuEllO and ail ho knous 1s the
...
Subnitted herewith, as requested, are AEDIPPER/20's verbatie
...
(Russian language transcripts for Bools #s 6 and 7 are ready for

typing, 1f raqulred); an index to the nanes mentloned in all of the
...
the fifteen (15) corresponding tape recordings already
...
(jorakoy Bazvedyvatel'ayy Punkt = Navy Intelligence

Point) - ASDIPPER/20 stated that at the tine ADOR was assigned to
...
In operation thero, he has no knowledgo of thel specklie. deserations
...
Itsols, but of the State Security practice altays of circulating such
...
followlag key (not repeatod in tbe transcripta):

a. A — ARDIPPER/20;

b. B - AEDONOR;

c. C - T. I. BAGBY (1n the tranacript of Roel # 15 only);

d. () - Single sots of parentheses enclose transliterations

or, in case of

•. (2G), (8G), (81) • Indicate a number of misaing. or garblod

or otheruise "unroadable" nords;

I. (6)) - Double sets of parentheses enclose transeriberl

translator remarks, explanations, otc., In addltlos to/not part of
...
titles, indicate emphasia in speech.

5. As noted, the AKDIPPR/20 transcripts are verbatia transcripta;

however, there has been some "anelloration" of the few obscenities
