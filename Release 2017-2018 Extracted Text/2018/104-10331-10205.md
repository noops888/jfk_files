...
eview for the Board or not acted on by the Board. These include a number of "open in full" documents
...
c. By December 31, 1999, the duplicate documents within the working files of CIA officer Russ Holmes.
...
the will be completed by the deadline, however, we have not received any tapes recently.
...
intensive, and I have not had the resources to handle the fask. This process requires locating each
...
Part of the final decision concering the disposition of the JFK collection; NARA requires the right of
