...
opinion. Please note that this decision affects only thase documents designated "NBR" by ARRB. The documents declared to be
...
staff, some Board members consider ClA use o

as an "open secret" and are inclined to release. We have been offered the
...
2. We need to advise the ARB staff no later than COB 12 November (Wednesday, it we plan to brief the Board on
