...
Chlof of Stetion, Mexico City IN
...
during daylight hours of the entrances of the
...
two traised, full-time surveillance agents who live across the street from

the target

C.

current Related is to sective Not Merlootty A, Objective I, of tie

Background. This project, herewith presented for approval for the first time,

does not represent & new.

LIONION activity has been going on
...
ITIAMI-2 and LITAMIT-I who are l

They are subsequently forwarded to the ll section of IN/SA where they are shown

to PERUMEN intelligence defectors (AMNIP-1 and AMMUG-]. Of those assets to whom
...
with whom wich are of great value to the Station In mounting operations against

the target.

In addition to photography, LICNION-I and LIONION-2 are often called upon

to do visual surveillance of the target installation and LIONION-1 is essential

to the dispaiching of the LIEMBRACE surveillance team against individuals

associated with the target.

Because of the presence of police patrol cars in

the Station's mobile

surveillance assets cannot come close to the

target, hence the need for LIONION-l's dispatching

services:

The presence of LIONION-1 and LIONION-2 also insures continued occupancy of

a valued piece of real estate which vill be used as a listening post when the

Station sucoeeds in installing additional technical surveillance devices in the

target in the form of concealed radio trensmitters..
...
LIONION-1 is a young PHRUMEN lawyer in exile. He left PBRUMEN in 1960,
...
was recruited In 1961, as LITILY-2, as a basehouse occupant and
...
In 1962 LIONION-1 and LIQNION-2 worked

together in processing the take of the wEar Lerode michae installation, now

Known as LICEN.

At this time their cryptonyms were changed from LILILY-1 and

2 to LEDiD 22 and 23, respectively.

In the latter part of 1962 the two agents

began the present photographic surveillance operation.

LIONION] was granted an 0A on 18 May 1962 by HMMW-10664. He was

ICFLUTTERSD on 8 October 1963, HMMW-12064.

LIONION-2 was granted an OA on 16 May 1962 by FMMW-10660.

IIONION-1 is the mainstay of the operation. LIONION-2 acts as his assistant

and f1ll-in at such times as he is absent from the observation post.

principally as observers and photographers.

LIONION-1 also acts as a dispatcher

for the LIANBRACE surveillance team from which he is compartmented. Dispatching

is done by radio using pre-arranged innocuous code terminology; the team does not

know LIONION1 or his precise location.
...
Bot agents realize that they are working for PBPRIMa intelligence; LIONION-1

appears to be aware that he is working for KUBARK... Ide cover utilized by LIONION-?

7 ITONION-1 passes as al

who can afford

to dabble without notablel

_success because of family landholdings in

Tampa, Fiorida (incerited from his deceased father), which enable him to live as
...
ammication 1s primarily with LIONION-1; with LIONION 2 only in hi

absence

Meetings, pre arranged or signalled by innocuous phone calls (call

from LIONION 1 go through a telephone cut-out), are usually held at the

LIONION-I safe apartment. This apartment, which would appear to be a IIONION-1
...
to Indicate that they are working for an exile organization based in the JMNAVE
...
with the KUrIOT automatic pulse camera on the premises. This camers is of such

refinement and complesity as to be difficult to ascribe to an exile organization.
...
Under Mexican law, the principal (photographie) activity of the project is
...
On one occasion AMKNOB-], a JMWAVE asset, was shown a nearby building (not the

LIONION base) by a PERUMEN Embassy officer and told that it was a KUBARK photo
...
measures employed in this operation are designed to make it virtually

impossible for any opposition service to link LIONION personnel with the Station.

Coorcination. Coordination with other PBPRINE elements or the Mexican government
...
Te total annual cost of Project LIONION is $10,478, distributed
...
Salaries for LIOMION-1 and -2 Include the customary year end

bonus se one wonth's salary. LIONION-l's sabry was raised from $200 to

$320 montaly 1n 1954 to compensate in part for his renunciation of a

sales position in order that he might devote his full time to the LIONION

operation. LIONICN-2's salary has remained at $150 per monta since her

recruitnent in 1961. lo salary changes are contemplated during the
