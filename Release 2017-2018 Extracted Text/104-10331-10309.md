...
NARA. The data recorded on

the Id Aid reflects the status of the Id id
...
fiold at input there may be instances where the field is blank.
...
same record. I will talk to Jim on Tuesday but I view this as a human

error.

I will also call NARA and ask them to pull this record for
...
In his manipulation of the disk data Mr. Marweli discovered numerous
...
Refgral marking when the document originator is anything but CIA. This

marking was not inserted by the indexers but by the program. The theory

being that if the document was not CIA it was/is coordinated. It was also
...
Mr. Marwall is concerned that these superfluous digital marks would
