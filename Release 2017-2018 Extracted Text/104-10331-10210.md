...
Agency on Senate Joint Resolution 282, the
...
assassination material, could lead to a
...
so that the initial decisions on whether to
...
conflict with the DCI's statutory duty to protect
