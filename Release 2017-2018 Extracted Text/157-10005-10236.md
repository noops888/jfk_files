...
NH 50955 DocId: 32202426 Page 2

110

Mr. Schwarz. These are minutes of the Special Group which

you attended, and it states:
...
within Cuba and institute a new government with which the
...
ical or paratven is row bring about the regio of the Cubante
...
established within Cuba, to generate the revolt, to give it direction lo-

wards the objective, and to capitalize on the climactic moment.
...
Western Hemisphere to the point of their deep anger and open actions lo
...
appears to be a hopelegs future or the futility of their status.)
...
goal of the Project must be to bring this about,) The popular movemer a
...
also has been tasked with fully assisting State and ClA, as commitments

of Defense men, money, and materiel are required.

K. Major elements of the population

(with resulte largely negative to date) for mounting special group operations

Sate on dare and CA date in a explore their capabilitien
...
Task 1: NIE 85-62 on Cuba due 7 February (CLA).
...
Task 5: CIA to submit plan by l Ecbruary for defection of top Cuban
...
Tasked Durebruary, CLA to submit operations schedule for
...
State to follow up the OAS meeting by having U.s.
...
Task 9: By 15 February, State to submit an inventory of opcrational
...
for which we should provide.

Certain proposals should have
...
EXCLUDED. TRO! AUTO'TIC

PEGRADING: 20D DID 5200.10
...
In deny supply to Soviets and to hinder This can be an early sabotage action on the
...
y dramatic action all people wi

note.

Effects of CIA program of lubricating oil

additive is expected on locomotive stin Jane-

"Jay. Much more can be done with fuel
...
sabotage of Cuban locomotives, throlgh contaminating
...
nside Cuba for some of these residents; a real potentia

xists for collection of intelligence not otherwise avail

able. (FBI support and coordination is basic in this

As Opa-Locka becomes fully activated, CIA will activate

loater is being activate is as prom

local authorities are _being undertaken to activate centers,
...
groups of Cuban nationals Oatheast Aur force Bombing Range, Avon

park, Plorida, immediately. Defense reports that the proposed area?
...
unseat the present Communist Cuban regime.
...
infiltration no Cuba.

Armingror Cuban guerrillas:
...
teams and In the general field of intellen landestine interrogan

pa-locka interrogation center and the
...
portance if view of Duque's stature.)
...
Stettsthat it Is worthwhile to check this capability out, as is now
