...
James O'Connell, Tony Varona, and Juan Orta,
...
views, to you; not necessarily shared by my colleagues.
...
My point is that the HSCA raft is subject to improvement on this
...
. Delete "James 'Big Jim' O'Connell" and replace with the

phrase "chief, Office of Security Operations Support Branch,"
...
Page 6. Change last sentence to commence as follows:
...
Page 1l. Fifth line from bottom. Insert word "unsuccessfully"
...
emphasis to a broader range

than the SSC report really supports.
...
quite some time afterwards, on a time available basis that the CIA Task
...
Page 18. The subparagraph (l), second line. The word "as"
...
Page 23. Top paragraph.

The reason there was no contact with AMLASH
...
24. Second paragraph, first line. Substitute "cabled" for
...
Page 24. Second paragraph, ninth line. Substitute TER for CIA.
...
with the nature of the association with AMIASH, except peripherally. His
...
that FitzGerald's meeting with AMIASH/1 had to do with Castro's
...
One would think that the man's credibility would be tested
...
He admittedly did not know the
...
The draft's assertion that O'Connell and Maheu are
...
and I did the original 196% IG report on assassinations. At that time
...
He is not a philosopher, and I doubt that he would have
...
O'Connell knew from the beginning
...
The interpretation of O'Connell's thought processes are far
...
O'Connell first told the story in some detail (with some error in dates),

inside the Agency for the record (1967), he told it in just those terms

le had no reason then to conceal concern, if any, and current speculatio

really doesn't alter the basic facts of that simple story. There really

was no concern at that time about Giancana leaking

Mouse ant clean upe he presentates to idente san and
...
it started when it was reactivated in April 1962 for Phase I1.
...
dispatched "teams" with the

mission they were supposed to have.
...
of clandestine operations. There are numerous
...
Page 90. Sixteenth line. Delete "in Madrid."
