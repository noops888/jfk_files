...
(U) Issue. The purpose of this memorandum is to
...
nationals, recruited and

living in a foreign country, who
...
(U) This month, the Review Board will be

considering approximately 50-60 true names of human sources

for release.

These particular sources range from encrypted
...
the JFK Collection at this

time so as not to impede the
...
Even if we were able to locate
...
taken into account 1s the difference between CIA and Federal
...
other hand, promises secrecy and confidentiality
...
tact, not only is the identity of CIA sources protected from
...
103(d) (3), codified at 50 U.S.C. 5403(3) (c) (5), requires the

DcI to protect intelligence sources from unauthorized

disclosure.

In addition, §403 (3) (d) (2) requires the DCI to

ensure that risks to the

United States and those involved in
...
or potentially involving classified intormation.
...
cases where the risk

to national security is too great.
...
Supreme Court held that pursuant to the National
...
declassifled within five years.
...
carrying out its statutory obligations, the Review Boar
...
• officers to effectively collect intelligence around
...
In addition to the risk to a source's

personal safety, discovery of

a CIA source would also reveal
...
hostile to the United States and especially CIA.
...
murdered while waiting to turn into CIA Headguarters in
...
working with the CIA abroad face.
...
10 Soviets who were covert assets of the CIA were
...
important to work toward a

general policy of protecting CIA

sources

in the JFK Collection. The Agency proposes that in
...
substitution for the true name be used. In
...
are zone die the can propose be Eat in the namer
...
protection of the fact that he was a
...
protected from release is the new

identity provided to a

defector. Although defectors do

not face some of the
...
risk to their personal safety even in the U.s.
...
Golitsyn's identity had to be changed again.
...
of Golitsyn's current identity.
...
that in these cases, if the

person is deceased and has no

living family, that

the Review Board and the CIA can agree
...
can work out a mutually agreeable policy regarding the
