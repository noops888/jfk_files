...
ADMINISTRATIVE-IN''EHNAL USE UNNE
...
The reguest stems from a requirement
...
forms called "identification

This involves keying in information onto a pre-set

that appears on a personal computer screen. (Experi-
...
The same information that is developed in the aids wilf-be

on diskettes that will be forwarded to the National
...
_Center for the Study of Intelligence, Room
...
CSI-0048, dta 2 Apr 93

ADMINTSTPATTVE-INTERNAL USE ONLY
...
Reguest for Assistance/Declassification of
...
y the JFK Act; therefore, we cannot determine whether the boar

ill have additional requirements for us
...
HRG/CSI/JPereira:hs (3:0335) (17May93)

Retyped:

0/EXDIR/pad (37902) (18May93)

2

"AUTNTOMDAMTVE - -INTERNAL
...
We are arranging to bring in at least 20 indexers

to work overtime on inputting information into the

data base from which identification forms
...
CIA SPECIAL COLLECTIONS 0320/93

RELEASE AS SANITIZEDI, september
...
assassination records is completed.
...
of records on topics such as the Bay of Pigs,
...
7 ICS @ $4,500=$31,500 per mth x 6 months=
...
Cost to complete in 6 months using existing stafting
...
Notes: (1) The estimated cost for existing alfreduced by 50% for the 5 and 6 month
...
Equipant (Kenox), tables

305F

- Stonde space (Files, boxes)
...
on the JFK Paper Project.

I am glad you are pleased with their support.

You might be

interested in knowing that they worked
...
divert resources from other activities and reviews.
...
Jur copy has be matched against the originali
...
designation of the files as assassination
...
ot anticipated when we discussed the completion of th
...
resource impact and to allow us and the CIA to proceed most efficiently with the t

review. We also take very serously our commitment to Congress to complete our work
...
1l. Issues applying to all CIA record groups
...
The ARB staff has completed a survey of the 63 boxes (on the
...
older level provided that all records in the folder are open-in-full. If there are records

n which the CIA is requesting redactions, those records must be identified
...
designated, a RIP will be prepared, and they will be sent for Board
...
to create this separate records group, he did so in otder to facilitate
...
99118/97 TUE 12:37 FAX 202 724 0457
...
Re: Completing the Review of TEK Assassination Records

CIA HASTE ORJECTION TO
...
meeting on October 16, 1996, of her fuil support for the project and her willingness to
...
thought it would be appropriate to advise you of our goais for the upcoming year. It is
...
nandate that custody be transferred to the National Archives in a timely way. We
...
required to fulfil our own responsibilities. Although it is our perception that CIA may
...
О Лі лісамоіюллілиіоло ели

CIA SPRCLAL COLLECTIONS
...
Revlew Project, through 31 September 1998.
...
has recently exercised its statutory
...
must be transferred to custody of the National
...
Sent on 5 November 1997 at 07:27:26 P.M
...
leadline, which would leave little time to complete the
...
request, and a note reflecting

congressional concern. Gina
...
I appreciate the complimentary remarks you
...
Completing the Review of FK Assassination Records
...
Congress, the 'resident, and the American people.
...
1 Staff employee, 13 ICs, 3 summer employees
...
Follow up discussin col heed Rusty is

* need y people, 4 day@wi, tmanths
...
As we discussed, the JFK Project has an immediate need for "A" type support over the next four months (Feb-May/June). |
...
Rich Warshaw (627 @ hri, the cost will be approximately $59,000 to cover the four months. Unless we receive the five requested
...
pace with the reviewers. Does OM have any indexers who would be interested in working on the JFK project?
...
Ve request your approval to add short-term IC resources to the JFK effort immediately as outlined in Barry Marrelson's request below

unds would be needed to reimburse ADD
...
riginal Text of J. Barry Harrelso
...
Lee et. al.: I have asked Jeffry to send us the detailed cost breakout by month. Now what l
...
$$ to be transferred from HRG for FY 98 to make sure we can cover the bill. The, Nancy
...
I've received an estimate from SAIC for contract costs for our next option period, 1 Apr 98 - 31 Mar 99. I wanted to get this information

to you early for planning purposes. I stress that these figures are estimates because we would like to change our contract vehicle from

the current Cost-Plus-Fixed-Fee (CPFF) to a Cost-Plus-Award-Fee (GPAF) contract. With the current CPFF contract, we have very little
...
fully fund the effort, please feel free). I'll keep you posted as I receive more information.
...
DCI Gates decided to start declassification process
...
First two years the Program focused on JFK with two
...
consuming, labor intensive review process:

ill sanitized records had be reviewed by the Boar

ind action taken on each postponed item

Specific evidence of current harm was reguired for
...
in 1993/199 contained deletions.
...
evidence so deficant emmended postpo enguised to prepare
...
and at least two Board sessions to protect

he specific location of an Agency's facility in a fer

locuments. The release of the location would have adde
...
Office of the DDCI and DDP files for the JEK time-frame
...
Board receives extension through FY 1998; mandated
