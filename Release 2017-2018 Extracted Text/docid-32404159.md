...
FROM : JOHN F. PEREIRA, CHIEF HRG/CSI
...
MEMO: REVIEW OF JEK ASSASSINATION RECORDS
...
DATE DE LAST REVIEW: 04/23/03

COMMENTS

.JFK-M-16 : F2: 2000.02.08.08:33:17:560054
...
Review of JFK Assassination Records

Memorandum to you, dtd 1 Feb 93,
...
propose several specific

actions to alleviate the problems.

2.

This section discusses the four basic phases of our
...
Review Group (HRG) has completed the
...
The process of coordinating our
...
One reason is the lack of resources
...
The second reason is the long time it takes to

reach

agreement with the Do on what information can be

released.

In

this regard, part of the problem is the

Do's generally rigid view

on protecting sources and

methods, even in the

face of the provisions in the JFK

law that allow for withholding of
...
Final Redaction: As mentioned above,

preliminary redaction of

the JFK documents is

accomplished during the first review phase.

But final

redaction cannot be performed until coordination with

the DO and other components is completed.
...
Identification Aids and Index: The

requirement to prepare identification aids (computer

forms)

and an index presents
...
form called an identification aid.
...
Even when the software is fully
...
NN 53217 DooId:32404159 Page 3
...
URG. This would free up staff to devote more time to

the other three phases.

b.

Coordination: 1) Request the DO to devote
...
Final Redaction: To the extent that the pace

of coordination is improved, the pace of redaction will

also increase.

However, we need to be prepared for a
...
Identification Aids: It is clear that with
...
also prepare identification aids*
...
We recommend that initially 20

such people be retained to work 10 hours of overtime

An HRG officer would supervise the group and
...
personnel services account, but these would soor

out, and we would need to seek help from the

We plan to send memoranda to the
...
* Surgiet to licitation on CIS fred, for Ecs.
...
AONEITORLAGZUA VERNAL DOS QUEE
...
AONTNIERPARZVE ETERNAL VOR ONE*
...
B. Pages reviewed by the Directorates
