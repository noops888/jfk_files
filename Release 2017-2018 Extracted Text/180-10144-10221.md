...
(AMCLATTER - 1) was terminated effective 7/31/66 :

Termination

carried out

in an amicable manner, AMCLATTER-])to take job
...
Cooperated with ODEARy in job as liaison, volunteering into.
...
would be inquired into orticlally.
...
natters in maun cation with asidaten file l Bark recalled a
...
Mentions Joe Piccolo, UMARd) case officer, re Barker.

- PRO/part I HKH-A- 5126)
...
1ith Bay of Pigs book pefore the Barker-Martinez story is published

lants to cover AMLILAC operations - infiltrations into Cuba
...
since we last met, and as a matter of fact it is,
...
ender direction of Senior Case Officer on Project UMARcoCtion project
...
(Anclatter-I somewhat restless. Had proposed to Bender he might be

utilized one of our training camps In view Twicker assignment

MASH as AMRASP Ops officer believe Amclatter 1's best

utilization assistant to wickerd

9/12/60

office.

Indicates that prior to May 1960, Barker handied out of (KUJUMP?
...
-- Contract information and check list ford
...
During last Bender- AMBIBBY-AMCLATTER meeting AMBIDDY mentionec

follow thru soonest after his return from MY. Hould like te Amclatier

again his Mexicna short-wave broadcasting effört.

cutout between AMBIDDY Jand Mex radio station, location, script writer
...
So cere or a radio) ear on edent

4/6/60

RE: establishment of Amclatter-1,

las Frank Bender representative
...
- Cancellation of file for ANCIATTER-1) 3/29/60, per CI/DA notice
...
-UMATA 2/10/60 Dispatch

Re; documentation required of Amclatter-1 in connection with

trip from Havana to Caracas 15-25 November 1959. /s/
...
Suggesting Barker exfiltration op. recommned Barker guan cia trai

and assit reloate him in Miami where he could assista
...
VOL1- Barkit role 1oi Cateriniled
...
Request[A)renewal for Clara Elena Fernandez Collazo de Barker

to be used as translator.

POA and PRQ part 1 3/13/61 approved

's Ofr:Joe Piccolo- Clara Elena to be sued as translator to hel

lusband inMATE activities. Husband is contract agent with projec
...
Barkar no londer being "case officered" but handled administractive
...
Mr. Spears, FBl rep at the AMEMB, Havana, and also worked with
...
passport and is in US as an SP paroled to Bernie
...
and Alten affairs officeire: Barker's citizenship status.
...
Amclatter-s considered to work
...
develop regular access to this group. Provided

on-the-spot

telephone coverage of DRE strike against Havana, etc.

- Dispatch (GYROSE) Barker progress report for september (UFGA) 6209
...
points.of. Agrarian reform, land redistribution.
...
-- (UFGA/3072 3/18/63 Barker progress report February
...
luis info they wish to have passed on to gave.
...
-(UFGA) 9745 6127163 Barker progréss report for June 1963

Artime, and exiles

Martinez Fragalto provide info on CRC from vantage as general/
...
(ura) 359 Resteduling of air strike and leaflet raid on Havana
...
cited black or an cretion pay-dog bernigerent
...
destined for 852 SW 13th Ct, Miami; Ricarao cuervo
...
of contacts in US and Cuba. Submilted extensive list of ocntacts
...
Has a great deal of affection and respect fon(AMBIDDY- 1.)
...
action. Becasue of Barker's prior overt relationship w/ ClA,
...
Barker reporting re: poisitent rumors that AMBANG-produced
...
request that she send her relative, Regit
...
info FromANCONCERT - Jand Barker thru Hiram donzalez.
...
Info obtained from friend of Johnson - Miami businessman.Pawcci
...
Cover: handled byAMBLINK-1 who knew Barker in Cuba. Currentl

being handled by Cl branch of WAVE station reporting or
...
Ransacking of(AMIBIDDY-1's) house.

Planned air strike against Havana by MIRR

Addtt info on ransacking or AMBIDDY-Is house.

Decision of Bosch to use Cuban pilot on MIRR's

air strike of Havana.

Addtl into re ransacking of/AMBIDDY-1's)nouse
...
Barker in almost daily contact with market td funder has th the

that Castro may be using the bolita.
...
the are nat a Chian an end ate arkoo be the key marg
