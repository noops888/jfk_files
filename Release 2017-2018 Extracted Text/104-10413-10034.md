...
Mexican Gorernent sponsored telephone tap unit, and cor a lon

relationshid which provides access to the
...
to 150 pages per month. The tap center monitors prepare full
...
recorded. This information is given special dissemination to the
...
prior to the assassination of the late President KENNEDY.
...
control, or Tiaison problems during the past year.

7.

This Project encompasses an unofficial liaison
...
friendly attitude of that Government toward
...
was also provided contact with a KUBARK official

in each West European city so that he might send classified

messages to certain trusted Mexican
