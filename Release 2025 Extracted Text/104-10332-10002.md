...
I. Regarding the items discussed in the referenced memos,
...
another project and does not contain a valid
...
futher, undesireable, exposures.

Care must also be taken so

that the release of pseudonyms is not done in such a manner so

as to enable a

researcher to accummulate through an inspection

of numerous documents the approximate size of a
...
in the JFK story. All hqs cable numbers can be released

as can

dispatch numbers to Mexico City.

The release of cable/dispatch

numbers from other Stations can only be done if there has been

prior public identification of a Station in that location.
...
however, could permit detailed analyses of our comno,
...
next of kin to request their permission to release
...
: JFK Project - Review of Cuban Files
...
PNINFINITE assisted in ops in Mexico.
...
with him until circa 1976, at which time he was implicated in bombing of :

involve in quests ance aeraved is Venezuela. As of March 1993, he was still
...
Per 6 June 1995 discussion with Don Hatch,

DA/IRO, "the slug

line is strictly an internal distribution line"
...
meetings with ARRB staff members, ClA's current practice ot redacting the sluglines
...
believe there is any place

we will see that.

She is will to

give upcall AM crypts
...
addressed with the Board. These issues appear throughout the JEK
...
Position on Cryptonyms, Country Designators, Action
...
to field personnel in true

name are uncommon, however, since
...
ISOLATION, ISOMETRIC, ISOTROPIC, MKCOSMOS
...
Accordingly, any crypts,

slugs, or other words associated

with the locations and linking

them with the CIA must not be
...
ISOLATION, ISOMETRIC, ISOTROPIC, MICOSMOS
...
The Directorate of Administration (DA) has
...
ISOLATION and ISOTROPIC

ISOLATION and ISOTROPIC

ISOLATION and ISOMETRIC

ISOMETRIC and MKCOSMOS

3.

Copies of the documents' referred to above are

returned herewith with these terms highlighted in yellow for

deletion.

Also returned are three documents that did not

contain this information (10197, 10198 and 10199). This

concludes DA action on this request.
...
(S) Protection of (IUDECANTER Cryptonym
...
given document TSX-59777 of

• 15 December 1991), and juxtaposed

with the Los Angeles Times article of 29 December 199% would
...
(S) Mindful, however, of the Board's statutory purpose
...
staff to note the classified nature of this
...
(S) As the Board is aware, the relevant document has
...
SUBJECT: (S) Protection of IJDECANTER
...
_identity.redacted but, in fact, IJDECANTER) .It concludes by
...
must protect the cryptony here so that the key intelligence
...
The practice of counterintelligence (CI) -- and

hence the issue of damage to national security
...
• what foreign intelligence sérvice (s)
...
be acquired through/a combination of confession's, polygraph

interviews, and/of

assumptions based on access.
...
the damage will be far beyond the ostensible value.
...
operational, they had taken no countermeasures (1.e.,
...
extensive countermeasures and invaluable intelligence was

directly and immediately lost.

With further respect to question four, we have the

quintessential factor for exploitation.
...
And it would be critically damaging today to confirm

to the Russians the final piece of the PAPUSHIN puzzle and allow

them to have the ultimate benefit from what heretofore has been
...
(S) In sum, question 4 -- bona fides -- is the CI key.

The CIA to date has released all of the substantive information

relating to IJDECANTER in this particular document.
...
and legally compelling issue, there are

three additional points of relevance vis-à-vis harm:

First, is foreign relations.

Inour judgment, the

Russians are fully expect that, after Aldrich

Ames, the

United States is considering avenues of reprisal.
...
it is publicly known at least to some degree.
...
Protection of [IJDECANTER Cryptonym
...
OIM/IRG/LSS: b10/31287 (6 August 1998)
...
_ specifically, the actual

cryptonym of a CIA source (IUDECANTER) •

• It is our considered judgment that the release of

this

cryptonym, in the particular context of the given

document (SX-59777 of 15 December 1991) / and juxtaposedl

with the Los Angeles Times article of 29 December 1997.r
...
Second Chiet Directorate which was.
...
(redacted but, in fact, vIJDECANTER) •

It-concludes-by stating that this-source (IJDECANTER)has

hàd his "...

bona fides ….. fully established (by-CIAl."
...
IJDECANIIR known to the public in true hame and crypt,
...
combination of confessions, polygraph
...
really an issue here since

the Us fully understood the
...
information relating to IJDECANTER in this
...
CI benefit to the Russian Federal

security Service when
...
of course, information on the publicrecord via the
...
compounding consequence for an intelligence
...
damages that I will touch only briefly upon in
...
States is considering avenues of
...
and it would serve only to exacerbate tensions.
...
our capability to assess the bona fides of defectors.
...
9: \irg_frontoffice general/lsslarrbijtp.doc
