...
• (S) Reconsideration of the release of Warrenton, Va. as the location of the CIA Racord Center.
...
We have provided written evidence (D0 riote coordinated with State and copy.of MOA between CIA and State). According to the ARB

staff, some Board members consider CIA use of state coveras an "open secret" and are inclined to release. We have been offered the
...
2. We need to advise the ARRB staff no later than COB 12 November (Wednesday), if we plan to brief the Board on Warrenton
