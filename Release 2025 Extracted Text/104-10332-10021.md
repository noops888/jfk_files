...
release of JFK-related documents
...
mechanism itself is very fragile. Per
...
refers to WIC as a "Top Secret military installation. "currently

addition, the public-at-large truly believes that WIC is a
...
publicity over a WTC ground water

contamination issue, the re-
...
real possibility that cover would be compromised.

4 .

(S) With the closure of Vint Hill, WTC is the sole

remaining

federal facility in the Warrenton area. As a result,
...
Activities at the other three WTC Stations that would

be compromised are as follows:

a.

Station B serves as the principal training site for

the Office of Communications, DTSPO, and the Department of

State.

However, it also is the site of sensitive activities
...
and the Office of Technical Collections.
...
for the Bosnian Peace Talks.

b.

Station C serves as the Agency's primary
...
(S) Warrenton Training Center Cover Considerations

c .

Station D serves as the Agency's primary receiving

site for world-wide communications.
...
This message traffic is vital to national

security preparedness.

WIC's cover allows it to maintain a very low profile. It is that
...
(S) In summary, any affiliation of WTC and the Agency,
...
(S) Required Protection of Warrenton Training
...
decision on 17 November 1997 to reconsider this issue.
...
Required Protection of Warrenton Training Center
...
(S) As we advised previously, identifiable and serious
...
at WTC in support of these efforts
...
which procures, distributes, tests
...
governments, and support activities for the Do's
...
and the various area divisions of the

Directorate of Operations

(hereafter "DO") which

operations overseas elandestine human intelligence
...
Hence, if WTC was associated with CIA, then the presence

of a student at WIC

serve to identify

that officer as a soon-to-be-assigned espionage
...
Accordingly, and as considered in more detail in
...
(S) But in addition to this established mission and
...
alternative ERS site for the Secretary of State.
...
Needless to say, the fact that WTC is not an
...
consideration is being given to also designating WIC 'as the
...
(S) The preceding descriptions of ongoing and planned
...
In sum, WTC would become an easy "target
...
security through a low profile.'
...
For example, Station C has two gates: the first is only 50 feet from

a public road and the second is approximately 600 feet.
...
9. (S) The breach of compound security was by an out-of-state vehicle which
...
WIC information regarding, first, a local militia
...
Agency's communications eguipment and could kill

numerous federal employees at WIC from outside the
...
We know from ample evidence that foreign
...
actuality, clandestine intelligence officers.
...
The official term for such procurements is "SC-1" or "Sterility Code

1" which means that the tangible items purchased cannot be traced to
...
than 40 years, WTC has operated as an Army facility.
...
mission -- those clandestine officers who could cone and
...
overseas as CIA officers.

They have stated that it is

the fact of the current WIC cover which permits them to
...
12 (S) It is not unreasonable to believe that the loss of cover for WTC would
...
Annotated View of WIC Station D
...
g: lipcrawp|general\lss arrb_wtc.doc
