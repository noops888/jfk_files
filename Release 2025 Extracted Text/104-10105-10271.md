...
Mr. Pleasants retired under cover and his past
...
same sentence containing Mr. [Pleasants) name.
...
similarly classified. The description of this activity just o)

1.4 )

lack of an agreement between the Agency

unilateral operations in France] (Item 4 below) is potentially

an additionally damaging blow

to liaison relationships. (Page
...
Ito the narrative but it unnecessarily jarsulaison with the
...
The au page 6s, the pseudony "you f. Rissenhouse" d even 34

though

compromised, never appeared in the press and
...
4-20, including footnote] - 121 [lines 1-16,
...
It describes the Agency's role in the translation, publishinges

and distribution/of Eudocio Ravines' book, The Yenan Way.
...
because it describes a speculio, sensitive operation as well 2534

sensitive sources and methods including thelacquisition of code
...
describes various cover and support facilities used in far tast
...
an operation conducted jointly with a liaison service in Hone
...
and including the footnote on page 99.
...
efforts but are also

disruptive to liaison relationships with

the Japanese. (Page 169 line 23 through page 170, line 22,

including tootnote.)

Page 102 beginning with "Despite" on line Y
...
specific and sensitive CIA operation includ
...
sensitive Agancy sources and nethods.

eleted since it

(Page 181,

Page 108 beginning with "tap" on line I7 through
...
recruitment of an identifiable individual, as wery
...
Soviet intelligence agent. Since this intormatzon was then

turned over to the Agency, a question arises concerning the

need to seek the FBI's prior comments.
...
to be made to have this passage deleted of Changed since itszu

damage potential to liaison relationships
...
terred to by date and position and thus, dre identifiable.
...
'monitoring of forty-two telephone

lines)'• Page 200, lines 6-18.J
...
it describes a sensitive operation conducted jointly)

with a liaison (Uruguayan) service which Invoived code materials
...
book. In addition an eftort ought to be. made to have the author
...
passage in order that they be made aware of its possible
...
because it spouses the classified activities of a clA officer,

Roger Goiran.

assignments

as his involvement in the compilation of ,a classified

in Tehran and BrusselS, encyclopedic
...
of one of the principals of the free Cuba

Page 150, all of lines 14 through 6. It would appear
...
ought to be made by OGC to have the author rewite this version

in ordes to reflect Dr. Malloy's true role in this affair.

Malloy" s

Page 260, lines 22-23 through page 261, lines 7-?.)
...
alias documentation by Hunt and others in-
