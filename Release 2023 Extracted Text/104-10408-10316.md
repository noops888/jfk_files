...
SUBJECT RECENTLY NITENDED THE SEVENTEENTR ANNUAL

I CONFERENCE OF THE INTERNATIONAL ASSOCIATION OF CHEMISES

AND PHARYACISTS MILO IN MUNICH,

GERYANY FROM 22 THROUGH
...
9. Name Typo Indicator

10. 01. Codes

11. Record Dato (year only)
...
persons for whom provisional operational approvals and operational

approvals

are requested (see exception belosi). 201 files are not to be opened on staff!
...
formation about a 201 personality should be filed or cross-referenced inl

is dossier. When additional information is discovered on a 201 subject throug
...
da dear let order lie in do i Co to too load a

of the TS document

(0) Deferred documents (see 5b(2)).
...
or KAPOK document sent to Central Files not in & black-taped envelope will
...
BUNSMITINI OF DUCTIVE 201 DOSSIERS
...
All documnare prior to

2(204).

Carpardos 20 IP/PLIer: 11:
...
Tals 1s to notisy you that eccountability for the document(a) and/or file(s) cited

below has been transferred to you by:

Accordingly, IP's recordo sou reflect you as the custodian.

Ext, 4362, 19 you have any questions regarding tois transfer.
...
201 personality will be included ia the Headquarters and field machine listings
...
restrict a fIla, complora Section A (algasturo of R.O, not

сесездату).

To remove.

a restriction, cooplete Soction B (R.O. aignature

12c0.100-

SECTION A

RESTRICT TO: (Use country or Don-country code number, see CSI T0-28).
...
REMOVE RESTRICTION (AURORIZED BY)
...
held in Central Files will be forvarded with the entire dossier and a multiple.
...
c. Anyone requesting a restricted dossier, or a document within á restricted
...
he Automated Index Section (IP/AlS) will provide the identity of t

bject ol a 201 number unless the 201 tile is restricted, in which case t

requester will be referred to the restricting desk.

IP/AIS will also provide tae 201 number assigned to a name, unless the 201

le is restricted, or state that there is no 201 number assigned, Requesters should
...
blank, use the pod-country code 900 in. the action box (Box 14), and Indicate
...
ssued semi-annually to Headguarters and the field; based on a component

"terest as indicated in the "Action Desk" "Country of Location" and "Interes
...
(5) Numerical, leadiag to a cryptonym.
...
(2) 0I codes (organization and/or intelligence affiliation)
...
a user could obtain a list of all 201 personalities whö have been assigned the

Ol code of XX or codes of XX, XY, or XZ. A 201 personality list could also be

produced of all persons who were born in Germany betveen the years 1915
...
(arranged) according to any, but not more than three, of the following keysords:
...
groups and organizations of continuing larget interest. Each of these
...
to it, all of the reporting of the individual's personal history, current
...
is a file. For gsample: A considerable number of stations are concerned
...
sonalities, such lists should contain the names ard identifying data
...
programs within the 201 system. The field recelves current notifica-
