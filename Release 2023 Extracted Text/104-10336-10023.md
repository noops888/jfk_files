...
Attached is all of the available information
...
been destroyed. Since OS files are
...
and from the Soviet Union, (China, Pakietan, and South
...
Gilbert as a resource. Mr. Gilbert), CIC Liaison Officer,
...
conducted by the Security Analysis Group. Mr. Filia was
...
b. The Washinaton Post press clipping dated
...
Question 4i (U) Io the extent that Counterintelligence
...
assassination time period. MI. (Staton made inquiries
...
review of the security file on Marguerite P. Stevens;
...
of this request. Our efforts

were concentrated on the pre-assassination time frame.

4.

(U) This review was conducted by (Katie Nakai
...
generated by the John F. Kennedy Board's desire to review
...
contained any information on Lee Harvey Oswald.
...
HTLINGUAL was a Directorate of Operations project
...
This file contained information from press clippings,
...
An employee of this Office recalls the Defector Machine
...
index of defector names with assigned numbers.

The second

part listed the assigned numbers in numerical order
...
probably retained in the Defectors File. As the
...
Lee Harvey Oswald (#0351164) were

handled by Marguerite D.
...
Request for Additional Information and Records

No. CIA-16 (Oswald Pre-Assassination Files)

No. CIA-IR-24 (Defector File)

This is in response to the ARRB's referent request for

pre-Assassination files this Agency may have had on Lee

Harvey Oswald.

It is believed that the following comments

and two enclosed documents respond fully to your request.

At Tab A is a 22 December 1997 memorandum

containing information from the Agency's Office of Personnel

Security which provides

• details about the files it had on
...
Also enclosed at Tab B is a 27 October 1977

memorandum from the Office of Personal Security which

explains the numbering of that Office's file on Oswald..
...
The Oswald Office of Personnel Security file and

pages of the defector file deemed relevant by the ARRB

member have been forwarded to Historical Review. Group

for review and will be processed according to current JFK
