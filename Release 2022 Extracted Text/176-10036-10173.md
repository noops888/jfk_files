...
high prospect of sieeesat We have never considered any betrayal
...
-LOP-SECRET EYES ONLY


( a C)

- FOP-SECRET EYES ONLY 72-
...
generals because of Se for pcaent regime. We recognize heed to
...
-given as a friend and any opposition to their pbjectives.

Q aoe

4K. We continue to be deeply interested in up-to-the-minute i
...
vy To clarify our intent, paragraph 7 of our 79109 is rescinded
...
sure it will help to pun Harkins fully informed at all stages and to
...
Gonein nor any other reporting source is getting the clarity we would
...
OR-SECRET EYES ONLY -3- 10/30/63
...
for our resolutionywhen time permits.
...
-FOP-SECRET EYES ONLY <4 10/30/63
such as removal of key personalities or relay of Pulesumpe pi
In such actions, however, U. 5. authorities will POS avoid
...
d, But once a coup under responsible leadership has _
begun, and within these restrictions, itis in the interest of the U.S.
” Government that it should succeed,
7%. We have your message about return to Washington and =

GLE pangh is comment |

ennomeoment-hestretelrendy beer tiradey, we suggest that jade kept
