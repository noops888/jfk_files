...
a. On the basis of a lead from the ODA CID installation in
...
one trip to veracruz with results that contributed substangie y to
...
1962, SCANTLING is also used to spot and rent safe houses anubpartments

for other Station operations. SECRET

Excluded from actorati:
...
GER ENDE is used frequently to rent hotel rooms and apartments for other
