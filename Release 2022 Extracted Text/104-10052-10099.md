...
SCANTLING has continued (see pre-
...
all LIENVOY leads which indicate interesi by Soviets in specific quarters.
...
one trip to Veracruz with results that contributed supstant to
...
Station Soviet double agent which contributed significamly to thai
...
SCANTLING nandled LIEMBROIL - 2 until the return of LIMOTOR - 14 in July
...
As stated in the preceding Requests for Project Renewal,
...
There has been no change in Projeci LIEMPTY which would alter
...
improve the compartmentation and security of the projeci.
