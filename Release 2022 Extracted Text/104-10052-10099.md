‘od-10682%10088| [2022 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS ACT OF 1992
* 1
...
= Speer) |
- - ; WW
Chief of Station, Mexico City NESS '
ECT '
...
intelligence officer assigned to Mexico under diplomatic cover, ith the
...
current records on the residences of ithe many Soviet persomnel in Mexico
...
operation to unobirusively sabotage a large unit of agricultural
...
one trip to Veracruz wi ‘hat contributed subptatpithyto,
...
‘Station Soviet double agent which contributed significayprly to that
operation,
...
_ 4, In addition to his contributions to the above objectives, SCANTLING
is used for miscellaneous support requirements from the Station, For example,
SCANTLING handied.LIEMBROIL=2 until the recurn of LIMOTOR-14 in July
1962, SCANTLING is also used ag spot and rent safe house;
for other Station operacions,
...
3. “To provide operational support to Station operations, i. &.',
...
As stated in previous project renewals, it can readily be noted that 1
...
improve the comparimentation and secugity of the project,
...
LIEMPTY-13 2, 2003.00

LIEMPTY-14 2, 200,00

LIEMPTY-19 1,000.00

LIEMPTY-24 (no salary) ooo
