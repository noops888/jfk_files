...
We find no record that mail intercept operations were discussed
...
or individuals mailed spontaneous letters to CIA-supported

enterprises. Again,

there is nothing unusual about this--regular use

of the mail

system.

IAB C-- Special covert operations which make use of the mails, including:
...
C-3--Some covert operations using the mail may have been desiened

Note that the last item in this group (17 and

10 January 1972) refers to "letter-insert mechanisms." I can find

no elaboration of what this means, but it might represent intercent
...
senuing leters ostensibly Irom groups in North Vietnam to other
...
TOP SECRET SENSITIVE Attachment gIC=7
...
IOP SECRET 'SENSITIVE Attachments -3-
