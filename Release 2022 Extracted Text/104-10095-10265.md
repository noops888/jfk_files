...
Ld Division File Search

Background Use Only

RETURN TO CIA Dee 176

•Do Not Reproduce

1. I net with Bill Sturbitts and Chris Hopkins for about an

hour this afternoon to review the statua of the In task force on
...
plue some 300 files to which the material in the 900 files led. Chris
...
tripes and what they were reporting. Some 12 box»s of this material
...
envistoned separate rackages covered with a brief description or explanati on,

which would be used for writing a final report with some attachments, but

the finst set of packages or bundles being held for the record of the
...
An attegpt is bing made

be identifythe persons, nut at present it is an inteiguing but not
...
bo There are some gaps in the files
...
I mentioned the speculation in O/S about Frank Sturgis
...
Havana. Orta came ou; of Havana and soneone fet. hit and took the

tabssesendingtitito Miami, where the CA people took poosession.

A search for the mss has been fruitless to date. (Don feath) O3

remembers its existence, but not; its contents. ritz "arkin) may.
...
that much, and a final sunmary can be undertaken. In terns of what has
