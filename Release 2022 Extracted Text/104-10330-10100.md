...
2022 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECO 97-46020F 1992
...
CLA has made all reasonable attempts to locate, review, and declassify all available
...
BOARD MEMBERS: John R. Tunheim, Chair • Henry F. Graff - Kermit L. Hall - William L. Joyce • Anna K. NelsoniDEC
...
sufficiently the pace of the review process to meet
...
allow us to recommend to the Board what
...
Dave CSI asiers to you greetin
...
I torwarded them to Comptroller, too.

Comptroller provided additioned background, also attached..
...
In Brian Latell's absence, I am providing the following response to the Exit's questions regarding the
...
SUBJECT: BaRe: CSI Resource Request regarding JFK

Some background information for you:

(S) First, although Congress authorized and appropriated $5.5 million for classification management, it is

unlikely_ that_CS| will receive_the_full $5.5 million. Why? Congress levied a tax on DoD procurement that

will have a significant impact on ClA's program because of the fact that

As a result of that tax, CIA has to take about a $49 million
...
(C) In addition, CIA has a large FY98 unfunded bill (

On Friday, we will determine how
...
§aware of a shortfall in FY99 of about
...
Classification of Material Transmilled
...
Roquent for additional tuady for. the JiK AssassinatiOn

Records Review Projact, through 31 September 1998.

Refereace: Itx. to Executive Director form J. Jeremy Gunn,
...
complete for that of i econd tate a de tation to
...
the review and transfer proceas. Referent letter is the
...
additional resources, at least through 30 September.
...
The ARRE has recently exercised its statutory
...
the ARB staff continues its review of Agency files.
...
Additional Resounces Reguested.

3. The following estimate is based on our understanding

of the ARRa requirements at this time.
...
equivalent of 1.5 man-years (2 contractorg --
...
Reproduction: approximately one-man year of

overtime (525 hourly rate.
...
Roguast for Funde fox Declaralfication of Korear Documents

•1. Background. In December 1995, the Director of.

Central Intelligence drafted a Policy Directiva calling for

the implementation of a community-wide systematic

declassification program under the leadership of the Center

for the Study of Intelligence (CSI). The Coumunity

Historical Raview Advisory Committee (CHRAC). Chaired by the

Dixector of CSI, was formed last year to implement the DCI's
...
At the October meeting of the CrAC, the agency
...
?. The ketean projecte Funde are requested for the

Agency to fully participate in this project.

With funding,

CsI, in cooperation with the Agency's automatic

declassification program (OIN/IRG/ADD), will revlew for

possible declassification intelligence records related to

the Korean War period (1 January 1950 through 27 July 1953).

The raview would be done concurrently with the rest of the

Intelligence Community. The joint effort will be

coordinated by CSI.

The Protect's Costu Preliminary research done by
...
The following costs would be incurzed during

such a review:

• Document Preparation (select pertinent documents for

copying and organize

for 50 days (5i3,000g bem for revlewers) - One contractor

• Copying Expenses - One copier, at 75 pages per hour for
...
"Contractor is approximataly $270 per day.
...
• Document Massaging (input of staff supervisor, time to.

utside coordination, and preparation of final copies fo
...
"The total 1o a conservative estimate that could escalate depending
...
other teached de taste le doc mence deto dot personnel and cost os
