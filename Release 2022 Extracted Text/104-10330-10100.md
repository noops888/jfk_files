‘Wfod-10530<10100. 2022 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS acy OF 1992 |
rae ER 97-4602
...
Boaro Memacrs: John R. Tunheim, Chair + Henry F. Graff + Kermit L. Hall + William L. Joyce + Anna K. Nels
€xecurive Dinecton: David G. Marwell
...
cpp pares CIA SPECIAL COLLECTIONS
LE ee ccet ae RELEASE AS SANITIZED
...
xecords to the fullest extent possible.
...
Alot - CSE areweree Zee rs fon ist ivescniere

on SFK prefect pect ove Xt

av Frm: COL 1-82

seas forwarded fhm fo Cou Frellr, fev.
0 Compt le prorided adbitind Chae Ap.
NOTE FOR: CC: Cina,
...
SUBJECT: CS! Resource Request regarding JFK
...
cc: Brian S. Latell (Patricia F. Duryee} Rodney A. Snyder(Rex H. Lathani-C-,(Robert E>
(Ceggett,U. Barry Harrelson
...
SUBJECT: i}Re: CSI Resource Request regarding JFK
...
| | As aresult of that tax/CIA has to take about a $49 million
reduction across all programs (per SAC direction). This will impact on all acti

cr liding new adds.”
Each activity can expect to lose“about 1% of its resources. We will identify specifically how to take this cut
at Friday’s offsite. q

(C)\In addition, CIA has a large FY98 unfunded bill ( } On Friday, we will determine how
to reduce and/or pay that bill. One of the propésals on the table for paying that bill is to use’some of the)
{ Congressional add money $- obviously, we would have to work thisdwith the Hill} but the bottom line is that

some of the declass money may be redirected to other priorities.

$EEEEEEERESEDERESDDOr™ _ - - —
(C)\Finally, we may decide to use some of the adds to prepay some FY99 shortfalls. We are already )
aware of a shortfall in FY99 of about feseeusna PERE eee PEER
...
“NOV. a7 797 10:31AM, . i aa :
Classification of Material Transmitted EX DIR.
D/EKOIK
...
IEEE IEE EINE IIE HEE HI EININ HEE IEEE BER EEE IEEE EE EE
...
SENDING FAX NO. _703-613- *frode), ©%
DELIVER TO: Becky Sr ads CKO ee

RECEIVING FAXNO. JO3- 734- 1919

—_—
DATE TRANSMITTED: af’ 4 ~~ PAGES TRANSMITTED: x)
: "(including cover sheet)
TRANSMITTED BY: arbere

He enn i nnnnneniiiniiirini ene reeneneenretntes
...
Executive Director, Assassination Reconds Review Board
(ARRB), copy attached.
...
complete ite review of all records held by the U.s.
...
2. C6I/HRG has carefully reviewed its current position
...
xeview processiand ARRB action would have to be completed by
...
tt a -- average daily contractor cost
270) 5
...
Nov @7 S97 10:33AM P.4

Request for Funds for Declassification of Korean Documenta

‘1. Backgromd. In December 1995, the Director of.
...
Commmity. At the October meeting of the CHRAC, the agency
...
aoe to. fully ‘participate din this project. With funding,
...
3. The Projects Cost. Preliminary research done by
...
copying and organize fhem for reviewers) ~ One contractor
for 50 days ($13,000)* ~*~

*¢ Copying Expenses - One ci copier, at 75 pages per ‘hour for
2000 hours ($50,000)*
