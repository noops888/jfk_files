...
Thanks for the quick response on Lockheed. I passed the information to the ARB staff; they will keep us informed. The fax
...
Marsha Hubbs @ DST, Bonnie Hunter
...
HRMIMSIINFO COORDINATOR

05/05/97 04:41:06 PM

SUBJECT: CRe: ARRB Request
...
Note: +4/IR080599/IRO heue no pellen

with APREs saff Heyng to locate indruidual
...
that the analysis (of which trames in which shots struck occupants of the limousine) was performed at the
...
(in an attempt to specity whether McMahon was referring to R.I.T., or Kodak) asked whether he meant
...
manual a it me tie Manito at a to no palover than r
...
clarity whether the home movie was slit or unslit, and McMahon said that he was pretty sure the film was
...
-At this point Horne informed Mr. McMahon that CIA's HRG had deposited a surviving briefing board
...
the developing and processing of 8mm film; Jim Milch had given me permission to contact Rollie directly

on an informal basis.

I asked Rollie whether copies of the original Zapruder film could have been properly exposed on a

contact printer using Kodachrome Il daylight film, vice Kodachrome lIA (designed for a tungsten light

source). He said the answer was yes, but that the exposure would be extremely slow, because more

exposure time would be needed for the Kodachrome ll (daylight) film than for the Tungsten film. He
...
second per frame with Kodachrome IlA; he said that the contact printer would have to be operated much
...
was Kodachrome Il, whether the film was Il (daylight) or lIA (tungsten light source), and that the

designation IlA vice Il simply indicates a variation in color balance, but not a change in product type. He
...
DEVELOPED AY KOASK a ROCHESTER.

(PROVIDED BY ME. POLANS ZANADA)
...
ORIENTATION : WHEN EDGE PRINT ES
...
EXGE-PRINT.ON SECRET SERVICE

Capy # 1 (JuLy 16,1997)

ASSASSINATION SERMONCE (DONEY PLAZA) :
...
BASE (SHaNy) SIDE "U'", wHEN

EDGE PRINT READ CORRECTLY

HOME MOVIE" SEQUENCE:

PROCESSES BY KODAK ODD NOV 63

BLUE (TURQUOISE) LETTES)

ESUPERIMPOSED OVER BUE LETTERINE IS

SAFETY FILM", READ BACKWARAS ]

ARTEAMATIONS: RACE CHARDSING "ID"

1,

QUE LATERING

LETERING REIA CORRECTLY
...
ORIENTATION: BASE(SHINY) SADE "UP" WHew

EDGE PRINT READ CORRIETLY
...
"(BLE oR TURQUORSE LETERS).

ORIENTATION: BASE (SHENY) SIDE "UP" WHEN

BILE EDGE-PRINT READ CORRECTLY.
...
APPEARS REVORSER, IN WHITE, ADDACENT TO

ALSO: thE wards

SAFETY FILM" OVERLAP DAEN
...
a job at NPIC before he left the Air Force. He said he leit the Air Force on 30 November 1962, started
...
even anyone else at NPIC, and that it people were to press him on it, they were to be directed to call
...
and talk about these events from 1963. We asked him to defer untit after we had formally interviewed Mr.
...
that it he (Ben Hunter) was available at that time, we would include him; otherwise, we would schedule a
...
-He said he now is fairty certain that Captain Sands was a high-ranking employee in NPIC's
...
wanted to interview Mr. Mcmahon first, and promised to pass McMahon's telephone number to him atter
...
ARRB has requested information on former ClA employee, John Sands. He is reported to have been a Security Officer at NPIC in
...
Becky Rant @ DA, Teresa Wilcox @ DST, Bonnie Hunter
...
an in-depth, in-person interview at Archives Il during which the original working notes from NFIC and a
...
Although no materials produced were stamped with classification markings, Smith told Mcwahon that the
...
manufacture of greatly magnified indiviaval 8 mm movie frames as internegatives as the
...
Horne e: Iwp-docs ledgeprnt.wpd
...
(DA, DS&T) Zapruder film - Homer McMahon, NPIC Tech who worked on the film, said it was developed at Hawkeye works in
...
As noted in Barry Harrelson's note below, Homer McMahon advised that the Zapruder film was developed at Hawkeye works in
...
memo (presumably prepared on May 13, 1975), which forwarded these working papers? F &
...
immedeatel attached Doc. fram ViK 52, 24.

(ch is actuall 3 docs

not includes in de batch jiu yoe me.

e23 assel memo from Simmons—

appeas to have been premia
...
OVER 52, 59 contains masto de

documents.

• Cannot locate le 20)na, 76 meno
...
randuu. On 8 May 1975, Mr. Olsen asked for copies of any
...
AEPRANOS FOA RELEASEISS?

CLA HISTURIGAL REVIEN PRCCRAN

CGL-ANHLYSIS oF ZAPRUDER FIeM
...
You recently asked for angs textual materiais

that may have been provided by the Agency to the

Secret Service in connection with the PIC

analysis of the Zaprader film.

. T'he only testual material involved is attached.

I understand you have had a Iceting with NPIC
...
Intornation las corsarded io the commission previously

on this natter in connection vich our connents on tic loch

пспо-

randum. On s day 1975, Mr. Olsen ashod for copies of any

acroranda or other tortual infornation provided to the Sccret

. Service by CIA after NPIC's analysis of the Zapruder film. Ne

have no indication in our records that any

such written naterial

was provided to the Sccret Service. Attached are copies of the
...
the color photography lab at the National-Photographic Interpretation Center.
...
Re: Status of CLA Responses to Assassination Records Reviesv Board's Requests for
...
BOARO MEMBERS: John R. Tunheim. Chair • Henry F. Graff - Kermis !. Mall - William L. Jorce • Anna K. Nelson
...
CLA-IR-25 Zapruder Film.

The Board has requested any and all records, not previously located in the

Sequestered Collection, on any handling by the CLA of the Zapruder film. In
...
Uz sheist, UP. 1, spoil he de daled in quested, in on, te he a was drovided with a revised

4. CIA-IR-17 DS&T Records on Castro Assassination Plots - Closed per Board memo.

5. CIA-IR-25 Zapruder Fllm - As previously reported, a search was conducted on the terms:

ZAPRUDER, UrK, Commission, and 1963. Hits on year 1963 did not reveal any pertinent information to

the request. I am, therefore, requesting that this action be closed.

AHB.Q7 Claudo Barnes Capshart,

Closed

309799491

1987 ConCur 1/1, 9 po. 191-92-112 Final response s
...
2. CHA 10 "Eletrente tate from texter enty Stron This

memorandum addresses the portion of the action "In addition, the Board is still awaiting

a response on the present location of Stal D records. Regardless of the outcome of

these particular searches, the Review Board continues to seek a full accounting for all
...
(poor quality) was between a man and woman who are just talking about office
...
Records Retirement Requests, no information pertinent to the request surfaced. There
...
are no shelflists (folder-inventory) asso

lated with these Records Retirement Requests

since the Division D records were recg ded intitally in the DO system. I have attached

six Records Retirement Requests wh

pse job numbers relfect the years 1959-1962
...
6. 62S0C 986R -Transferred to OSO (DS&T) 1974

These were the only

records Retirement Requests in the possession of OTC

that are in the timeframe rele ant to the JFK assassination. As their descriptions

indicate, they do not appea

relevant to the request.

2c. A search was cinducted on CITO (Clandestine Information Technology

(Office). This fairly new Di
...
ducted on OTS, OTO and CITO records used the following
...
IA-IR-07 Claude Barnes Capehart. Closed per Board memo.

SCIA-IR-33 FBIS-USR-92-112 Final response submitted for review to DS&T
...
ARRB Reguest No. CIA-IR-25, Bill
...
3. The Agency has conducted

a search of its records. for

the NPIC log books and a Bill or William Green who may have

worked at NPIC or in another capacity which would have

caused him to deal with the Zapruder film.
