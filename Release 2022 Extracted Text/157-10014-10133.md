157-10014-10133 2022 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS ACT OF 1992 |
...
RECORD SERIES: MISCELLANEOUS RECORDS onTHE CHURCH COMMITTTEE
{
AGENCY FILENUMBER: —07-M-39 i i
...
;
i" i ie)
pitch and recruit a stual © as an agent, but you must, when you

do.that, when you reallyjibring him into an operational relation4

ship with the Agency, hel should be so informed and not brought
rit
i
ik
1
...
by the CIA be informed ae fis relationship with the CIA
at the time that that relationship is established?

Why do you condition lit upon payment or leaving the
country? : ii

‘ Senator Huddleston. well, I was going to say there are
many, many initial contaét's that do not advance maybe much
further than that, and for the CIA to have to be exposed maybe

on each-of those might not be reasonable. What .we have tried

to do is to make the wittiingness be known about the time that
...
Now, that may be top| restrictive and go beyond what the
Committee intended, pee sb” therefore we wanted to raise this
i
...
As I understand. . what we were -- it was not clear, but

imal
it is possible that what the Committee had in mind was that

any writing, publicatign| for distribution in the United States
: ee

would have been the appropriate formulation for this, and if

that is correct, we can ke a very easy fix.
...
al particular purpose. If. the programs are then used for another
2 purpose by the Government, that was considered and suggested
3 that that second purpose’ should not be used.
4 Now, if you want to; exempt certain categories fore and
...
13] Of training. Most of them — of course, are from.friendly
14 || nations to start with.
15 I don't know, you: kiow, military. Once a person puts on
ig || a uniform, he becomes fair game. in a number of ways. He gives
17 || Up a Lot of protections that civilians have.
18 Senator Schweiker. | You allow him to recruit--- under
1g || other policies here we allow them to recruit foreign military
20 || officers because I thinki that's an even more valid Pat ionchie
pg) |) than the students, but/ I make it clear that what we don't
...
TOP SECRET
MW 50955 Docta:3b423521 Page 16 ee
...
we are endangering the wea report, so you make that kind of
...
three other things. I'm hot picking at any of them, r am

just sort of accepting te recommendations of the Subcommittee,
...
Subcommittee has been ee of that situation. I think it is

because of that that mit of these recommendations are. already
softer than some of us. foes would be appropriate, and this

is one of the fields. There was a considerable amount of suppoxt
...
already made that eee ee in 1967, and reconfirmed in 1973.
...
now under tie pocess of Information Act, that part of 50-10
...
which have been authentiéated by the Agency, that there are
