...
SUBJECT: Release of JFK Assassination Records eae
...
not identify the full extent of that relationship.) iat
...
-eryptonyms when present in cable sluglines, we would appreciate receiving it by this
...
give up-d&1l AM crypts simply because there are so many
...
investigation and fender an easiér reading of the written ~
material.
...
104-10177-10230 ISOMETRIC and MKCOSMOS a
...
SUBJECT? (S) Protection of { TIDECANTER| Cryptonym
te (S) This memorandum responds to the Assassination
...
of a CIA source (IIDECANTER) . It is our considered judgment that
the release of this crypton: cryptonym, in the particular context of the
given document (sx- -59777 of “a5 December 199%) sand juxtaposed

(with the Los ;_Angeles - Times article cof. 29 December’ 199%," would
...
in this or any other document where it appears and
would otherwise be releasable.

cee (U) As a preliminary matter, I would respectfully ask
...
SECRET
SUBJECT: (S) Protection of (IJDECANTER|Ccryptonym
...
*(identity..rcedacted_but,__in_ fact, IJDECANTER)_._ It_concludes_by——____ 3}
‘Nstating that this source (IJDECANTER) has had his "... bona fides
Xs. fully established [by CIA]." It is this final fact which is’
critical to our request. By having released this substantive”
iapsouccier -- “bona fides ... established" -- and by otherwise
having, TJDECANTER known. to the public in true name and i_érypt, we |
must protéct the cryptonym here so that the key inteldigence i

judgment OR GIA is not compromised.
= ee

| S. (Cc) The practice of counterintelligence-(cI) -- and
hence the issue of\damage to national securit 3 proceeds from

four basic questions: i de

° what information was compromised?

e what foreign intelligence sérvice(s) received the
information? ZA

i | ¢ what understanding of je information did the
| service(s) have? oN

¢ what information 4d the intelligence service(s) {
believe and thus’ act on to its benefit and to the |

detriment of tHeUnited States? \

6. (C) The first’ two questions are largely factual and can
j be acquired throug! /a/combination of confession’, polygraph
* interviews, and/or’ assumptions based on access. Questions three a
| and four, however,/ are the most difficult and the most ‘important
j for both the ag¢quiring intelligence service and the tatgat
} intelligence Service.

va _

1 |. 7. )’ With further respect to question three, if a \ |
foreign Qvernment fully understands the substance (i.e., the \ i
import) / they will be able to exploit the information fully and\

the damage will be far beyond the ostensible value. A perfect \\ i
The information \ | ;
|

BLE of this is the Boyce/Lee espionage case.

exal
eis . * :
Gromi sed was a seemingly innocuous operational manual for a
...
SUBJECT: (S) Protection of [I[JDECANTER|\Cryptonym
...
scot bs eee <6 Stan sum, question. “4 -- bona Fides -- is the CI key.
The CIA to date has released all of the substantive information
jFelating to IJDECANTER in this particular document. But we must
...
[of course, nformation_on_the_public_record_via_the-media..... |
...
. First, is foreign relations. § In= Ou. judgment, the ~
rer-Aldrich Ames, the
...
tensions: Pere reese se erecreesveee-ereceereees ee)

e Second, is another potential intelligence benefit to
the Russian service. (This specific release could —.
[tessess y_provide_them-with insights into our capability

to assess the-hona_fides-of defectors. The Russian
| service knows |
...
But I would
j|-urge caution here since the information at issue is
| minimal, not critical to the public understanding, and |

[ seguably b harmful to living persons.
...
document _(Sx= 59777. of '15. December 1993), and juxtaposed

ith the Los Angeles T. Times article'of 29 December 1997,

{outas po id meeteresete Ofer sharin
...
e Mindful, however, of the Board’s statutory purpose and
objectives, we propose however:

e a-substitution of a fictitious cryptonym (e.9.,
...
(KGB) of the former USSR; ‘spe
‘Second -Chief Directorate. wi
...
bas bee by reporting from. another sourc

ieconelndes By atattna the -this—source—(IJDECANTER)—has
had. = ",.. bona fides ... fully established {by-CIAL.-

AND otherwise having
IJDECANTER R known-to t the public in ‘trae hamavand_ crypt,

THEN WE-MOST “PROTECT the cryptonym here so aS
...
e what information was compromised?
...
j what. understanding of the information did the receiving
; intelligence service(s) have?

what information did the receiving intelligence
service(s) believe and thus act on to its benefit and j
...
i Questions three and four, however, are the most difficult and
I the most important for both the acquiring intelligence service
...
\ detriment of the other service. fa
\ eats uetaee a seas!
...
[7 Aldrich Ames, the United States is considering avenues of
*
...
g:\irg_frontoffice\general\1ss\arrbijtp.doc
...
ory of Station activity for subsequent curiousity seekers, is to reverse the process, releasing the
...
information. The major relevant LI projects (LIENVOY, piu LICALLA, etc.) have had both the
full cryptonym and most of the details released.

[nsession jistories are @ among the n most sensitive documents
