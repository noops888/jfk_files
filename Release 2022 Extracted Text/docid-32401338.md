...
: JEK-M-02 : E2 1999.09.01.15:50:22: 873103
...
as of 1200 EST, 26 December 1963)
...
REGIME FACES NEW POLITICAL CHALLENGES
...
Appointment of Ney Galvao as finance

minister

reduces the

already slight prospect
...
JS, and he warned that any Afro-

sian country which became de-
...
I Fighter defense elements

* Combined command headquarters

• Radar station

À East coast filter center

Eat Early warning radar coverage
...
security bas been deteriorating.
...
an end to the US aid pro-

gram.

Messmer's high-level

entourage, which includes
...
, the EEC and the French in particular have

long insisted that a 50-percent cut in tariffs by both the US and the LEC would leave the US:

with substantial profection on certain items and deprive the EEC of bargaining power to effect

their future reduction.

The disparities issue was believed to have been settled at the GAT ministerial meeting

last May with a formula which provided that tariffs on industrial items would in general be:

reduced

mificant advele effection the oard, except that pecial rules would apply where sig

adverse effects.on trade.would result from disparities in tariff.levels."-In fact, how-
...
After lengthy negotiation, & GATT. subcommittee:reached.@ considerable measure. of

agreement last month on a formula which would identify a "significants tariff disparity in

the first instance as one in which the high rate is at least 30 percent of value and at least

I0 percent above the lower rate: Because this formula would identify some 850 US items as

eligible for "special trearment," the subcommittee proposed seven additional qualitative cri
...
gy of the government, this source re-

ports, is to hold on until the econ-
