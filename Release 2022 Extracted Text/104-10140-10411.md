...
Mr. Leader and I met with (Steve Hunt and Ray Reardon, OS, today

to discuss ur. Hunt'S experience on the Review Staff in preparation

for making recommendations concerning how Downing Committee requests

should be handled. Mr. Hunt made the following suggestions:

- Al? requests from the Downing Committee should be in writing.
...
Mr. Sprague/concerning security procedures.
...
Unrectorate forwarding such files should be required to send someone
...
taffers fan out to different offices.

leTicacy of this subject, it would be most helpful if staffers were
...
wise to establish a separate, more sophisticated indexing procedure in additi to

for the above described function.

All documents forwarded to the
...
unit neaded by Linda Young, Bob Young's wife.
...
--Mr. Hunt)asked that any system we devise should include forward-
