‘"404-10140-10441 {2022 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS ACT OF 1992 J
zl 7 7 WEAN TE ows

: ind Use Only - SD. B,
: : ho Wot Reproduce ie hos
Sy yy

9 November 1976

°o
INFORMAL MEMORANDUM FOR: S. D. Breckinridge 77- 0007
...
3 ne
Mr. Leader and I met with Gteve Hunt Jand Ray Reardon, OS, today
to discuss (Mr. Hunt's experience on the Review Staff in preparation
for making recommendations concerning how Downing Committee requests
should be handled. (Mr. Hunt nade the following suggestions:
...
_ number assigned to an incoming request is also used for each re-

sponse keyed to that request; i.e., as a reference number on each
response.

-- Sanitization guidelines should be consistent for alt Agency
components and should be developed as soon as possible.

ae Stembridge, OS, has had one discussion already vith ey
...
wise to establish a separate, more sophisticated indexing procedure «4 add hug fo
fer the above described function. A11 documents forwarded to the
...
--(Mr. HuntDasked that any system we devise should include forward-
...
Distribution:
Original ~ S.D. Breckinridge 27
1 - Mr. Leader

1 - IS Subject (SSC-Warren Commission/Schweiker File)
1 - A.E.Brody Chrono
