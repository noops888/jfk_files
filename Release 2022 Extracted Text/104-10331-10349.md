...
OOS. Routine Correspondence Prepared Without File
...
010. Employee Travel Vouchers and Individual Earing Records.
...
202 324 3409 P.B4/08

Mr. David G. Marwell

Ten of the above record systems do not concern the investigative ares. The five
...
or the related investigations. In addition, record systems 003 through OOS, 007, 008, and 010
...
retrieving documents at the FB.. The FBI's primary records repository is its CRy, which pras
...
The FBI's filing system follows a numbering method used to show (1) tho

classication or type of investigativo violation or administrative area involved, (2) the individual
...
Universal Case File (UCF) which was established in November 1991. However, the FEI's JEK

collection of ales aid documents known at this poiat do noi fall within the UCF system.
...
documented in this category, with tie information jeing placed in the 00 fis.
...
file on another main subject. The case agent of records specialist indexes the cross reference, so
...
electronic surveillance; Proprietary Interests; and Overhears. The FBI initiated the EL SUR index
...
Throughout the process of responding to the Board's specitic numbered requests
...
staff of is in the process of responding. The JFKTF prepared an inventory of the requests and
...
From the Desk of Michele I. Platte
...
become ill in 1951 and was put inot a sanitarium so I doubt he is alive but? If you find anything

pertinent you can send it to Eileen Wukitch and Lee Carle)if I'm not here tomorrow. Thanks.

CC:

Kenneth R. Johnson @ DO, Eileen M. Wukitch@ DO, Lee E. Carle-Y@DO
...
ASSASSINATTON, TO THE GREATEST EATEN POSSIBLE, SHOULD BE

MADE AVAILABLE TO THE AMERICAN PUBLIC.

-- WE SUPPORI THE BOARD AND ARE GIVING IT OUR FULL
...
not only on the experience of the FBI and law enforcement based
...
(in previous years as a PCI), he or she is made the

subject of an individual file.

This file contains information

CLA SPECIAL COLLECHUI
...
A defector source is an individual
...
individual becomes the subject of a file
...
of public testimony, the relationship with a W
...
the course of an investigation, they agree to

provide information only if they are assured that theis
...
fact, today, a subpoena would be
...
so on a confidential basis, even where that

inderstandino is not specifically articulated in FBI documents
...
due to the real danger of retaliation
...
380 F.2d 206, 213 (2d Cir. 1967); accord

In re United States,

565 F. 2d 19 (2d Cir. 1977).
...
sources but which, despite their considerable
...
ot relationships currently requiring protection when public
...
of satisfying the public interest when compared, again to the
...
It would not be possible to have effective law
...
doing so is consistent with the postponement provisions of the
...
crypts _unredacted make a copy for Barry to coordinate with

Some numbers in the FBI 100 series (100-#####)

are

classified.

If a FBI 100 number is referenced
...
her, is releasable but not her relationship with the Agency.
...
OFFICE OR TER LEGAL ATTACHE

ANKRICAN INBASSY

LONDON, ENGLAND

SECURR FAXS 171-629-8246

NON-SEOURB FAX:

171-499-7944

TRLEPHONS: 0171-408-8078
...
Number of paged Including thie page- 3
...
SUBJECT: JOHN DE KENNEDY ASSASSINATION RECORDS

COLLECTION ACT OF 1992

THE •ASSASSINATION RECORDS COLLECTION ACT OF 1992

(THE "ACT") WAS SIGNED INTO LAW ON OCTOBER: 2641992-
...
FOREIGN GOVERNMENT'S FOR ANY: RECORDS THEY: MIGHT

MAINTAIN: SPECTRICALLY, SECTION 10(6) (2) OF THE ACI
...
ORGANIZATION OF IPOTENTIALLY RELEVANT BRITISH FILES:

THE ARRB CANNOT PROVIDE SPECIETS/ GUIDANCE:ON: THE

APPROPRIATE, STRATEGY FOR ENSURING A COMPREHENSIVE

SEARCH.

THE ARRB TS WILLING TO PROVIDE ANY
...
(B) ANY AND ALL DOCUMENTS, STUDIES, INQUIRIES OR

INVESTIGATIONS BY GREAT BRITAIN (INCLUDING MI-5
...
entered the data into the mandated NARA "Identification Aids" program. To date, the JFKTE
...
to other employees within the FBI Please be assured that the employees of the JEKTF, with
...
mask their identities in FBI documents. The use of these
...
It should be pointed out here that, even within ithe
...
of seemingly innocuous positive information attributable

to the same symbol source can,

in the aggregate, lead to the
...
informants enable law enforcement to

detect and address activity of which it would otherwise be

unaware.

Informants are sometimes
...
those principally motivated by money
...
The process begins by targeting someone for development based
...
a person, a law enforcement officer might spend
...
nanagement is required to guard against disclosure of their role,
...
search warrants and other affidavits, and to share
...
single case, and operation ceases
...
the extent to which they are penetrated, to include

knowing

the breadth of law enforcement coverage and the length of
...
the IO, a fellow employee of

an IO, a social friend, or even
...
investigations, carefully developed and utilized
...
and the consequences of disclosure fatal.
...
These are difficult factors to overcome, as is the

natural reluctance of these persons to undertake the grave risks

disclosure would pose for them and their families, who often
...
For evidence of the results of disclosure of an
...
authorities after Ames disclosed their identities to the
...
for many years. Moreover,

the value of their information can

also extend for years when it serves

as the basis for, or is
...
which the source can provide no useful information to the FBI
...
the matter and the contacts were therefore reported
...
appear in these files were specifically targeted against

the subject and therefore furnished information that was nearly

always positive.

! In brief, the guidelines set out below were utilized by
...
such sources. Any information considered central
...
The information provided was only postponed
...
might have been available from a number of sources
...
persons giving information in the course of their jobs (j.e.
...
Referrals being made for the JFK Assassination Records
...
Assassination Records Review Boar
...
Committee on Govemmental Affairs, United States Senate, May 12, 1992, on the Assassination
