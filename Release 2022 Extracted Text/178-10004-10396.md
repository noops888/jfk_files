...
by the CI staff was the/Tofticase. (Tofti was a long term employee of
...
the second employee found that there were quite a number of
...
the Agency with which Tofti had been involved. Ultimately Tottf/explained
...
would simply advise the Bureau of other components of the Agency such
...
Embassy. I told him that we had already reviewed this
...
_This program involved: informa-

tion received by CI staff from Agency sources, from the State Department,

and from the Military. Information might also be received from the FBl.

The

was to collate all contacts between any American and any
...
program for filing was simply that when a name was reported

to CI staff, it was mechanically processed by personnel who exercised

no judgment in recording the name.

The names of both the Soviet and the

American people involved in the contact would be recorded. As a result of this

process, the

file index was able to develop a great deal of information
...
Stein explained that this program was conduc ted by CI staff instead of by
...
The information utilized by could have been derived,as noted, from

reports of other Governmental components or from info mation provided
...
NH 50955 DocId:32105622 Page 5
...
personality file). It the information on a particular person is requested
...
Other Cl files derived from on-going cases.
...
Other examples of going cases are:

who had private contact

with George Blake, a former KGB agent in England; an American who

the tire in the gue elite his instant, and a coion are taken CB,
...
that this is a State case which the Agency is running on

behalf of State.

There is also a file on

held by the CI Staff. The Agency became
...
Stein said that, at one point, l

lawyer called to say that he wanted

to have an account of everything which had been said about _
...
as a result. have special knowledge.

Another sort of defector is one from
...
persons involved may eventually

end up in the United States once again of in some country other than the
...
NH 50955 DocId:32105622 Page 7
...
This was an operation which the CLA did not particularly want to under-
...
suggested that they intended to defect to, for example, Russia. The CLA

attempted to turn the program over to the Secret Service for the Bureau, but th

would not take it.

The CIA ultimately stopped the project and cleared all the
...
is, the Immigration and Natufalization Bureau have a quota of persons
...
some iritial doubt, as to whether, in fact, Nosenko had been sent to the
...
and, therefore it was terminated by ClARiv
...
Before you make any statement to, or answer any questions fron,.
...
to make a statement and answer questions Eith 7

L without /

a lawyer at this time. No promises or threats have been made
