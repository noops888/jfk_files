...
a waren 54 nee
een Photographic: Branch - exe" |no mackine nequinto
ame » ‘ONLY QUALIFIED DESK
a on . ta nc NONE
Zjom Mexico City sncxon
goon a

«_ Jfonal Monthly Report == 1-31 December 1963 _|

Pion: None. For your information.
...
|| inetallation of the SEQUENCE camera at the LIERODE basehouse; Assistance
...
at an LP monitoring the LCHARVEST apartments Station production totaled
...
City to install a SEQUENCE camera at the LIERODE basehouse. See para 5.g- 1
of this report for details.

On 17 December 1963 an SWB representative arrived at Mexico City H

(continued)

}- Enk
1, Training Report (KASNICKA) nt
...
ee | = CLASSIFICATION oes Fue NUMBER
GD evtbg | SEGRET so-6-18 gt Pld >

e COS yesiacuces
(GRCHARITY bases
_ This extension was
jcials who insPe

G. On tHE NE

the COS to install an extension phone ae
ini i py RESCH al

wraining Pere the F Y est satisfactorily

ale to service this reque SuusoDA off
...
yx the Chief of Station.

63 PARMU TH photogr?

on 10 December 19 Requirement £0
...
the Recor
i SEHART
i On the morning of 17 December 1963, eae

SipH met at the LIBRODE basehous® to in

ARMUTH : INEWART ins
_ ger device ou na maintenance

a
thoroughly on the installation 4 a
...
{, On 10 December 1963 PARMUTH photographed 423 frames,

g. On the morning of 17 December 1963, S

DISPAICH MIMMAT Stee

iB PARMU‘TH in the use of SW system 99.
...
a. On the mor
in installing audio microphones under the
apartment. (See HMMA-22608, ll Dec 63

sudio installation to the LP were strung am
ample semi-crawling space between the target area and the LP apartment.

RESCIGNO and PARMUTH entered this crawling space by removing @ small
vcction of flooring located inside the LP apartment There is also a trap door
...
six to ten inches deep on the floors at all times, cob webs, bugs, etce, etcer+
‘Three audio microphones were installed on this operation.

ning of | December 1963, PARMUTH assisted RESCIGNO
flooring of an LCHARVEST occupied

, para 5.d.) Lines leading from the

.d secured below the flooring which had

b.. Daring the periéd 2-14 December 1963, PARMUTH again handled
LIFIRES 4/5 while Marvin A. CABOT was on annual leave.

RMUTH forwarded to KURIOT/WAVE.
...
requested to re-enter the

4. On 6 December 1963 PARMUTH was
a 5.a. of this report.

LP covering the LCHARVEST apartment aS reported in par:
The purpose of this visit was to “Anlock a closed door which stored the LP equip-
...
catered the apartment at 0130 hours on 7 December and un!ocked the door. It
sins found that the throw bolt located inside the lock was broken, For security
...
WINEHART, LIFEUD/2é
asehouse to install the 35mm SEQUENC

and PARMUTH met at the LIBRODE b
...
som — [USE PREVIOUS EDITION ~CSSHICATION =e rae ee
peeasees nay $82? SECRET Gece] convo 2.
Aeomaine
...
meres -The complete system was then dismantled by SWINEHART so that L-22
...
public for a period of six days for unknown reasons ag of the nig
...
the installation, sud statistical and training report concerning this operation,
...
3 is the SW report which is to be sent to SWB, . rl E
