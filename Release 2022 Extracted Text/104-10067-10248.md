...
The section titled Cuban-American presents
...
If FOIA materials released

by the Agency were read
...
be missed. Whatever was read, as

stated it is incorrect.
...
'the vast majority of CIA files made available...were reviewed
...
went to the Soviet Union in 1959, onty the years 1959-62
...
a CIA operation, in one instance than the other.

cited as the basis for the suspicion of HSCA investigators 1s citec
...
mind was not run the way that they depict it.
...
the USSR from the U.S.

In any event, it is incorrect; undergraduates
...
were made as illustrative rather than in the literal sense
...
his location in dapan.dreveals a post that has not been acknowledged by

the U.s. or the Japanese governments, and further publicity
...
protect urine after stand ella he is haves a the not pled in

the draft). But the allegation of other oparational disbursements there
...
at an unnamed foreign post.

This would, of course, necessitate other
...
" (ui' Consolidating certain CIA information pertaining to
...
Third line, second paragraph. The file was opened
...
In any event, the fact remains,

the thought was not implemented (1) because
...
Reiterating explanations given elsewhere, there

was no requirement

to open a file. The judgment of the officer in question controlled.
...
reguirement to do so, it was also quite proper to have decided against
...
Has the draft erred in using the name
...
(but not consolidated) general files, but

"duplicate files"

in the sense of

concealment is. an incorrect

characterization; such a

characterization would,

again, reflect basic misunderstandings.
...
employ it--demonstrates only that such a thing was considered
...
Why? Because he could not. A lot is draped
...
It is not at all clear why reference to Oswald

file would "raise a

sort of CI project „question of whether he was, in fact, involved in some
...
Page 42. Delete reference to retired employee as "under cover."
...
It is an intelligence method, and publicity

on the concept would jeopardize those who may particate in the future.

Page 48.

The reference to "the CIA's New York field office"
...
Request that second sentence, next paragraph, "is Solely
...
MacDonald" and the two places where

"Mr. Jameson" appear elsewhere in
...
with the Department of Stater The following language is suggested: (C)
...
"Moreover, he added that Snyder went to
...
Request deletion of all paragraph starting or
...
Page 81.24 swald in Helsinki en route to USSR. At page 85 reference

o the clA the en soviet consul should ge

deleted, as should the

eference toliCIA Dispatches from Helsink showing the existence of cl

operations in a sensitive location).

On page 86 reference toda CIA <4

dispatch should be deleted; it should suffice if it was simply stated

to a TA dispath from page El should be deleted (c)

dated 9 October 1959....

The reference

to (@ CIA dispatch on page 87.

Page 89.

The absence of a reference to the origin of the communication

conceals the location, and there is no objection to this form.
