...
At the Agency Recorde Center, we have approximately

1,407 folders that we can identify as having the terin U-?.
...
at the direction of Richard Bissell of the CIA. Is there
...
is no record that I am aware of that would tell
...
all those records are under my purview and
...
practices in the DS&T.

When records serve their useful
...
DS&T Records Control Schedule.

This control schedule, which
...
Component records custodians with the
...
those records under the appropriate schedule item.
...
We have been working to identify all technical and
...
that, ISG keeps a hardcopy file records of operations that

are either still active, or that are no longer active but

still have technical equipment in place. For example, if

T'SG concealed a device in a wall but was unable to retrieve

it when the operation was over, they would retain a record
...
What searches could be conducted to

retrieve any additional records?

If such electronic take
...
that TSG does not get involved in.

TSG's function is to

assist the station with the mounting of a technical

operation, maintain the equipnent, train station

personnel on the use of the equipment, and remove the

equipment when the operation is terminated. Once an

operation is in-place, up and running, the stationis
...
How can be verify that what exists in the Sequestered

Collection represents all records of the technical

production of the Mexico City Station during the period óf

Oswald's visit that was available at the time of the

assassination?

Again, ISG would have no idea as to the amount of

production from an operation. Due to compartmentation

reasons, TSG officers
...
Are all technical and surveillance activity logs.

referred to TSG?

If not, then what organization element

would be responsible for storing these logs?

ISG maintains its own record of operational activity,

as monitored by cable traffic originated by TSG officers in

the field.

This cable traffic only covers the big picture

though: who, what, when, where, how as related to the

overall operation.

They day-to-day specifics of operational

activity is not something that the ISG officer becomes

involved in.

Those day-to-day records are kept for the
...
Who other than TSD would have had access to the raw

trattic collected from the surveillance targeting the Cuban

and Soviet

installations in Mexico City in the 1963-1964
...
the station immediately takes possession of the raw

traffic and processes it for intelligence.
...
How could those records be queried?
...
How might a search query be framed to isolate these records?
...
The existence of records, as stated in the

answer to question 1 under Surveillance

Records, would be

the same for this response.

If the records of this nature

exist, according to the previous criteria, then they would

also be retired to the Records Center. A

he created using terms, such as, "Castro," search query would

"assassination,'

or any other related operational term.

This

same search criteria would more than likely be used to
