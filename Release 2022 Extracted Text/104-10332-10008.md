...
aceleaee Copy Jace v rdead to

John A. Hartingh B
Inspector-in-Charge CP by F L
JFK Task Force
...
opportunity irfthe near future to work with the State Department and the FBI to.
...
Boaro Memecns: John R. Tunheim, Chair + Henry F. Graff - Kermit L. Hall + William L. Joyce Anna K. Nelson
a Executive Dinector: David G. Marwell
...
Board at the January 5 meeting. fined lee
...
04-10017-10040: Although the Board continues to protect the

liaison cryptonym in both ragraphs, the text shows Station
cooperation with the service.

104-10017-10058: Although the liaison cryptonym remains r
...
text reveals liaison with |
the respective local services. i ae ae

104-10017-1ho36: Although the liaison cryptonym is
...
104-10015-10420: Cable from in clear text indicates “no
liaison” traces; therefore, if the identification of the
Station is released, it will acknowledge the liaison
relationship between the Station and the service.

104-10015-10159: Paragraph 4 contains information that will

show that Station had a technical operation directed
against the Cuban target i in November 1963. Also
context of the cable reflec at the following Stations

have a relationship with their local liaisons: Paris, Rome,

Madrid, Se Helsinki, Brussels,
London, and Ottawa.
...
to photograph US passports at the 1
...
the operation.
104-10018-10088: Cable clearly shows that both | | aad

SS have a liaison relationship. in their 3
respective countries if the Stations are released.

shrase “assume \ At the bottom of Page 2 of the cable is the
...
The following is a draft memo for Jeff. (Bob Caudleis looking at it now so there may be more changes. Please let me know if there is
...
Chairman Tunheim of the JFK Board about 2 attached cable and
the importance of otecting the phrase h Mexicans") because
it gives away (iaison involvement in a(tél-tap) operation. At
...
cable was released in full by the Board, with no objectién by
CIA, in September 1995. CIA probably did not contest this
release bécduse an excerpt from this cable, containing the phrase
at issue, had been inadvertently released en-prierte—that. It
...
to appeal this release to the White House. oo The Nehonal Archives in ug 3
...
issue of protecting ™ son} has become increasingly
...
this tel. -tap! operatio: Although we ed to the Board/ eleneg
thet. 4s phrase Gwi

ives that relationship away,
iS | @ does not imate = directly do so. In fact, the reason ‘Stl
for the Board's insistence that this phrase should be released
e did NOT directly state that the

we ip.) We_should be able to use
their arguments to continue to protect “the (1 on_relationship.

ais Our only recourse is to acknowledge to the Board that
...
have been~ on?! yjectS. HRG will also be doub
documents going to the Board to mekemsure—phet—e cates of
prior releases axre—beimg—sent. You should be aware, however,
that. there is only a rudimentary CIA computer index. isting Saxo pro)
releases and that it is impossible to d computer eI
...
often, Gwino ebsolule assurances ch com’ We peer ies heed
...
and declassification of foreign government but will
also address the specific issue of the ‘six documents"
...
that would give it. Rather than going to the
...
SUBJECT eae Information

resident to agree to the unilateral_declassification of foreign
nformation, CIA proposés that. the release of the
documents be either postponed le or that 3
...
SUBJECT: Foreian eee Information

the U.S. and the foreign government whose interests are involved.
DCID 1/10-1.

7. (U) National i i tions: The importance of
...
_+—__—9—(§) Coordination: _As-two ofthe documents
at issue here are letters from inet
| CIA is legally obligated by E.O. and |

th to seek the consent of the
prior to eir release. even in redacted form. The
issue of coordinating with the is a timely

jone. In most cases, CIA would not have an objection to going to
[the foreign government and seeking their consent for declas- |
lsification. However, several events that have occurred in the
...
below, it is CIA's position that even asking the 7
...
\ that this demarche’ is not between—intelligence-services—but————! zi

( gueaserstuuinarenietearane - — " - Sereeeaaeete
...
ional Security Council and
_to the U.S. Ambassador The manner in which the
treated the demarche demonstrates that the it
...
e On two recent but separate occasions
passed to CIA information indicating that there would be
assassination attempts on two non-U.S. citizens. CIA

ij requested that it pass this information on to the targets, but

j refused. They argued that the information was

i not specific enough and would endanger a source. The

stated that if they believed the information was

“useluL, tney would pass it themselves. were

concerned that CIA had even asked to pass on is intormation,
...
| |
| e Just this month, a senior official of |
i approached the CIA with accusations that a former Agency
\4 employee allegedly may have disclosed their classified |
| | information. believe that this disclosure |
| i may be related to the loss of all agent reporting sources
| H in a country of particular interest to them. The DDCI

promised to launch an
...
\1 alludes to a relationship between the CIA and

1 | Even though this book ici i
| fe) is ok was not an official CIA i
...
ove events which have all occurred in the last year. The

|
would not only be extremely upset with CIA, but would |
certainly deny their consent. Should deny their |

| consent, CIA would have no authority to agree to @ release of
|| the information and would be obligated to-do all it could to
\ | t disclosure. It_is_crucial_not—only—to_CIA‘'s-_mission_but_i |_
...
[ -aiso-to-the-conductof-US~foreign relations that the usc is séen
as abiding by its agreements with foreign services as. well as its
own laws on the release of information.

j 11. (S) Finall the importance of maintaining good

| relations with leeureoresers cannot be overemphasized. As a

i; vesult of our valu @ relationship with our

ij counterparts, the USG receives a large volume of finished

intelligence. Due to our shrinking resources, much of this

information would not be available to U.S. policy makers were it

| not provided Additionally, we work togéther
j around the world on joint collection
...
i collect intelligence independently. In_these cases, we rely _ !

entirely on the continued good will of to) |

i | provide us with the assistance necessary to meet U.S.

[ policymakers' needs.

{ 12. (S) In light of all the above, CIA submits the

Hl following two proposals for the Board's consideration. First, :
the Board could postpone these two documents from release for a ha
short period (we propose 10 months) at which time CIA can

4 reassess its relationship with It is possible ! i
i that the relationship with CIA and could change so that:
! it would be possible to seek their consent for release in full. ty
is However, should ent of ata }

| future date and object to the release of the
...
i coordinate with the JFK Staff a substitution or some sort of H |
} summary of documents for immediate release. This | |
summary would hide the fact that the letter came from the t i
but would reveal what the subject of the \
This would avoid the problem of having to go the id
\
\

to seek their consent, which we would have to do even, |
in the case of redactions. i]

by 13. (U) Should the Board reject these proposals, CIA is Vy
\ willing to work with the Board to reach another mutually 1 \
| agreeable solution. We strongly believe, however, that any y |
approach which suggests that the U.S. Government may ignore its \ |
obligations and commitments to foreign governments would i \
...
14. (S) With regard to the remaining four documents | \
\
e-redactions-proposed-by-the-—! 3

4 \“these-are“CTA-documents-and-w
...
(S) Regarding the release of the reference to the
...
would establish a stronq inference that the two Agency officers
...
named LIENVOY fonducted jointly with components.of the Mexican government.) We
...
-{elephonic tk, specially Te actual recordings of Oswald's telephone cals
...
e Executive Director: David G. Marwell
...
1995. On page 5 of this document (not including the cover

sheet) information that the

Board agreed to protect, due to the sensitivity of sources and methods involved,

{suggests that the Mexican security forces may have had their own copy of the October 1 7}
...
We would appreciate your contacting appropriate officials to determine wh.
Teasonably can be known about this and related matters, and ask that you provide a

to this request by November 14, 1997. We are fully aware of the sensitivity of

fésponse to this
this ieee OF ea juest and do not wish to take any action that would compromiselexisting:}

If necessary, we would be pleased to discuss with you ways in
which we might further elaborate on this request, aoe B erson-to-person

discussions with appropriate officials either herelo
...
(s) A. Reconsideration of the}
not required. However, the Agent

“evidence memorandum”. The evidence memorandum must be at. ARRB no later than Tuesday
we may want to have individuals standing by for questions. The current plan is for Lee StritkTai

NW. to answer any questions.

{AlUO): B. Office of Personnel Files in the Sequestered Collection (Microfilm). The ARRB staff will recomipend to the Board that
...
{AIQU)  C. Non-related filesjdocuments in the Sequestered Collection (Microfilm). The ARRB staff will recommend that the files ve
...
The ARRB staff has advised that briefings by senior CIA andi
‘ion if it will add to the information being presented in the
Mr. Gunn has suggested
id me to be available at 600 E. St.

re welcome to make a presentati

aT and et

records for public release. This too will be coordinated with the Agency prior to release.

B. Other possible items:
...
(8) ii. Cryp(UINCUCK)- ARRB staff did not find our evidence memo on this crypt persuasive. They are expected to
recommend that the Board reaffirm its decision to release.

{AIUO) iii. 1967 1G report on "Castro Assassination Plots” -- ARRB has requested that an updated version be released to NARA by
thie end of January. Any disagreements between the Agency and ARRB staff may be added to the agenda. HRP and
