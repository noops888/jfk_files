104-10149-10051) [ 2022 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS ACT OF 1992
...
SUBJECT + Comments of HSCA Drafts

Forwarded herewith are preliminary comments on
drafts received recently from HSCA. I hope they identify the
drafts sufficiently. Please be ready to discuss these next

week; as we understand, this is the only review prior to the

"Five-day" review procedure. (U)

Chet ahi Gt)
ih ee en
DO: NOE REPRODUCE
UNCLASSIFIED WHEN SEPARATED RETURN TO GLA

FROM ATTACHMENTS

Attachments

RETURNTO CIA APPROVED FOR RELEASE 1993
| SORT ass Cnty GIA HISTARSGAL REVIEW FROGRAM-

Distribution: 7
Orig - Adse :
1 - OLC/Subj 21167
= 1 = OLC/Chrono
1 - RSG penivativectay Aai2 2 ——_.
1 - SDB

necwrecnoren ee LEKevw on <7bn 12>
OLC/SDB/ksn (25 Jan 79) fy
...
question ina furtive and groping fashion, they now feel it necessary
...
point or departure serves more to distort the record than to illuminate
it. (U
...
lelsinki raises a sources-and-methods question. References to
"two CIA dispatches from Helsinki" highlights the existence of the Met
Station there,J General references to the name of the Soviet Consul
should be conSidered to determine if the story can be told without
using that name. (C)

V. Untitled, Hand-Written Draft_on Non-Interviewing of Oswald
...
The name of Birch O'Neal appears at pages 9 and 16. Win
Scott appears at page 18. Alvarado's Nicaraguan case officer, Jerez,
...
a with Alvarado in the Warren Commission report. It is mentioned here
RRR at pages 17, 22, and 23. Does it raise a methods question? (Cc)

e At about line 20, page 3, Alvarado's name is used where
