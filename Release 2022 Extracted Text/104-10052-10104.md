...
l. It is requested that the LIEMPTY Project be renewed for the
...
The LIEMPTY Project was programned for
...
the other LIEMPTY agents is being contemplated for the
...
IELD CASE OFFICER QuInton rele
...
that the LllErick target was having con-
...
investigative asset for keeping track
...
efforts in this correction would be the spot
...
collecting information on targets

other than LIMERICK:

sio

In March 1960 SCANTLING was instrunental
...
Do SCANTLING is also used to follow up
...
SCANILING's contribution to this objective, the
...
See the attachments to HMMT-1416,
...
SCANTLING can be relieved of this assignnent as soon
...
measured against monetary exyenditures,
...
Ba Raymond H. GERENDE Segment (discussed in relation to project

objectives):

"To collect operational information pertaining to

LIVERICK personnel and physical facilities through
...
visiting or working at the LIVeRICk target.
...
information through photographic coverage of LIVERICK
...
area knowledge and personal operational capabilities combine to make 1:
...
• Pericles FRANCO Ornes (201-64546) - FRANCO is a
...
knows, only one of the team members, LIEMPTY-20. SCANTLING is 313
...
espionage activities directed against the LIMERICK target require detalled
...
upon requirements from other Station operations,
...
responsibility for the LIfERSEY team and can concentrate more on his

investigative and casing activities.

The transfer of the LIJERSEY team

to Project LITEMPO reduced Project LIEMITY activities by an
...
conditions Both of these agents identify themselfs,
