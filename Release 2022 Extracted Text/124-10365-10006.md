...
the SAMMY case prepared bp the Chief, Soviet Russia

Division for the information of the Deputy Director for

It is an

"in house" document containing an in- 2
...
appear to relate in some way to the SAMMY case. The ses

port concuudes

sIble KGB aims

to resolve the case 01

in such an operation,

th such an operateD plant, discussas post.
...
/ SAMMYon American Citie

evaluation not only will affect the manner

will for an important part of the finalsdeterination
...
sogn as possible your

views on other aspects of the case
...
a travel order for his use in the "search" for CHEREPANOV)
...
NH 50953 DocId: 32318811 Page 4
...
the OSWALD case, the KoTEN case, thes
...
MARCH a KOT however, practically every one of these was
