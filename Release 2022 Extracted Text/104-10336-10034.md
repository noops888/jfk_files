...
assassination records were designated from this 201 file. CLA also provided sections of
...
specifically, the actual cryptonym of a CIA source (TIDECANTER) .
...
2is (S) Mindful, however, of the Board’s statutory purpose
and objectives, this memorandum also proposes a substitution of a
fictitious _eryptonym (e.g., “TRUSTED”) for the actual cryptonym
IJDECANTER in this or any ther document where it appears and
...
SUBJECT: (S) Protection of TUDECANTER \Cryptonym
...
{Gdentity redacted but, in fact, IJDECANTER)} It concludes by
‘Stating that this source (LJDECANTERY has had his "... bona fides
...
must protect the eryptonym here so that the key intelligence

judgment of CIA is not _compromised. eee rasan i ess CnsSePmnaunp oes teos cut oeateonaste

~~" "5, (C) The practice of counterintélligencée (CT) -
...
e what understanding of the information did the
service(s) have?

e what information did the intelligence service(s) 7
...
interviews, and/or assumptions based on access. Questions three j|
and four, however, are the most difficult and the most important in
for both the acquiring intelligence service and the target //
intelligence service. i

|

rin (S) With further respect to question three, if a
foreign government fully understands the substance (i.e., the |
import), they will be able to exploit the information fully and i}
the damage will be far beyond the ostensible value. A perfect HI
...
critical information that we must protect vis-a-vis defectors in i
our fold. }
...
of time. ae eee ieseatasitedsessnedientasdtcatiedl Hf
...
ll. (S) In sum, question 4 ~- bona fides -- is the CI key.
...
e First, is foreign relations. , in our judgment, the
...
_arguably provide them with insights into our capability
...
eaBU te woulliciaee ace


13-00000

SECRET
SUBJECT: (S) Protection of {fJDECANTER /Cryptonym
13. (U) “ T would be pleased to appear before the Board in
...
e It is our considered judgment that the release of this
...
“TRUSTED”) for the actual cryptonym | IJDECANTER / fin this or
any other document where it appears and would otherwise
be releasable, and/or,

cL By: 0619849 ciinciom_}
~ CL Reason: 1.5(c)
Decl On: X1
Drv From: HUM 4-82
...
It continues by stating that this CIA assessment-is—__

supported by reporting from another source (G@dentity i

(redacted but,” in fact, TIDECANTER) .

It concludes by stating that this source (EIDECANTER} has
...
“THEN WE MUST PROTECT the cxyptonym here so that the key
...
e Questions three and four, however, are the most difficult and
...
e what understanding of the information did the receiving
intelligence service(s) have?

e what information did the receiving intelligence
...
e If they do not, the other service may escape damage fully
or to some degree.
...
e In the matter at hand, we are very constrained by what the
...
Lt e they do not know, however, whether we believed him and
ti thus incorporated his information into our operational ¥
tl practices and activities. is

: * In sum, question 4 -- bona fides -- is the CI key.

t e The CIA to date has released all of the substantive o

F information relating to IJDECANTER in this particular *
document.

e But we must protect his cryptonym here, in this B
particular document, if we are to preclude a substantial a
? CI benefit to the Russian Federal Security Service when ‘
; they assess this new information in light of their i
...
of course, information on the public record via the wy
media. 7

* There is additional damage that will accrue from not
officially protecting the identity of | LJDECANTER;
...
against the harder targets (e.g., terrorism). ius

e There are other damages that I will touch only briefly upon in
the interests of the Board’s time. They are not
insignificant, however.

¢ ONE, is_foreign relations. _ z

“e In our judgment, the Russians are fully expect that, after
