‘04-10307-10024) [2022 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS ACT OF 1992
...
fe Military commitment. In addition, the non~invasion assurances
...
PE Cc. CIA operations involving a high noise level and a
...
K. Adequate aerial W Uhcd Ot pups of Cuba on continue.
...
Cc. Maintain through clandestine means, short of commando
...
D. Maintain maximum possible intelligence and counter- fase
...
tions with tne(131)recruited agents now resident in Cuba.
...
now running as controlled agents. stat

6. Penetration of Cuban Installations Abroad: At
the present time we are running G2)etban diplomats
stationed outside Cuba as controlled agents and have viable
operations aimed at an addi tiona1 (26) tdban diplomats.
...
increase their Geaborne) intercept coverage of Cuban
communications, 24
...
can be directed against Cuba either by dispatching the ee
agent to Cuba or by pointing the agent against Cuban

targets, this will be done, except in those cases where

such action would result in unacceptabl prejudice to

the operations in the area where the agent is now based.

It is believed that the most lucrative field for the Seas
redirection of such operations to the Cuban target will

be Latin America where there are 68) penetrations of

various communist parties. Of this (63) the survey

we have conducted indicates tnat {23) have some direct

2
pertinent access to Cuban targets. All of these(23, ae BT

be directed against these targets unless in any case
there are overriding reasons to the contrary. The

2
remaining cases in the total ot Gayath bein individually
...
successful black infiltrated teams (COBRA a:td AMTORRID)
...
some preclusive buying and inducing frieadly U.S. and allied
...
action operatianus of Cuban groups against Cuba, it is believed
...
Maximum &mplementation of the above plan which provides
...
Cc, It is recommended that you secure from the Special
