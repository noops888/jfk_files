...
The reference to LAM/FI should be changed to "responsible."(e)
...
the reporting basis far an investigation was dubious. (u)
...
Reference to a Mexican police source should be deleted. (c)
...
They did not.. The amount of unread material is estimated
...
administrative, financial and operational, work against such a development. (v)
...
did meet the criteria for constituting a possible Cl threat, so it was
...
Oswaldin Helsinki en route to USSR. At page 86
