...
the Review Board has completed its deliberations on the
...
approximately 50-60 true names of human sources
...
sources, there is an important difference that
...
7. (U) BY Executive Order (E.O.)änd statute, the
...
103(a) (3), codified at 50 U.S.C. 5403(3) (C) (5), requires the
...
or potentially involving classified intormation. Working
...
carrying out its statutory obligations; the
...
example of a federal statute that allows for the protection of humar
...
affiliation with CIA could and, in tact, has threatened the
...
CIA is even more real.

These individuals live and work in
...
(U) In light of the foregoing, CIA believes it is
...
substitution can be used for an

individual source throughout

(for example, "Mexican source 1").

are tone a e cho can propose be Eated in the hanen

True name of LIRING/3.

an encrypted asset of the

CIA and unilateral penetration of the Cuban :

Embassy:

His wife also worked_at_the Embassy and
...
• True name of ERTHYROID/3,I the unilateral
...
person 1s deceased and has no

living family, that

the Review Board and the ClA can agree
