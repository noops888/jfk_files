...
in Minsk Who Are Engaged in

Survel lance of Foreigners
...
also believes that KOVALEy, while he is an MuD officer, has close:

attes with

the kGB and may have been co-opted by ft.
...
short blondhairo gray eyes and dresses simply lan apparent

effort to bewinconspicuoush

During a drinking sessIon, PINYAZ"

admitted to Source that he "Cooperates closely" with the k68.

PINYAZIs frequently seen at the Hotel Turists:
...
A. There are no Headquarters traces on
...
IP/ONSE (please classify Into 207-09483826
...
MVD headquarters buriding on prospekt Lentna.
...
with black marketeers (fartsovshchikl). Although Source previous-
...
IP/DMSE (please classify into 201-0948382)
...
Druzntaniket and Operativatei, Voluntary Civilian
...
Since become official appendages of the
...
äll the students of a particular department have
...
cer of tue militia tiere, witi several miliciamen of
...
(st/SAG/OP routinely uses the following
...
tne suujects snould run full traces of their

A. Tere are no Headquarters traces on

(para 7).

(para 9r.

There are no Headjuarters traces on
...
classify into 201-0948382 and

Index Indicated names to para 8)
...
Selection and Recruitment of KGB Officers, Agents änd:
...
AKSENOV replied that the discovery.ora
...
important. Party or governmert dignitary.: Thus, in the eyes of his
...
recipients of this report with an active interest
...
REF SX-31465, 12 May 71: 201-0948982
...
LOC USSR, Belorussian SSR. Minsk. PEF SX-31466,
...
IP/AN (pIs classify into 201-09483829 25 PRy1977
...
not be construed as being extensive or complete and any reciplents

Of this report, with

an active interest in any of the subjects;
...
KGB presence in a tourtst hotel in MinskBasicol
...
the KGB unit in the Yubileynaya Hotel, M105k•
...
Later source learned the does

not remember from whom)
...
Traces: (SE/SAG/Of routinely uses the following

These traces should not de
...
Are are no Headquarters traces on
...
conversing, he has the hault of looking downward
...
son of Aleksandr Niki forovich
...
favor vito her father-in-law, AKSENOVs wife reports lepta
...
SECHLYkon Miadinaduated frowaGe school (apparently
...
not be construed as being extensive or complete
...
Tnerg are no Headquarters traces on
...
there are no teadquarters traces on
...
(Barre Are no identifiable Headquarters traces
...
let's are no teadquarters traces on
...
Graduates of the Minsk State Pedagogical Wastrele

of Foreign

Languages who travel abroad
...
17 April 1977 and SE/CI/X on 12 April
...
in Burma and since 1975 has been in Guinea
...
(sE/SAG/OP routinelyuses-the-followino
...
here are no Headquarters traces on
...
2. FBI HOS COORDINATION EFFECTED. NO BASE CONTACT OR SUPPORT
...
Requirements for me gA vzL9 and Bors

PALANT

- Your memo 8 Apr

S1 don't have Aleksandr DAVIDOVICH (para 1=A-1) on
...
what didsthese persons have to say about the
...
them? African assignments are parcicularly
...
exploitables we would like to learn as much,

as possible. We would also be inter-
...
at Oxford or Cambridge: now teäches English in
...
ORIG: SE/SAG/OP CM. HOOKSZ: COORD: SEIXIFR & PHIPPSZÄ FRIS
...
rather's full name. is, or of the patronymic of the son whor

Subject describedas his friend in both grade school and college?
...
SEGRET 2517202 MAR 77 DEFERRED TELEPOUCH
...
1 292655E MAR 27 DEFERRED TELE POUCH
...
OF GELORUSSEAN FATHER AND JEWISH MOTHERO MARRIED. VERY CLOSE
...
APPACACHED BY REUNIO GLENTA? AGRANOICHT SIRLENWHO

ASKED HIM TO SEESE TU ISRAELI OFFICIALS IN THE NEST OR TO

INUS SHOST A RO REP OF JERISE COMMUNITY:
...
ULITSA MOMMUNIS: ICHESKAYA 6, ME RESIDES AT ULITSA

VOLGOGRADSKAYA ST. API 2. MINSK. SUES HAS KNOWN HIM SINCE
