Tod“10088-10072, [2022 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS ACT OF 1992 | _

Chief, KURIOT Atm: Photographic Branch
...
1. ° resented below is a reporting of the operational and support activities
...
- WH, w/o encls |
‘ 1
| [renossnerenence ro ; one
oe HMMs be filte ' ES
§ — HMMA-22726 16 January 1964
t 7 SuASSEATON.. WQS FUE RUMBER |
SECRET 50-6-18 i
ie !
...
ox the purpose of training PARMUTH in the use of SW system 99.
...
apartment, (See HMMA-~22608, ll Dec 63, para 5.d,) Lines leadizig from the
...
The purpose of this visit was to ullock a closed door which stored the LP equip-
...
room to check if these locks were'in the sarne bad condition. In each case,
...
vand:PARMUTH met at the LISRODE basehouse to install the 35mm SEQUENCE
camera and the VLS-Z trigger device, SWINEHART instructed both L-22 and

I a,
PARMUTH very thoroughly on the installation and maintenance of the SEQUENCE
rou

‘USE PREVIOUS EDITION. CASSFCATION | —

Siam ane ano 27 ‘SECRET
ncn ate OWSOAEE.
...
The complete system was then dismantled by SWINEHART s0 that L-22

Ssystem trom the beginning. This wae done by L=22 and met

fs satisfaction, ugh the Consulate door was closed to the
...
later‘at the LIERODE basehouse and found that the camera system waa working
...
fzom both of these cameras and make printa daily, it will be necessary to install
...
Cea oy h. On the night of 17 December 1963, PARMUTH and SWINEHART
...
the opportunity to inspect the passport camers located in the Immigration Sactio#
of the Airport.
4. On the evening of 31 December 1963, PARMUTH was requested by
...
3.is the SW report which is to be sent to SWB, Cine. 43 46 an S-2 Pod

b. On 20 December 1963, PARMUTH was trained in the use of SW
~systern 99 by a visiting KURIOT technician,
...
ORM: USE rea DITION. ‘CUSSRICATION' [PAGE NO.
heals wees
ea"58a Bains tn size SECRET Laddeonmuso 35
od WHICH ARE OBSOLETE.
...
(6): Sheet film (all types

(7) Miscellaneous: -0,
b. Color: 0 jobs.
., & KURIOT Station Support:
; () Secret writing: issued 1 - 37 carbon to SWLUCK/l1.
(2) Flaps and seals: 0,
