...
BOARO MEMBERS: John R. Tunheim, Chair • Henry F. Graff • Kermir 1. Hall • William L. Joyce • Anna K. Nelson
...
*ECIA-IR-04 Disposition of Angleton's Files.
...
During the course of this review, additona muestions were raised thät CIA.!

agreed to pursue, CIA also agrec at condirt aaltional searches to determine

whether there may be additiong/eteyable.cord. oHMr. Capehart, The

Review Board seeks a full and accurate formal response to this request. Once the

formal statement is provided, this request wilbe complete.
...
BACKWARUS IN THE MIRKOK | 127

Angleton bluntly. "Well, I guess I better start reading them," said

Kalaris heavily. He turned to Angieton's (now his) secretary (the loyal
...
it, they found it crammed with Angleron's own most super-sensitive
...
1918C A NO 18 M000 A18 A 8000 1000000000001 d000
...
solitsyn, and the Fundamentalists, a perpetual generator grinding out
...
respectful way, he tried to explain this to Angieton, but he sensed i
...
talked, and Kalaris again found it quite impossible to comprehend 1
...
I don't understand him or anything about him. I cannot and will i

waste my time like this. In the future, if Golitsyn has something for l

staff, I will send someone else to deal with him."ll
...
scott documents and manuscript at oge.
...
record that seems to refer to these personal
...
but the FBl in New York kept in contact with him. Months later the
...
at the ClA thought the defector was mentally unstable, and that his
...
01/08/97 MEU LY: VO FAA ZUZ 124
...
Subject me Requests to CIA. for Records- Related Information- UPDATE
...
The followingis alist of our current requests for information. These should be
...
identified below. Weare Wiling to formalize any of the requests into our numbered

• serdes yout yould so prefer
...
pu Faldniles. Are all files In collection? It CIA has any

additionalties (eg. personnel, 201, eic.), we would like to

request them.

pas raidin file in Box 15 tolder 34. Who is the person

signing the DCD messages? Did Raikin work for CIA? Did

he work for DGD/00? What is relationship between

documents in fie and Raikin?

Location of cable Identried in JFK

1993.07.20.10.18:29.650630 (Box 34, F 22) p. 2 Cable

number (IN 24708) 7 July 82. We can send fax if helpful.

ManynD Murettles. Are all files in collection!: If ClA

has any additional files (e.g., personnel, 201, etc;), we

would like to request them.

Information on HITLINGUAL

Information on Arigleton's filing system at Cl

Location of DRE, CRC, MRF(?) monthly operational
...
see no need for any further information to be released from the histories. IIt is my
...
o two additional documents that should be requested: The Bronson I weedy

(w/Goleniewski?] study on Golitsyn (1975) and the John Hart study on Nosenk
...
departure from the Agency. It may be appropriate to make copies of pp.I:8 (ast
...
From "Post-Angleton": (1 and Il are Roman numerals, apparently volumes)
...
Page I:11 (Kennedy files)

Page 1:22 (Cl abroad)

Page I:67 (FOIA)

Page I:71 (Double agents)
...
DRAT NOTES BY TIG FOR ASSASSINATION RECORDS REVIEW BOARD

UNCAR TA137

On January 13, 1997, Michelle Combs and Jeremy Gunn from the ARRE Staff reviewod the files
...
(1) A manuscript entitled "I! Cime to Litt," by Ian Maxwell (preud.), which contalns 221

enumerated pages. The foreword to the manuscript stater that the events rocounted therein contain "no

aggorations and no deviations from bac truth." (unpaginated forwand). It reveila that some true

names have been need, and that this hat been done without the consent of the persons named. The author

axpresses hia "most sincero admiration and utmost respect for: Mr. John Edgar Hoover, Director, Federal

Bureau of Investegation (sic); Mr. James R Murphy, wartime director of OSS/X-2; and particularly, the

late Allen, Welch Dillas, OSS Cilet In Spitzerland during World War II, a principal architoct in the

croation of CIA for President Farty Truman and the Greatest Directo" CIA has had." The author refers to

the blight of communtam, and the courageous people who havo worked to fight it, but nevertheless

concluden that "all the effort (to thwart Communism) has come to littic." (unpaginated forward)

There is only one chapter that makes any identifiable reference to the assassination, of President

Kennedy and to the eventa related to Máxico City at the time Lee Harvey Oswald was alleged, to have

vaicod. Thât chapter has been roleased in till to thè public.

(2) A Supplemental Declaration of J. Barry Harrelson from the case Michael Scotty, CIA, CA

No, 1:9SCV00686 with attached documents. The attached documents contain documents relcased in full

and some thät are redacted Accordins tO CIA, all redacted documents are a part of the JFK collection,

This should be confirmed. If thcy aro part of tho collection, no further stops need be taken. Ifmot, they

must be thily reviewed to determine whether they are assassination recorde.
...
disclosed no "and nation records." Althoughinot asassination records, the following information was

located in the personnel file:

- The records disclose that during World War Il, while in the employ of the FBI, Scott worked in

"connection with esplonage and subverstve activities" and in "countoresplonage" while based, in Flavana.

- Document, dated 7/23/69, refers to the possibility that CLA might attempt to recruit Scott for

the "Civillan Reserve Program (FR 20-15) following his retiroment from the agency.
...
bocomo a highly éffectivo counterintelligence mechanism capable of covering Sovlet Bloc and

Cuban [activitics]."

His Citation for the Distinguished Intalligence Medal includes the following statement:
...
JAIN 27: 9? 10:23AM USGOVERNMENT

P. 3/8

CEAFT

"TEle has served brilliantly in Mexco for over twalve years where among other things he has

built a remarkable counterintelligence machine-a true bulwark helping to guard our southem

border. His station has long been a showcase of technical Intelligence methods as well as

classical operations."

-There is no record in the file that suggasts, one way or the other, that Mr. Scott was ever

treated for or sui ered from any mental or emotional issue.

Unless the following are already part of the JFK collection, they should be designated "assassination

record?" and processed under the JFK Act.

AR: Doc. 93: 8 Oct 1976 for Chief, Security Analysis Group from (105x) in Security Analysis

Group, subject: Philip B. F. AGÉE Exposure of CIA Personnel (4 pp.).

JAR: Doc. 94: discussion of Chapter 21 of manuscript

*AR: Dóc. 129: discussion of chapter 21 of manuscript
...
TIG was ahown the Records Control Schedule that appears to document the destruction of somo Win Scott

documents. Thii record should, perhaps, be designated an "arassination record."
...
Varification no other WS filos

PrOCEss ARS

Which records are already in collection?

ARRB must stil review any Scott destruction schedules
...
2. There is a reference to & 1959 IG survey of CI which should be requested for review. (See,

0.E., Cram 47, 56

3. The 1959 IG analysis stated the within the CI start, "96 were praisssionals, 75 clerical and

four staff agants. The Staff also had ons Headquartens contract agent, and several agents under

projecta" (Cram, 48).

4. There is a discussion of the Special Investigations Unit (clica 1939) and HuiNGUAL.

Copies of pages 49-51, and 55, which describe the STU and HTLINGUAL, should be evaluated to

détermine whother they contribute to understanding of relevant isquca.

5. Angleton was on sick leave from the agency from May, 1960 to 12 Jaquary 1961. During

Angleton's absence, S. Herman Horiön was Acting Chief and James Hunt was Acting Deputy

Chief. Hunt rubsoquently became the regular deputy and served until 1969(Cram: 58).

6. Routine liaison with FBI was conducted by Jane Roman "from the late 1940s anward.."

7. The activites of CI/SIG are described on pp. 144-45. Cram's cited sources are the 195S and

1973 descriptions of its activides. It should be decided whether thise two pages should be copied
...
understanding of the astassination. Mr. Angleton's testimony to the Church Committee le much more
...
disposition of the files of James Jesus Angleton and a few other matters. Becausc of the speculation about

the contents of the files, discussions of their dispostiton would jeem to be relevant. The pertinent points
...
and as being intellectually detached from the work of the agency. (Bonnes, p. I:6-8.)

2. The Angleton affice filer were voluminous and in disarray at the time of his departure from

the Agency. It may be appropriato to make copies of pp. I:8 (ast paragraph) up to the last
...
that ho had ipoken to Kalaris and Blee sbout this, and neither man could remamber anything in

the files excopt the Robert Kennody photographs.

4. The files revealed evidence that Angieton ran "counterintelligence [operations] abroad as

chief of the Cl Staff in the way in which the local station would be effectively cut out and

command channel and communications wild rus direct to counterintelligence headquarters in

Washington" Bonner, p. 122.) (sic). I believe Bonner Is saying the following: Angleton ran

coult litely cut, common a Caled it a smir atons would ta diet ritona

counterintelligence headquarters in Washington.

5. Bonner cites two examples where Angleton ran liaison with fiendly governments without the

local station chiets being specially aware of Angliton"s sctivities. The station chiefs found this

"frustrating." (Bonher, pp. Tas-26).

6. (Circa, 1976) "Handling (FOLA requests for information concerning Lec Harvey Oswald)

en the the tit dira ta chan i i done. ran analys, pius clerical personnol,

1. Discussion of activites of part of CI staff circa 1976: "Double Agent Branch - was charged

with the conduct of and coordination on double agent operations abroad. Sinco the vast majority

if DA cases were run by the US military servloes, the FBL, or- in some instances-foreign-liaison

serviloes, the branch was very heavily a coordinator rather than active runner of operations."

(Bonner, p. 1:71).

8. Bonner refari to an August 1976 IG report sometimes called the Freer report. It analyzes

Angleton's stewardship over CI compared to that of Kalaris, It discusses how Angloton ran CI.

We should revicw this repart. [it is cited in Mangold, Cold Wardor, at 316.]

Bonner volume II:

The only significant reference in Bonner pertains to the final completion of the review of the Angleton

files. (Bonnier, p. I:114.)
...
The Post -Angicion CI Staff

2 volumes (Tuly, 1993)

The ARRE requested access to any and all internal CLA histories of the CI staff for the purpose of

termining Whether they contain any intormation that would be useful for understanding th

assination of President Kennedy, including for example, the activities of Lee Harvey Oswald, i

tructure of Cl with respect to the comporients of the office that had responsibility for handling Oswald's

ilo at diffèrent times (particularly CI/SIG); and any aspoct of HTLINGUAL related to Oswald Because

the Agengy koops these historios closely held, it was bolloved that they are rolatively more likely to be

candid assessments of CI and its activities than one might obtain from more widely circulate documents.

I was providod complete socess to the entire 11 volumes of Cleveland Cram's (untitled) history of the old

firêt volume is hand dated (1981) and signed "Cleveland Cram." There are 1063 pages in the Cram

history. I was also provided complete accestto Al-Bonner, history of counterintelligence, which starts

with the departure of Angleton and continues to the present.

By all appearances, the histories appear to be relatively candid assessments of CL. I was able to idoatify

information that illuminated some of the latues of concern, and those will be outlined below. I identified

no Information tat would lead to any significant reevaluation of the role of CI in issues rolated to Oswald

or to the assassination. For the purpose of underitanding the assassination of the President or the other

insuor that come within the scope of the Roview Board'e mandato - other than the information identfied

below -I do not believe that the histories themseives, nor copies of any of the pages of the histories,

would provide any significant useful additional information that would enhance the understanding of the

assessination and I see no nood for any further information to be released from the histories." It le my

prillminary judgment that the page numbere highlighted below should be copied and atached to this

miniorandurn so that they can be made public

The information contained in the histories consists largely of case studies of important counterintelligence

activities. As a rulo, the histories do not describe the structure of the Cl offices, the personnel, the filing

system, or operations generally - although discussion of some af these issues arises. The principal
...
ho was provided only limited access to Angleton and the files. The author of the first histor

as given, for example, no access to any CI/SIG documents. Cram, accordingly, found th

history to bo unhelpful for understanding sensitive Cl activities. (Cram, p. I-2). There are
...
Battaglia, Staft Diroctor of the SSCI, told me that the ARRB should request the Monster Plot for
...
2. There is a reforence to & 1959 IG survey of CI, which should be requested for reviow. (See,

o.g., Стат 47, 56

3. The 1959 IG analyals stated the within the CI staft, "96 were professionals, 75 clerical and

four staff agents. The Staff also had one Headquartens contract agent, and several agents under

projocta." (Cram, 48).

4. There is a discussion of the Soccial Investigations Unit (circa 1959) and HTLINGUAL.

Copies of pages 49-51, and 55, which describe the STU and HITLINGUAL, should be evaluatod to

determine whether they contribute to understanding of relevant issuce.

S. Augleton was on sick leave from the agency from May, 1960 to 12 January 1961. During

ngleton's absence, S. Herman Hortön was Acting Chief and James Hunt was Acting Deput

Thief. Hunt subsequently became the regular deputy and served until 1969(Crain, 38)
...
this practico "did not develop until the carly 1960% after the defoction of Golitsyn...." (Cram,

71).

7. Tho activites of CI/SIG aro described on pp, 144-45. Cram's cited sources are the 1955 and

1973 descriptions of its activites: It should be decided whether these two pages should be copied
...
disposition of the files of James Jesus Angleton and a few other matters. Because of the spoculation about

tho contents of the files, discussions of their dispostion would deem to be relevant. The pertinent paints
...
and as being intellectually detached from the work of the agency, (Bonnet, p. I:6-8.)

2. The Angleton affico files were voluminous and in disarray at the time of his doparture from
...
that ho had spoken to Kalarie and Blee about this, and neither man could remember anything in

tho files excopt the Robert Kennody photographs.

4. The files revealed evidence that Angleton ran "countorintelligence [operations] abroad as

Chief of tho CI Stuff in the way in which the local station would be effectively cut out and

command channel and communications woüld run direct to counterintalligence hoadquarters in

Washington." (Bonner/p, T-22. (sic). I bellove onets saying the tollowing: Angleton ran

counterintolligence operations abroad as Chlef of the CI Stiff in fuch a way that local stations

would be affectively cut out; command channel and communications would rua direct to

counterintelligenco hoadquarters la Washington.

5. Bonnet cites two examplos where Angloton ran liaison with friendly governments without the

local station chiots being specifically aware of Angleton's activities. The station chiefs found this

"frustrating" Bonner pp. I23-26).

6. (Circa, 1976) "Handling FOLA requests for information concerning Lee Harvey Oswald]

required the creation of a tak force of 13 operations aficers and analysts, plus clerical personnol,

and their full-time efforts far over a monta Counship. 1:67.)

1. Discusson of activles of part of CI ital circa 1976: "Double Agent Branch - was charged

with the conduct of and coondination on double agent operations abroad. Since the vast majority
...
Angleton'& stewardship over Cl compared to that of Kalaris, It discusses how Angleton ran Cl:

We should review this report. fit is cited in Mangold, Cold Warder, at 316.]

volumo Il:

The anly significant reference in Bonder pertains to the final completion of the review of the Angleton

files. (Bonner p. Il:114.)
...
DRAFT BY KMEC AND TIG FOR ASSASSINATION RECORDS REVIEW BOARD

REVIEW OF MANGOLD V. CIA FILES

TANUARY 13 and 24, 1997

The Mautold vi CLA POLA lidigation files consist of 7 redwelds, totalling approximately 18 inches. They

are organized by "tabe," which can be described as follows:

Tab A; copter of publinbod newspaper and magazine clippings that were released in full. I see no need to

designate any documente as assassination records from the set.

Tab B: coples of published newspaper articles, the texts of which have been released in full. The agency

did redact marginals, which consisted exclusively of file names and indicators. I see no need to

designate any documents as ascaleination records from the set

sents, about Angleton from the 1940s; including his carcer with OSS. I ses no neod to

designate auy documente dr assassination records from the set.

Tab D: docs:94-230, AR (unles already part of the collection)s Docs. 95 (24 Nov. 1918.

Memorandum JIA tertimony to BSCA).

On December 11, 1978, the D.C.-based law firm of Duncan,

Brown filed, a FOLA request on behalf of James Angleton in conjunction with his anticipated, testimony

before the ESCA: P

resumaby allrecords related to thie matter are AR and should be processed under the

JFK Ac See doc. nos. 109-116; 120, 121.

Includes fitnces reports (not designated). All of the fitness reports were reviewed to determino whether

they coutaired probative information

Stuaion ta Intellence on lues rélated to litelligence. I see no need to designate any documents as

assassination records from the set.

Tab F contalns documents préviously releasod to Henry Hurt In responso to a request for documents
...
Tab & contains documents previously released to A. Doppeli (on behalf of The Readers Digest in

response to a request for documents concerning Nicholas Shadrin. These documents Include a specch by

Ci Turer, testimony by Capt. Nicolal Fedorovich Artamonov (Shadrin) before the Comittee on Un-

Imerican Actlylties (Sept 14, 1960), & transcript of a Panorama show on Artamonov, and extensive

orrespondence from his wite to varlous USG officials about. Shadrin's disappearance. I see no need to
...
exception of the following recorde:

From Category VI: nos. 496, 498, 499, 500, 510

Doc, no. 496 in directly relevant for potential future leads. The document is a memorandu

dated February 7, 1974. Docs 498 ls of Interest regarding the Malla, Teamsters, and Hoffa
...
Special Clearanco forms, administrative personnel information, information from denied FOLA requests,
...
and various memoranda relating to different conversations between JAi and Agency officers an a wide

vadety of Issues.

The gout Relena Fol, Os to, a atitiate person information, are moled tore ecso no

need to designate any documents as assassination records fom the set
...
destruction after his retirement. The Review Board asked the CLA to search for any
...
request for book reviews from CLA's internal journal Studies in Intelligence. These
...
various memoranda relating to different conversations between Angleton and CLA
...
for the central system for other DDO
...
ADMINISTRATIVE INTERNAL USE ONSK
...
these documents are an integral part of a
...
ADHENISARATTYS INPERNAL USE QUEX
...
CIA SOBOLAL COLLECTIONS

RELRASE AS SANITIZED
...
Meeting with Chief, Cl Staff, frOn
...
CI Staff accomplish the recommended objectives.
...
The ISS team reviered current re...u. ie. Ming practini.
...
number of policy and management files

that shoul'd be established for the documents that reflect the
...
an index of 270,000 3x5 cards that provides access by name
...
analyst is a prerequisite for processing this materia.
...
and document status information. These terminal:

name, & used to process the old records into the system and to
...
The CI/Research and Analysis Group's vault, Room 2B-2‹
...
the files to be analyzed are already stored
...
paid a octe on the eard that is ento on 3
...
Serve as a records referent to provide advice on hon

sensitive cases and projects can

• be processed into the records
...
sensitive material, (including CI Operational letters
...
case officors and it is difficult to account for the names and the

documents they are identified in.

A compartnented computer file will
...
another component or agency is conducting.a trace on
...
solutiohs to the CI Staff's record keeping problems
...
moving the records from Cl Staff to IP/DNS which could present
...
A computer system should be developed to allow nanes
...
7. A schior ISS analyst should be assigned to Cl Staff to
...
methods it protecting sensitive holings
...
Annex ฿ - Computer system proposal for handling
...
1 - EPS/EG (Mr. Glenn Brown) (i/o att)
...
NENOREA FOR: Chief, Infornation Hanagement Staff
...
years' assigiment to the Staff. During this period

much of the original 417 feet of Staff unprocessed

records have been reviewed by either the IMS Analjsts
...
done in a nost expeditious manner.
...
complete the remaining unprocessed records le have

compiled a listing of those records revilied by the ISS
...
oushl' 90 feet of unprocessed material vet to be revierec

and possibly incorporated into the Do Central Records

System.

such of the paper revieled by Cl Staff personel

neje found to be duplicate and vere destrojed. Those

documents thich had to be processed lere given to the

1'S Analysts for processing. (U)
...
The following files remain to be revieled and
...
Staff has heen reviewing and consolidating the WHEAT)

Project.

when the review is completed we
...
same kind of revier of the GROUNDHOG) Material (Item

prior to processing by the IMS Analysis assigned lo the
...
will have to be revieled and most processed into the
...
Project, and the LCHAYFONy Material: These three files
