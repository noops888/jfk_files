...
(U) CIA Employees Names in JFK Records
...
release of CIA employee names and the DO's response.
...
former employees have not responded to the DO's letter
...
protect most individuals.

Under the name-by-name approach,
...
is due to the ripple effect that would occur
...
Most of these individuals have little or no

connection to the JFK assassination story.

This is far

more names than had been anticipated when
...
May meeting will set

a precedent for the potentially

hundreds of names to come.

We have reviewed only the Oswald

201 file and 12 boxes of the JFK sequestered collection. At

this point it is impossible to determine the total number of

employees mentioned in the JFK collection. For example it/
...
much of our JFK collection as is possible.
...
an institution and to national security.
...
of their true names does not add to the story.
...
marginal or no interest to the JEK story.

(C) [Note: There is also the issue of

and the impact of officially acknowledging as CIA
...
If they agree, then I suggest a memo to the DO and

the General Counsel presenting the issues.
...
I see OGC (Linda) being tasked with preparing a
...
discussions with ARRB

staff as soon as possible with the

goal of having the memo ready no later than the 2-3 April

meeting.

We should also be prepared to discuss the issue

directly with the Board since we are
...
reviewers far comments

1 Gunn's and Wickhan
...
Analysis of ARRB and DO Memoranda re Treatment
...
The officer must be living outside of the U.s.
...
1ii. The officer objects to the release of his or

her true name.

COMMENTS: Mr. Gunn's

criteria are a little confusing
...
an adverse impact on future assignments or IDYs. With

respect to

retirees, if, after careful review, the Agency
...
There will be officers who petitioned hard
...
mentions the possibility of asking the IRs or the lOPM for
...
Note again, the criteria

required are four separate

ones, each

separated by a comma and between numbers 3 and 4
...
3. The Directorate of Operations Memorandum.
...
In addition to the data bases described --

retirement records, annuity pay records, the office of

security, insurance lists --

consideration might be given

and overt data bases

to the

such as Phonedec. Like the

IRs and OPM, the credit union
...
l and possibly place his/her life in danger.
...
process of handling names and minimize the potential damage
...
their employment remain under cover.

such

require the same review as that of an
...
unreasonable risk to the cover of thesè officers.
